---
{"dg-publish":true,"permalink":"/rules/source/races/genasi-earth-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/genasi/earth"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-race"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/genasi/earth"],"aliases":["Genasi (Earth)"]}}
---
...
You know the [[Rules/Source/spells/blade-ward-xphb\|blade ward]] cantrip. You can cast it as normal, and you can also cast it as a bonus action a number of times equal to your proficiency bonus, regaining all expended uses when you finish a long rest.

Starting at 5th level, you can cast the [[Rules/Source/spells/pass-without-trace-xphb\|pass without trace]] spell with this trait, without requiring a material component. Once you cast that spell with this trait, you can't do so again until you finish a long rest. You can also cast it using any spell slots you have of 2nd level or higher.
