---
{"dg-publish":true,"permalink":"/rules/source/races/harengon-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/harengon"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-race"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/harengon"],"aliases":["Harengon"]}}
---

# Harengon
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 22*  
![/Rules/Source/races/img/harengon.webp\|right wmed](/img/user/Rules/Source/races/img/harengon.webp)
...
When you fail a Dexterity saving throw, you can use your reaction to roll a `d4` and add it to the save, potentially turning the failure into a success. You can't use this reaction if you're [[Rules/Source/conditions#Prone\|prone]] or your speed is 0.
