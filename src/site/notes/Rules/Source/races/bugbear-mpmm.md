---
{"dg-publish":true,"permalink":"/rules/source/races/bugbear-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/bugbear"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-race"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/bugbear"],"aliases":["Bugbear"]}}
---

# Bugbear
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 8*  
![/Rules/Source/races/img/bugbear.webp\|right wmed](/img/user/Rules/Source/races/img/bugbear.webp)
...
You are proficient in the [[Rules/Source/skills#Stealth\|Stealth]] skill. In addition, without squeezing, you can move through and stop in a space large enough for a Small creature.
