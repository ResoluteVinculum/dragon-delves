---
{"dg-publish":true,"permalink":"/rules/source/races/centaur-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/centaur"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-race"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/centaur"],"aliases":["Centaur"]}}
---

# Centaur
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 9*  
![/Rules/Source/races/img/centaur.webp\|right wmed](/img/user/Rules/Source/races/img/centaur.webp)
...
Your fey connection to nature gives you an intuitive connection to the natural world and the animals within it. You therefore have proficiency in one of the following skills of your choice: [[Rules/Source/skills#Animal Handling\|Animal Handling]], [[Rules/Source/skills#Medicine\|Medicine]], [[Rules/Source/skills#Nature\|Nature]], or [[Rules/Source/skills#Survival\|Survival]].
