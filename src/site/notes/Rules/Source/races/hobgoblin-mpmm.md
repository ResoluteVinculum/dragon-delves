---
{"dg-publish":true,"permalink":"/rules/source/races/hobgoblin-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/hobgoblin"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-race"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/hobgoblin"],"aliases":["Hobgoblin"]}}
---

# Hobgoblin
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 23*  
![/Rules/Source/races/img/hobgoblin.webp\|right wmed](/img/user/Rules/Source/races/img/hobgoblin.webp)
...
You can use this trait to take the [[Rules/Source/actions#Help\|Help]] action as a bonus action, and you can do so a number of times equal to your proficiency bonus. You regain all expended uses when you finish a long rest.

Starting at 3rd level, choose one of the options below each time you take the [[Rules/Source/actions#Help\|Help]] action with this trait:
