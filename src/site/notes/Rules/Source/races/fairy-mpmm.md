---
{"dg-publish":true,"permalink":"/rules/source/races/fairy-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/fairy"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-race"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/fairy"],"aliases":["Fairy"]}}
---

# Fairy
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 14*  
![/Rules/Source/races/img/fairy.webp\|right wmed](/img/user/Rules/Source/races/img/fairy.webp)
...
You know the [[Rules/Source/spells/druidcraft-xphb\|druidcraft]] cantrip. Starting at 3rd level, you can cast the [[Rules/Source/spells/faerie-fire-xphb\|faerie fire]] spell with this trait. Starting at 5th level, you can also cast the [[Rules/Source/spells/enlarge-reduce-xphb\|enlarge/reduce]] spell with this trait. Once you cast [[Rules/Source/spells/faerie-fire-xphb\|faerie fire]] or [[Rules/Source/spells/enlarge-reduce-xphb\|enlarge/reduce]] with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast either of those spells using any spell slots you have of the appropriate level.
