---
{"dg-publish":true,"permalink":"/rules/source/races/triton-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/triton"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-race"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/triton"],"aliases":["Triton"]}}
---

# Triton
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 35*  
![/Rules/Source/races/img/triton.webp\|right wmed](/img/user/Rules/Source/races/img/triton.webp)
...
You can cast [[Rules/Source/spells/fog-cloud-xphb\|fog cloud]] with this trait. Starting at 3rd level, you can cast the [[Rules/Source/spells/gust-of-wind-xphb\|gust of wind]] spell with this trait. Starting at 5th level, you can also cast the [[Rules/Source/spells/water-walk-xphb\|water walk]] spell with it. Once you cast any of these spells with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast these spells using any spell slots you have of the appropriate level.
