---
{"dg-publish":true,"permalink":"/rules/source/races/kobold-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/kobold"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-race"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/race/kobold"],"aliases":["Kobold"]}}
---

# Kobold
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 25*  
![/Rules/Source/races/img/kobold.webp\|right wmed](/img/user/Rules/Source/races/img/kobold.webp)
...
- **Craftiness.** You have proficiency in one of the following skills of your choice: [[Rules/Source/skills#Arcana\|Arcana]], [[Rules/Source/skills#Investigation\|Investigation]], [[Rules/Source/skills#Medicine\|Medicine]], [[Rules/Source/skills#Sleight of Hand\|Sleight of Hand]], or [[Rules/Source/skills#Survival\|Survival]].  
- **Defiance.** You have advantage on saving throws to avoid or end the [[Rules/Source/conditions#Frightened\|frightened]] condition on yourself.  
