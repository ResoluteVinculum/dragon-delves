---
{"dg-publish":true,"permalink":"/rules/source/tables/background-i-became/","tags":["ttrpg-cli/compendium/src/5e/xge"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"tags":["ttrpg-cli/compendium/src/5e/xge"],"aliases":["Background; I became..."]}}
---
...
| 6 | After encountering a true servant of the gods, I was so inspired that I immediately entered the service of a religious group. |{ #acolyte}
...
| 6 | I was poor or I feared becoming poor, so I learned the tricks I needed to keep myself out of poverty. |{ #charlatan}
...
| 6 | I was always bored, so I turned to crime to pass the time and discovered I was quite good at it. |{ #criminal}
...
| 6 | A traveling entertainer took me in and taught me the trade. |{ #entertainer}
...
| 6 | I have always stood up for those who are weaker than I am. |{ #folk-hero}
...
| 6 | I learned the essentials of my craft from a mentor but had to join the guild to finish my training. |{ #guild-artisan}
...
| 6 | Society's decadence disgusted me, so I decided to leave it behind. |{ #hermit}
...
| 6 | I hope to increase my family's power and influence. |{ #noble}
...
| 6 | My family moved away from civilization, and I learned to adapt to my new environment. |{ #outlander}
...
| 6 | One of my parents or a relative gave me a basic education that whetted my appetite, and I left home to build on what I had learned. |{ #sage}
...
| 6 | I had few prospects where I was living, so I left to find my fortune elsewhere. |{ #sailor}
...
| 6 | Invaders attacked my homeland. It was my duty to take up arms in defense of my people. |{ #soldier}
