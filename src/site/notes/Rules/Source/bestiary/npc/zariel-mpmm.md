---
{"dg-publish":true,"permalink":"/rules/source/bestiary/npc/zariel-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/26","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend/devil"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/26","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend/devil"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Zariel"]}}
---

# [Zariel](Rules\Source\bestiary\npc/zariel-mpmm.md)
...
"cr": "26"
"traits":
  - "desc": "Magical darkness doesn't impede Zariel's [darkvision](/Rules/Source/senses.md#Darkvision)."
    "name": "Devil's Sight"
...
"actions":
  ...
  - "desc": "Zariel touches one creature within 10 feet of her. The target must succeed\
      ...
      \ be [poisoned](/Rules/Source/conditions.md#Poisoned) for 1 minute. While [poisoned](/Rules/Source/conditions.md#Poisoned)\
      \ in this way, the target is [blinded](/Rules/Source/conditions.md#Blinded)\
      \ and [deafened](/Rules/Source/conditions.md#Deafened). The target can repeat\
  ...
  - "desc": "Zariel casts one of the following spells, requiring no material components\
      ...
      \ will:** [alter self](/Rules/Source/spells/alter-self-xphb.md) (can become\
      \ Medium when changing her appearance), [detect evil and good](/Rules/Source/spells/detect-evil-and-good-xphb.md),\
      \ [fireball](/Rules/Source/spells/fireball-xphb.md), [invisibility](/Rules/Source/spells/invisibility-xphb.md)\
      \ (self only), [major image](/Rules/Source/spells/major-image-xphb.md), [wall\
      \ of fire](/Rules/Source/spells/wall-of-fire-xphb.md)\n\n**3/day each:** [blade\
      \ barrier](/Rules/Source/spells/blade-barrier-xphb.md), [dispel evil and good](/Rules/Source/spells/dispel-evil-and-good-xphb.md),\
      \ [finger of death](/Rules/Source/spells/finger-of-death-xphb.md)"
    "name": "Spellcasting"
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), Zariel can take one\
      ...
      \ in a row:\n\n- **Fireball.** Zariel casts the [fireball](/Rules/Source/spells/fireball-xphb.md)\
      \ spell.  \n- **Infernal Illusions.** Zariel casts the [major image](/Rules/Source/spells/major-image-xphb.md)\
      ...
      \ saving throw or become [frightened](/Rules/Source/conditions.md#Frightened)\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/npc/token/zariel-mpmm.webp"
```
^statblock