---
{"dg-publish":true,"permalink":"/rules/source/bestiary/npc/juiblex-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/23","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/fiend/demon"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/23","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/fiend/demon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Juiblex"]}}
---

# [Juiblex](Rules\Source\bestiary\npc/juiblex-mpmm.md)
...
"traits":
  - "desc": "Any creature other than an Ooze that starts its turn within 10 feet of\
      \ Juiblex must succeed on a DC 21 Constitution saving throw or be [poisoned](/Rules/Source/conditions.md#Poisoned)\
...
"actions":
  ...
  - "desc": "Juiblex spews out a corrosive slime, targeting one creature that it can\
      ...
      \ [mending](/Rules/Source/spells/mending-xphb.md) spell."
  ...
  - "desc": "Juiblex casts one of the following spells, requiring no material components\
      ...
      \ [detect magic](/Rules/Source/spells/detect-magic-xphb.md)\n\n**3/day each:**\
      \ [contagion](/Rules/Source/spells/contagion-xphb.md), [gaseous form](/Rules/Source/spells/gaseous-form-xphb.md)"
    "name": "Spellcasting"
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), Juiblex can take one\
      ...
      \ in a row:\n\n- **Green Slime.** A [green slime](/Rules/Source/traps-hazards/green-slime-xdmg.md)\
      ...
      \ [prone](/Rules/Source/conditions.md#Prone) and slide 10 feet in a random direction\
      \ determined by a d8 roll. When a creature enters the area for the first time\
      \ on a turn or ends its turn there, that creature must make the same save. \
      \ \n\n    The slime lasts for 1 hour or until it is burned away with fire. If\
      \ the slime is set on fire, it burns away after 1 round. Any creature that starts\
      \ its turn in the burning slime takes 22 (4d10) fire damage.  \n- **Sticky Slime.**\
      \ Juiblex slimes a square area of ground it can see within the lair. The area\
      \ can be up to 10 feet on a side. When the slime appears, each creature in that\
      \ area must succeed on a DC 21 Strength saving throw or become [restrained](/Rules/Source/conditions.md#Restrained).\
      \ When a creature enters the area for the first time on a turn or ends its turn\
      \ there, that creature must make the same save.  \n\n    A [restrained](/Rules/Source/conditions.md#Restrained)\
      \ creature is stuck as long as it remains in the slimy area or until it breaks\
      \ free. The [restrained](/Rules/Source/conditions.md#Restrained) creature, or\
      \ another creature that can reach it, can use its action to try to break free\
      \ and must succeed on a DC 21 Strength check. The slime lasts for 1 hour or\
      \ until it is burned away with fire. If the slime is set on fire, it burns away\
      \ after 1 round. Any creature that starts its turn in the burning slime takes\
      \ 22 (4d10) fire damage.  "
    "name": ""
"regional_effects":
  - "desc": "The region containing Juiblex's lair is warped by its magic, creating\
      ...
      \ 6 miles of the lair, all Wisdom ([Medicine](/Rules/Source/skills.md#Medicine))\
      \ and Wisdom ([Survival](/Rules/Source/skills.md#Survival)) checks have disadvantage.\
...
"legendary_actions":
  ...
  - "desc": "*Melee Weapon Attack:* +14 to hit, reach 10 ft., one creature. *Hit:*\
      ...
      \ off with an action, the target is [poisoned](/Rules/Source/conditions.md#Poisoned),\
      \ and any creature, other than an Ooze, is [poisoned](/Rules/Source/conditions.md#Poisoned)\
      \ while within 10 feet of the target."
    "name": "Corrupting Touch (Costs 2 Actions)"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/npc/token/juiblex-mpmm.webp"
```
^statblock