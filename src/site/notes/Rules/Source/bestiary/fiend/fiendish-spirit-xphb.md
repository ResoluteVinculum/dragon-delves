---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/fiendish-spirit-xphb/","tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/monster/cr/","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/monster/cr/","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Fiendish Spirit"]}}
---

# [Fiendish Spirit](Rules\Source\bestiary\fiend/fiendish-spirit-xphb.md)
...
"traits":
  - "desc": "When the spirit drops to 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      \ or the spell ends, the spirit explodes. *Dexterity Saving Throw:* DC equals\
      \ your spell save DC, each creature in a 10-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the spirit. *Failure:* 2d10 plus this spell's level Fire\
      \ damage. *Success:* Half damage."
    "name": "Death Throes (Demon Only)"
  - "desc": "Magical [Darkness](/Rules/Source/variant-rules/darkness-xphb.md) doesn't\
      \ impede the spirit's Darkvision."
    "name": "Devil's Sight (Devil Only)"
  - "desc": "The spirit has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"source":
  - "XPHB"
"image": "/Rules/Source/bestiary/fiend/token/fiendish-spirit-xphb.webp"
```
^statblock