---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/vrock-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/abyss","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend/demon"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/abyss","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend/demon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Vrock"]}}
---

# [Vrock](Rules\Source\bestiary\fiend/vrock-xmm.md)
...
"traits":
  ...
  - "desc": "The vrock has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 5 ft. *Hit:* 10 (2d6 + 3) Piercing damage\
    ...
    "name": "Shred"
  - "desc": "*Constitution Saving Throw:* DC 15, each creature in a 20-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the vrock. *Failure:* The target has the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
      \ condition and repeats the save at the end of each of its turns, ending the\
      \ effect on itself on a success. While [Poisoned](/Rules/Source/conditions.md#Poisoned),\
      \ the target takes 5 (1d10) Poison damage at the start of each of its turns.\
      \ Emptying a flask of [Holy Water](/Rules/Source/items/holy-water-xphb.md) on\
      \ the target ends the effect early."
    "name": "Spores (Recharge 6)"
  - "desc": "*Constitution Saving Throw:* DC 15, each creature in a 20-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the vrock (demons succeed automatically). *Failure:* 10 (3d6)\
      \ Thunder damage, and the target has the [Stunned](/Rules/Source/conditions.md#Stunned)\
      \ condition until the end of the vrock's next turn."
    "name": "Stunning Screech (1/Day)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/vrock-xmm.webp"
```{ #statblock}
