---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/night-hag-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/lower","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/lower","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Night Hag"]}}
---

# [Night Hag](Rules\Source\bestiary\fiend/night-hag-xmm.md)
...
"traits":
  - "desc": "While within 30 feet of at least two hag allies, the hag can cast one\
      ...
      \ save DC 14): [Augury](/Rules/Source/spells/augury-xphb.md), [Find Familiar](/Rules/Source/spells/find-familiar-xphb.md),\
    ...
    "name": "Coven Magic"
  - "desc": "The hag has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
      \ on saving throws against spells and other magical effects."
    "name": "Magic Resistance"
  - "desc": "The hag has a soul bag. While holding or carrying the bag, the hag can\
      \ use its Nightmare Haunting action.\n\nThe bag has AC 15, HP 20, and [Resistance](/Rules/Source/variant-rules/resistance-xphb.md)\
      \ to all damage. The bag turns to dust if reduced to 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md).\
...
"actions":
  ...
  - "desc": "The hag casts one of the following spells, requiring no Material components\
      ...
      **At will:** [Detect Magic](/Rules/Source/spells/detect-magic-xphb.md), [Etherealness](/Rules/Source/spells/etherealness-xphb.md),\
      \ [Magic Missile](/Rules/Source/spells/magic-missile-xphb.md) (level 4 version)\n\
      \n**2/day each:** [Phantasmal Killer](/Rules/Source/spells/phantasmal-killer-xphb.md),\
      \ [Plane Shift](/Rules/Source/spells/plane-shift-xphb.md) (self only)"
    "name": "Spellcasting"
  - "desc": "While on the Ethereal Plane, the hag casts [Dream](/Rules/Source/spells/dream-xphb.md),\
      ...
      \ the effect of the [Protection from Evil and Good](/Rules/Source/spells/protection-from-evil-and-good-xphb.md)\
      \ spell or within a [Magic Circle](/Rules/Source/spells/magic-circle-xphb.md)\
      \ spell.\n\nIf the target takes damage from the [Dream](/Rules/Source/spells/dream-xphb.md)\
      \ spell, the target's [Hit Point](/Rules/Source/variant-rules/hit-points-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/night-hag-xmm.webp"
```{ #statblock}
