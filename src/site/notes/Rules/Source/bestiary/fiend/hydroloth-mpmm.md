---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/hydroloth-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/9","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/yugoloth"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/9","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/yugoloth"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Hydroloth"]}}
---

# [Hydroloth](Rules\Source\bestiary\fiend/hydroloth-mpmm.md)
...
"actions":
  ...
  - "desc": "The hydroloth targets one creature it can see within 60 feet of it. The\
      ...
      \ itself on a success. A [greater restoration](/Rules/Source/spells/greater-restoration-xphb.md)\
      \ or [remove curse](/Rules/Source/spells/remove-curse-xphb.md) spell cast on\
      \ the target ends this effect early."
  ...
  - "desc": "The hydroloth casts one of the following spells, requiring no material\
      ...
      **3/day each:** [control water](/Rules/Source/spells/control-water-xphb.md),\
      \ [crown of madness](/Rules/Source/spells/crown-of-madness-xphb.md), [fear](/Rules/Source/spells/fear-xphb.md),\
      \ [suggestion](/Rules/Source/spells/suggestion-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/hydroloth-mpmm.webp"
```
^statblock