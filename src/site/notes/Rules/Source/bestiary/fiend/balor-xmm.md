---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/balor-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/19","ttrpg-cli/monster/environment/abyss","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/fiend/demon"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/19","ttrpg-cli/monster/environment/abyss","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/fiend/demon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Balor"]}}
---

# [Balor](Rules\Source\bestiary\fiend/balor-xmm.md)
...
"traits":
  - "desc": "The balor explodes when it dies. *Dexterity Saving Throw:* DC 20, each\
      \ creature in a 30-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      ...
      \ Points](/Rules/Source/variant-rules/hit-points-xphb.md) somewhere in the Abyss."
    "name": "Death Throes"
  - "desc": "At the end of each of the balor's turns, each creature in a 5-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
  ...
  - "desc": "The balor has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +14, reach 30 ft. *Hit:* 18 (3d6 + 8) Force damage\
      ...
      \ has the [Prone](/Rules/Source/conditions.md#Prone) condition."
    "name": "Flame Whip"
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/balor-xmm.webp"
```{ #statblock}
