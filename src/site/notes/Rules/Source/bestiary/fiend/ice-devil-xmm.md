...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +10, reach 5 ft. or range 30/120 ft.\
      ...
      \ of its next turn, the target can't take a [Bonus Action](/Rules/Source/variant-rules/bonus-action-xphb.md)\
      \ or [Reaction](/Rules/Source/variant-rules/reaction-xphb.md), its [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 10 ft. *Hit:* 15 (3d6 + 5) Bludgeoning\
    ...
    "name": "Tail"
  - "desc": "The devil casts [Wall of Ice](/Rules/Source/spells/wall-of-ice-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/ice-devil-xmm.webp"
```{ #statblock}
