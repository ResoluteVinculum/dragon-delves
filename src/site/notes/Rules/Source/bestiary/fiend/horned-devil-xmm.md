---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/horned-devil-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/nine-hells","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend/devil"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/nine-hells","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend/devil"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Horned Devil"]}}
---

# [Horned Devil](Rules\Source\bestiary\fiend/horned-devil-xmm.md)
...
"senses": "[Darkvision](/Rules/Source/senses.md#Darkvision) 150 ft. (unimpeded by\
...
"traits":
  - "desc": "If the devil dies outside the Nine Hells, its body disappears in sulfurous\
      \ smoke, and it gains a new body instantly, reviving with all its [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      \ somewhere in the Nine Hells."
    "name": "Diabolical Restoration"
  - "desc": "The devil has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 17, one creature the devil can see within\
      ...
      \ 10 (3d6) [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md) at the\
      \ start of each of its turns. The wound closes after 1 minute, after a spell\
      \ restores [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md) to the\
      \ target, or after the target or a creature within 5 feet of it takes an action\
      \ to stanch the wound, doing so by succeeding on a DC 17 Wisdom ([Medicine](/Rules/Source/skills.md#Medicine))\
      \ check."
    "name": "Infernal Tail"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/horned-devil-xmm.webp"
```{ #statblock}
