---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/mezzoloth-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/gehenna","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/yugoloth"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/gehenna","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/yugoloth"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Mezzoloth"]}}
---

# [Mezzoloth](Rules\Source\bestiary\fiend/mezzoloth-xmm.md)
...
"traits":
  ...
  - "desc": "The mezzoloth has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 9 (2d4 + 4) Slashing damage.\
      ...
      \ condition (escape DC 14) from two of four claws, and it has the [Restrained](/Rules/Source/conditions.md#Restrained)\
  ...
  - "desc": "The mezzoloth casts one of the following spells, requiring no Material\
      ...
      \n**1/day each:** [Cloudkill](/Rules/Source/spells/cloudkill-xphb.md), [Darkness](/Rules/Source/spells/darkness-xphb.md),\
      \ [Dispel Magic](/Rules/Source/spells/dispel-magic-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/mezzoloth-xmm.webp"
```{ #statblock}
