---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/gnoll-demoniac-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/8","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/8","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Gnoll Demoniac"]}}
---

# [Gnoll Demoniac](Rules\Source\bestiary\fiend/gnoll-demoniac-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +6, reach 5 ft. or range 60 ft. *Hit:*\
    ...
    "name": "Abyssal Strike"
  - "desc": "The gnoll conjures a 30-foot [Cube](/Rules/Source/variant-rules/cube-area-of-effect-xphb.md)\
      \ of magical [Darkness](/Rules/Source/variant-rules/darkness-xphb.md) originating\
      \ from a point it can see within 60 feet, which lasts for 1 minute or until\
      \ the gnoll's [Concentration](/Rules/Source/conditions.md#Concentration) ends\
      \ on it. This area is [Difficult Terrain](/Rules/Source/variant-rules/difficult-terrain-xphb.md).\
      ...
      \ Hit Points](/Rules/Source/variant-rules/temporary-hit-points-xphb.md). *Success:*\
      \ Half damage only."
    "name": "Hunger of Yeenoghu (Recharge 5-6)"
"bonus_actions":
  - "desc": "Immediately after dealing damage to a creature that is already [Bloodied](/Rules/Source/conditions.md#Bloodied),\
      \ the gnoll moves up to half its [Speed](/Rules/Source/variant-rules/speed-xphb.md),\
      \ and it makes one Abyssal Strike attack."
    "name": "Rampage (2/Day)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/gnoll-demoniac-xmm.webp"
```{ #statblock}
