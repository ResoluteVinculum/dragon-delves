---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/yagnoloth-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend/yugoloth"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend/yugoloth"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Yagnoloth"]}}
---

# [Yagnoloth](Rules\Source\bestiary\fiend/yagnoloth-mpmm.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 15 ft., one target. *Hit:* 23\
      ...
      \ DC 16 Constitution saving throw or become [stunned](/Rules/Source/conditions.md#Stunned)\
  ...
  - "desc": "The yagnoloth touches one [incapacitated](/Rules/Source/conditions.md#Incapacitated)\
  ...
  - "desc": "The yagnoloth casts one of the following spells, requiring no material\
      ...
      \n**At will:** [darkness](/Rules/Source/spells/darkness-xphb.md), [detect magic](/Rules/Source/spells/detect-magic-xphb.md),\
      \ [dispel magic](/Rules/Source/spells/dispel-magic-xphb.md), [invisibility](/Rules/Source/spells/invisibility-xphb.md)\
      \ (self only), [suggestion](/Rules/Source/spells/suggestion-xphb.md)\n\n**3/day:**\
      \ [lightning bolt](/Rules/Source/spells/lightning-bolt-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/yagnoloth-mpmm.webp"
```{ #statblock}
