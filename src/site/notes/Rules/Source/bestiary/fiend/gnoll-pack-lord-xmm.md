...
"actions":
  ...
  - "desc": "The gnoll targets another creature it can see within 60 feet of itself\
      \ that has the Rampage [Bonus Action](/Rules/Source/variant-rules/bonus-action-xphb.md).\
      \ The target can take a [Reaction](/Rules/Source/variant-rules/reaction-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/gnoll-pack-lord-xmm.webp"
```{ #statblock}
