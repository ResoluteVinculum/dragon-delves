---
{"dg-publish":true,"permalink":"/rules/source/bestiary/giant/hill-giant-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/giant"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/giant"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Hill Giant"]}}
---

# [Hill Giant](Rules\Source\bestiary\giant/hill-giant-xmm.md)
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/giant/token/hill-giant-xmm.webp"
```{ #statblock}
