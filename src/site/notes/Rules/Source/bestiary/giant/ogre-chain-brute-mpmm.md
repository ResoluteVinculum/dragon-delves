---
{"dg-publish":true,"permalink":"/rules/source/bestiary/giant/ogre-chain-brute-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/3","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/giant"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/3","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/giant"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Ogre Chain Brute"]}}
---

# [Ogre Chain Brute](Rules\Source\bestiary\giant/ogre-chain-brute-mpmm.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 10 ft., one target. *Hit:* 13\
      ...
      \ saving throw or be [stunned](/Rules/Source/conditions.md#Stunned) for 1 minute.\
  ...
  - "desc": "The ogre swings its chain, and every creature within 10 feet of it must\
      ...
      \ takes 8 (1d8 + 4) bludgeoning damage and is knocked [prone](/Rules/Source/conditions.md#Prone).\
      \ On a successful save, the creature takes half as much damage and isn't knocked\
      \ [prone](/Rules/Source/conditions.md#Prone)."
    "name": "Chain Sweep"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/giant/token/ogre-chain-brute-mpmm.webp"
```{ #statblock}
