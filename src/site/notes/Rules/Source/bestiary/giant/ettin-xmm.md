---
{"dg-publish":true,"permalink":"/rules/source/bestiary/giant/ettin-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/4","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/giant"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/4","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/giant"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Ettin"]}}
---

# [Ettin](Rules\Source\bestiary\giant/ettin-xmm.md)
...
"gear":
  - "[battleaxe](/Rules/Source/items/battleaxe-xphb.md)"
  - "[morningstar](/Rules/Source/items/morningstar-xphb.md)"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 14 (2d8 + 5) Piercing damage,\
      \ and the target has [Disadvantage](/Rules/Source/variant-rules/disadvantage-xphb.md)\
      \ on the next attack roll it makes before the end of its next turn."
    "name": "Morningstar"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/giant/token/ettin-xmm.webp"
```{ #statblock}
