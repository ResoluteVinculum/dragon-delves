---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/smoke-mephit-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-4","ttrpg-cli/monster/environment/elemental","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/small","ttrpg-cli/monster/type/elemental"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-4","ttrpg-cli/monster/environment/elemental","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/small","ttrpg-cli/monster/type/elemental"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Smoke Mephit"]}}
---

# [Smoke Mephit](Rules\Source\bestiary\elemental/smoke-mephit-xmm.md)
...
"traits":
  - "desc": "The mephit explodes when it dies. *Constitution Saving Throw:* DC 11,\
      \ each creature in a 5-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the mephit. *Failure:* The target has the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 11, one creature the mephit can see within\
      \ 15 feet. *Failure:* The target has the [Blinded](/Rules/Source/conditions.md#Blinded)\
      \ condition until the end of the mephit's next turn."
    "name": "Cinder Breath (Recharge 6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/smoke-mephit-xmm.webp"
```{ #statblock}
