---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/azer-sentinel-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/fire","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/elemental"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/fire","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/elemental"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Azer Sentinel"]}}
---

# [Azer Sentinel](Rules\Source\bestiary\elemental/azer-sentinel-xmm.md)
...
"traits":
  - "desc": "At the end of each of the azer's turns, each creature of the azer's choice\
      \ in a 5-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the azer takes 5 (1d10) Fire damage unless the azer has the\
      \ [Incapacitated](/Rules/Source/conditions.md#Incapacitated) condition."
    "name": "Fire Aura"
  - "desc": "The azer sheds [Bright Light](/Rules/Source/variant-rules/bright-light-xphb.md)\
      \ in a 10-foot radius and [Dim Light](/Rules/Source/variant-rules/dim-light-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/azer-sentinel-xmm.webp"
```{ #statblock}
