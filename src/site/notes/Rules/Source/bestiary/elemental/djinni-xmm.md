---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/djinni-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/air","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental/genie"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/air","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental/genie"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Djinni"]}}
---

# [Djinni](Rules\Source\bestiary\elemental/djinni-xmm.md)
...
"traits":
  - "desc": "If the djinni dies outside the Elemental Plane of Air, its body dissolves\
      ...
      \ Points](/Rules/Source/variant-rules/hit-points-xphb.md) somewhere on the Plane\
      \ of Air."
    "name": "Elemental Restoration"
  - "desc": "The djinni has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
      \ on saving throws against spells and other magical effects."
    "name": "Magic Resistance"
  - "desc": "The djinni has a 30 percent chance of knowing the [Wish](/Rules/Source/spells/wish-xphb.md)\
...
"actions":
  ...
  - "desc": "The djinni conjures a whirlwind at a point it can see within 120 feet.\
      \ The whirlwind fills a 20-foot-radius, 60-foot-high [Cylinder](/Rules/Source/variant-rules/cylinder-area-of-effect-xphb.md)\
      \ centered on that point. The whirlwind lasts until the djinni's [Concentration](/Rules/Source/conditions.md#Concentration)\
      ...
      \ and moves with the whirlwind. At the start of each of its turns, the [Restrained](/Rules/Source/conditions.md#Restrained)\
  ...
  - "desc": "The djinni casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Detect Evil and Good](/Rules/Source/spells/detect-evil-and-good-xphb.md),\
      \ [Detect Magic](/Rules/Source/spells/detect-magic-xphb.md)\n\n**2/day each:**\
      \ [Create Food and Water](/Rules/Source/spells/create-food-and-water-xphb.md)\
      \ (can create wine instead of water), [Tongues](/Rules/Source/spells/tongues-xphb.md),\
      \ [Wind Walk](/Rules/Source/spells/wind-walk-xphb.md)\n\n**1/day each:** [Creation](/Rules/Source/spells/creation-xphb.md),\
      \ [Gaseous Form](/Rules/Source/spells/gaseous-form-xphb.md), [Invisibility](/Rules/Source/spells/invisibility-xphb.md),\
      \ [Major Image](/Rules/Source/spells/major-image-xphb.md), [Plane Shift](/Rules/Source/spells/plane-shift-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/djinni-xmm.webp"
```{ #statblock}
