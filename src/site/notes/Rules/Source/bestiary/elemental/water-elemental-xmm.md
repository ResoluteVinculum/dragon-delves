---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/water-elemental-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/swamp","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/environment/water","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/swamp","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/environment/water","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Water Elemental"]}}
---

# [Water Elemental](Rules\Source\bestiary\elemental/water-elemental-xmm.md)
...
"condition_immunities": "[exhaustion](/Rules/Source/conditions.md#Exhaustion), [grappled](/Rules/Source/conditions.md#Grappled),\
  ...
  \ [restrained](/Rules/Source/conditions.md#Restrained), [unconscious](/Rules/Source/conditions.md#Unconscious)"
"senses": "[Darkvision](/Rules/Source/senses.md#Darkvision) 60 ft., passive Perception\
  \ 10"
"languages": "Primordial (Aquan)"
"cr": "5"
"traits":
  - "desc": "If the elemental takes Cold damage, its [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 13 (2d8 + 4) Bludgeoning\
      \ damage. If the target is a Medium or smaller creature, it has the [Prone](/Rules/Source/conditions.md#Prone)\
      \ condition."
    "name": "Slam"
  - "desc": "*Strength Saving Throw:* DC 15, each creature in the elemental's space.\
      ...
      \ creature, it has the [Grappled](/Rules/Source/conditions.md#Grappled) condition\
      \ (escape DC 14). Until the grapple ends, the target has the [Restrained](/Rules/Source/conditions.md#Restrained)\
      ...
      \ creature out of it by succeeding on a DC 14 Strength ([Athletics](/Rules/Source/skills.md#Athletics))\
      \ check. *Success:* Half damage only."
    "name": "Whelm (Recharge 4-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/water-elemental-xmm.webp"
```{ #statblock}
