---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/gargoyle-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/elemental"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/elemental"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Gargoyle"]}}
---

# [Gargoyle](Rules\Source\bestiary\elemental/gargoyle-xmm.md)
...
| 6 | Useful, like an ornate podium or a pillar. |{ #gargoyle-sculptures}
...
| 4 | The [[Rules/Source/conditions#Petrified\|petrified]] victims of a basilisk or medusa. |
| 5 | Reliefs on a sculpted gate or wall. |
| 6 | Rubble in a ruin or junkyard. |
| 7 | Stalactites or icicles on a cavern ceiling. |
| 8 | Statuary on a castle, mansion, or temple. |{ #gargoyle-camouflage}
...
"condition_immunities": "[exhaustion](/Rules/Source/conditions.md#Exhaustion), [petrified](/Rules/Source/conditions.md#Petrified),\
...
"cr": "2"
"traits":
  - "desc": "The gargoyle doesn't provoke an [Opportunity Attack](/Rules/Source/actions.md#Opportunity%20Attack)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/gargoyle-xmm.webp"
```{ #statblock}
