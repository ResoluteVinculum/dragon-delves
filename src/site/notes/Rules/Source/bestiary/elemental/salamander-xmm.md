---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/salamander-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/fire","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/fire","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Salamander"]}}
---

# [Salamander](Rules\Source\bestiary\elemental/salamander-xmm.md)
...
"traits":
  - "desc": "At the end of each of the salamander's turns, each creature of the salamander's\
      \ choice in a 5-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 15, one Large or smaller creature the salamander\
      ...
      \ (2d6) Fire damage. The target has the [Grappled](/Rules/Source/conditions.md#Grappled)\
      \ condition (escape DC 14), and it has the [Restrained](/Rules/Source/conditions.md#Restrained)\
      \ condition until the grapple ends."
    "name": "Constrict"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/salamander-xmm.webp"
```{ #statblock}
