---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/gazer-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1-2","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/tiny","ttrpg-cli/monster/type/aberration/beholder"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1-2","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/tiny","ttrpg-cli/monster/type/aberration/beholder"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Gazer"]}}
---

# [Gazer](Rules\Source\bestiary\aberration/gazer-mpmm.md)
...
"actions":
  ...
  - "desc": "The gazer shoots two of the following magical eye rays at random (roll\
      ...
      \ a DC 12 Wisdom saving throw or be [charmed](/Rules/Source/conditions.md#Charmed)\
      \ until the start of the gazer's next turn. While the target is [charmed](/Rules/Source/conditions.md#Charmed)\
      ...
      \ saving throw or be [frightened](/Rules/Source/conditions.md#Frightened) until\
      \ the start of the gazer's next turn.  \n- **3 Frost Ray.** The target must\
      \ succeed on a DC 12 Dexterity saving throw or take 10 (3d6) cold damage.  \n\
      - **4 Telekinetic Ray.** If the target is a creature that is Medium or smaller,\
      \ it must succeed on a DC 12 Strength saving throw or be moved up to 30 feet\
      \ directly away from the gazer. If the target is a Tiny object that isn't being\
      \ worn or carried, the gazer moves it up to 30 feet in any direction. The gazer\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/aberration/token/gazer-mpmm.webp"
```{ #statblock}
