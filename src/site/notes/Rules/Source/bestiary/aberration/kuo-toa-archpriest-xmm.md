---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/kuo-toa-archpriest-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/aberration"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/aberration"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Kuo-toa Archpriest"]}}
---

# [Kuo-toa Archpriest](Rules\Source\bestiary\aberration/kuo-toa-archpriest-xmm.md)
...
"traits":
  - "desc": "The kuo-toa can breathe air and water."
    "name": "Amphibious"
  - "desc": "While in sunlight, the kuo-toa has [Disadvantage](/Rules/Source/variant-rules/disadvantage-xphb.md)\
...
"actions":
  ...
  - "desc": "The kuo-toa casts one of the following spells, requiring no Material\
      ...
      \n**At will:** [Detect Magic](/Rules/Source/spells/detect-magic-xphb.md), [Thaumaturgy](/Rules/Source/spells/thaumaturgy-xphb.md)\n\
      \n**1/day each:** [Destructive Wave](/Rules/Source/spells/destructive-wave-xphb.md),\
      \ [Divination](/Rules/Source/spells/divination-xphb.md), [Hold Monster](/Rules/Source/spells/hold-monster-xphb.md)\
      \ (level 6 version), [Scrying](/Rules/Source/spells/scrying-xphb.md), [Tongues](/Rules/Source/spells/tongues-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The kuo-toa casts [Shield of Faith](/Rules/Source/spells/shield-of-faith-xphb.md),\
      \ using the same spellcasting ability as Spellcasting.\n"
    "name": "Shield of Faith (2/Day)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/kuo-toa-archpriest-xmm.webp"
```{ #statblock}
