---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/flumph-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-8","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/small","ttrpg-cli/monster/type/aberration"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-8","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/small","ttrpg-cli/monster/type/aberration"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Flumph"]}}
---

# [Flumph](Rules\Source\bestiary\aberration/flumph-xmm.md)
...
"traits":
  ...
  - "desc": "If the flumph receives the [Prone](/Rules/Source/conditions.md#Prone)\
      \ condition, roll a die. On an odd number, it has the [Incapacitated](/Rules/Source/conditions.md#Incapacitated)\
      \ condition. At the end of each of its turns, the flumph makes a DC 10 Dexterity\
      \ saving throw, ending the [Incapacitated](/Rules/Source/conditions.md#Incapacitated)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 10, one creature the flumph can see within\
      ...
      \ a stench for 1d4 hours, and has the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
      \ condition while the stench lasts. Other creatures have the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
      \ condition while in a 5-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the coated target. The target can remove the stench on itself\
      \ if it bathes during a [Short](/Rules/Source/variant-rules/short-rest-xphb.md)\
      \ or [Long Rest](/Rules/Source/variant-rules/long-rest-xphb.md)."
    "name": "Stench Spray (1/Day)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/flumph-xmm.webp"
```{ #statblock}
