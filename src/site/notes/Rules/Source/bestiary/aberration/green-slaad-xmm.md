...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +7, reach 10 ft. or range 60 ft. *Hit:*\
      ...
      \ has a condition determined by rolling 1d4: on a 1, [Charmed](/Rules/Source/conditions.md#Charmed);\
  ...
  - "desc": "The slaad casts one of the following spells, requiring no Material components\
      ...
      \ [Detect Thoughts](/Rules/Source/spells/detect-thoughts-xphb.md), [Mage Hand](/Rules/Source/spells/mage-hand-xphb.md)\n\
      \n**1/day each:** [Fireball](/Rules/Source/spells/fireball-xphb.md), [Invisibility](/Rules/Source/spells/invisibility-xphb.md)\
      \ (self only)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/green-slaad-xmm.webp"
```{ #statblock}
