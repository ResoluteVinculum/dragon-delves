---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/githyanki-warrior-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/3","ttrpg-cli/monster/environment/astral","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/aberration/gith"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/3","ttrpg-cli/monster/environment/astral","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/aberration/gith"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Githyanki Warrior"]}}
---

# [Githyanki Warrior](Rules\Source\bestiary\aberration/githyanki-warrior-xmm.md)
...
"saves":
  ...
  - "wisdom": !!int "3"
"gear":
  - "[half plate armor](/Rules/Source/items/half-plate-armor-xphb.md)"
...
"actions":
  ...
  - "desc": "The githyanki casts one of the following spells, requiring no spell components\
      ...
      \ Hand](/Rules/Source/spells/mage-hand-xphb.md) (the hand is [Invisible](/Rules/Source/conditions.md#Invisible))\n\
      \n**2/day:** [Nondetection](/Rules/Source/spells/nondetection-xphb.md) (self\
      \ only)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The githyanki casts [Misty Step](/Rules/Source/spells/misty-step-xphb.md),\
      \ requiring no spell components and using the same spellcasting ability as Spellcasting.\n"
    "name": "Misty Step (2/Day)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/githyanki-warrior-xmm.webp"
```{ #statblock}
