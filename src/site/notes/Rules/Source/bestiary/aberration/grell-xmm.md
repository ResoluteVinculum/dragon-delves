...
"condition_immunities": "[blinded](/Rules/Source/conditions.md#Blinded), [prone](/Rules/Source/conditions.md#Prone)"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 10 ft. *Hit:* 7 (1d10 + 2) Piercing damage.\
      ...
      \ target has the [Poisoned](/Rules/Source/conditions.md#Poisoned) condition\
      \ and repeats the save at the end of each of its turns, ending the effect on\
      \ itself on a success. After 1 minute, it succeeds automatically. While [Poisoned](/Rules/Source/conditions.md#Poisoned),\
      \ the target has the [Paralyzed](/Rules/Source/conditions.md#Paralyzed) condition."
    "name": "Paralyzing Tentacles"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/grell-xmm.webp"
```{ #statblock}
