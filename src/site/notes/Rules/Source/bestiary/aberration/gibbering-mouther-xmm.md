...
"condition_immunities": "[prone](/Rules/Source/conditions.md#Prone)"
"senses": "[Darkvision](/Rules/Source/senses.md#Darkvision) 60 ft., passive Perception\
  \ 10"
"languages": ""
"cr": "2"
"traits":
  - "desc": "The ground in a 10-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the mouther is [Difficult Terrain](/Rules/Source/variant-rules/difficult-terrain-xphb.md)."
    "name": "Aberrant Ground"
  - "desc": "The mouther babbles incoherently while it doesn't have the [Incapacitated](/Rules/Source/conditions.md#Incapacitated)\
      ...
      \ Action](/Rules/Source/variant-rules/bonus-action-xphb.md) and uses all its\
...
"actions":
  - "desc": "*Melee Attack Roll:* +2, reach 5 ft. *Hit:* 7 (2d6) Piercing damage.\
      ...
      \ condition. The target dies if it is reduced to 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      \ by this attack. Its body is then absorbed into the mouther, leaving only equipment\
      \ behind."
    "name": "Bite"
  - "desc": "*Dexterity Saving Throw:* DC 10, each creature in a 10-foot-radius [Sphere](/Rules/Source/variant-rules/sphere-area-of-effect-xphb.md)\
      \ centered on a point within 30 feet. *Failure:* 7 (2d6) Radiant damage, and\
      \ the target has the [Blinded](/Rules/Source/conditions.md#Blinded) condition\
      \ until the end of the mouther's next turn."
    "name": "Blinding Spittle (Recharge 5-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/gibbering-mouther-xmm.webp"
```{ #statblock}
