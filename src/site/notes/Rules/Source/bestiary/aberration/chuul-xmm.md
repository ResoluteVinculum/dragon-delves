---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/chuul-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/4","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/swamp","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/aberration"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/4","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/swamp","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/aberration"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Chuul"]}}
---

# [Chuul](Rules\Source\bestiary\aberration/chuul-xmm.md)
...
"traits":
  ...
  - "desc": "The chuul senses magic within 120 feet of itself. This trait otherwise\
      \ works like the [Detect Magic](/Rules/Source/spells/detect-magic-xphb.md) spell\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 10 ft. *Hit:* 9 (1d10 + 4) Bludgeoning\
      \ damage. If the target is a Large or smaller creature, it has the [Grappled](/Rules/Source/conditions.md#Grappled)\
      \ condition (escape DC 14) from one of two pincers."
    "name": "Pincer"
  - "desc": "*Constitution Saving Throw:* DC 13, one creature [Grappled](/Rules/Source/conditions.md#Grappled)\
      \ by the chuul. *Failure:* The target has the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/chuul-xmm.webp"
```{ #statblock}
