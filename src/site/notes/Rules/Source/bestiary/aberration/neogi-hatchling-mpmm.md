---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/neogi-hatchling-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1-8","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/tiny","ttrpg-cli/monster/type/aberration"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1-8","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/tiny","ttrpg-cli/monster/type/aberration"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Neogi Hatchling"]}}
---

# [Neogi Hatchling](Rules\Source\bestiary\aberration/neogi-hatchling-mpmm.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +3 to hit, reach 5 ft., one target. *Hit:* 3 (1d4\
      ...
      \ on a DC 10 Constitution saving throw or become [poisoned](/Rules/Source/conditions.md#Poisoned)\
      \ for 1 minute. A target can repeat the saving throw at the end of each of its\
      \ turns, ending the effect on itself on a success."
    "name": "Bite"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/aberration/token/neogi-hatchling-mpmm.webp"
```{ #statblock}
