---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/star-spawn-mangler-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/aberration"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/aberration"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Star Spawn Mangler"]}}
---

# [Star Spawn Mangler](Rules\Source\bestiary\aberration/star-spawn-mangler-mpmm.md)
...
"actions":
  ...
  - "desc": "The mangler makes six Claw attacks. Either before or after these attacks,\
      \ it can move up to its speed without provoking [opportunity attacks](/Rules/Source/actions.md#Opportunity%20Attack)."
    "name": "Flurry of Claws (Recharge 5-6)"
"bonus_actions":
  - "desc": "While in dim light or darkness, the mangler takes the [Hide](/Rules/Source/actions.md#Hide)\
      \ action."
    "name": "Shadow Stealth"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/aberration/token/star-spawn-mangler-mpmm.webp"
```
^statblock