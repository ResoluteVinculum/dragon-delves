---
{"dg-publish":true,"permalink":"/rules/source/bestiary/undead/death-tyrant-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/14","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/undead/beholder"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/14","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/undead/beholder"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Death Tyrant"]}}
---

# [Death Tyrant](Rules\Source\bestiary\undead/death-tyrant-xmm.md)
...
"actions":
  ...
  - "desc": "The death tyrant randomly shoots one of the following magical rays at\
      \ a target it can see within 120 feet of itself (roll 1d10; reroll if the death\
      \ tyrant has already used that ray during this turn):\n\n- **1 Charm Ray.**\
      \ *Wisdom Saving Throw:* DC 17. *Failure:* 13 (3d8) Psychic damage, and the\
      \ target has the [Charmed](/Rules/Source/conditions.md#Charmed) condition for\
      \ 1 hour or until it takes damage. *Success:* Half damage only.  \n- **2 Paralyzing\
      \ Ray.** *Constitution Saving Throw:* DC 17. *Failure:* The target has the [Paralyzed](/Rules/Source/conditions.md#Paralyzed)\
      ...
      \ take Reactions; its [Speed](/Rules/Source/variant-rules/speed-xphb.md) is\
      \ halved; and it can take either an action or a [Bonus Action](/Rules/Source/variant-rules/bonus-action-xphb.md)\
      \ on its turn, not both. *Success:* Half damage only.  \n- **5 Enervation Ray.**\
      \ *Constitution Saving Throw:* DC 17. *Failure:* 16 (3d10) Poison damage, and\
      \ the target has the [Poisoned](/Rules/Source/conditions.md#Poisoned) condition\
      \ until the end of its next turn. While [Poisoned](/Rules/Source/conditions.md#Poisoned),\
      \ the target can't regain [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md).\
      ...
      \ has the [Restrained](/Rules/Source/conditions.md#Restrained) condition until\
      \ the start of the death tyrant's next turn or until the death tyrant has the\
      \ [Incapacitated](/Rules/Source/conditions.md#Incapacitated) condition. The\
      \ death tyrant can also exert fine control on objects with this ray, such as\
      \ manipulating a tool or opening a door or container.  \n- **7 Sleep Ray.**\
      \ *Wisdom Saving Throw:* DC 17 (the target succeeds automatically if it is a\
      \ Construct or an Undead). *Failure:* The target has the [Unconscious](/Rules/Source/conditions.md#Unconscious)\
      ...
      \ [Restrained](/Rules/Source/conditions.md#Restrained) condition and repeats\
      \ the save at the end of its next turn if it is still [Restrained](/Rules/Source/conditions.md#Restrained),\
      \ ending the effect on itself on a success. *2Nd Failure:* The target has the\
      \ [Petrified](/Rules/Source/conditions.md#Petrified) condition instead of the\
      \ [Restrained](/Rules/Source/conditions.md#Restrained) condition.  \n- **9 Disintegration\
      \ Ray.** *Dexterity Saving Throw:* DC 17. *Failure:* 36 (8d8) Force damage.\
      \ If the target is a nonmagical object or a creation of magical force, a 10-foot\
      \ [Cube](/Rules/Source/variant-rules/cube-area-of-effect-xphb.md) of it disintegrates\
      \ into dust. *Success:* Half damage. *Failure or Success:* If the target is\
      \ a creature and this damage reduces it to 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md),\
      ...
      \ or Success:* The target dies if the ray reduces it to 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md).\
      \  "
    "name": "Eye Rays"
"bonus_actions":
  - "desc": "The death tyrant's central eye emits an imperceptible, magical wave of\
      \ negative energy in a 150-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ Creatures in that area can't regain [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      \ until the start of the death tyrant's next turn. An intact Humanoid corpse\
      \ there instantly rises as a [Zombie](/Rules/Source/bestiary/undead/zombie-xmm.md)\
...
"regional_effects":
  - "desc": "The region containing a death tyrant's lair is warped by its presence,\
      ...
      \ a creature within 1 mile of the lair regains [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      \ from a spell, it subtracts 1d10 from the number of [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      ...
      \ allies) that finishes a [Short Rest](/Rules/Source/variant-rules/short-rest-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/undead/token/death-tyrant-xmm.webp"
```{ #statblock}
