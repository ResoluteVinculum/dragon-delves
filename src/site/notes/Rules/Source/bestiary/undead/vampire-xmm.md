---
{"dg-publish":true,"permalink":"/rules/source/bestiary/undead/vampire-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/13","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/small-or-medium","ttrpg-cli/monster/type/undead"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/13","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/small-or-medium","ttrpg-cli/monster/type/undead"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Vampire"]}}
---

# [Vampire](Rules\Source\bestiary\undead/vampire-xmm.md)
...
"traits":
  ...
  - "desc": "If the vampire drops to 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      ...
      \ has 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md) in mist\
      ...
      \ vampire form and has the [Paralyzed](/Rules/Source/conditions.md#Paralyzed)\
      \ condition until it regains any [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md),\
      \ and it regains 1 [Hit Point](/Rules/Source/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "The vampire has these weaknesses:\n\n- **Forbiddance.** The vampire can't\
      ...
      \ the vampire's heart while the vampire has the [Incapacitated](/Rules/Source/conditions.md#Incapacitated)\
      \ condition in its resting place, the vampire has the [Paralyzed](/Rules/Source/conditions.md#Paralyzed)\
      ...
      \ has [Disadvantage](/Rules/Source/variant-rules/disadvantage-xphb.md) on attack\
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 17, one creature within 5 feet that is\
      \ willing or that has the [Grappled](/Rules/Source/conditions.md#Grappled),\
      \ [Incapacitated](/Rules/Source/conditions.md#Incapacitated), or [Restrained](/Rules/Source/conditions.md#Restrained)\
      \ condition. *Failure:* 6 (1d4 + 4) Piercing damage plus 13 (3d8) Necrotic damage.\
      \ The target's [Hit Point](/Rules/Source/variant-rules/hit-points-xphb.md) maximum\
      \ decreases by an amount equal to the Necrotic damage taken, and the vampire\
      \ regains [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md) equal\
      \ to that amount. A Humanoid reduced to 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      \ by this damage and then buried rises the following sunset as a [Vampire Spawn](/Rules/Source/bestiary/undead/vampire-spawn-xmm.md)\
      \ under the vampire's control."
    "name": "Bite (Bat or Vampire Form Only)"
"bonus_actions":
  - "desc": "If the vampire isn't in sunlight or running water, it shape-shifts into\
      \ a Tiny bat ([Speed](/Rules/Source/variant-rules/speed-xphb.md) 5 ft., [Fly\
      \ Speed](/Rules/Source/variant-rules/fly-speed-xphb.md) 30 ft.) or a Medium\
      \ cloud of mist ([Speed](/Rules/Source/variant-rules/speed-xphb.md) 5 ft., [Fly\
      \ Speed](/Rules/Source/variant-rules/fly-speed-xphb.md) 20 ft. [hover]), or\
      \ it returns to its vampire form. Anything it is wearing transforms with it.\n\
      \nWhile in bat form, the vampire can't speak. Its game statistics, other than\
      \ its size and [Speed](/Rules/Source/variant-rules/speed-xphb.md), are unchanged.\n\
      ...
      \ liquid. It has [Resistance](/Rules/Source/variant-rules/resistance-xphb.md)\
      \ to all damage, except the damage it takes from sunlight."
    "name": "Shape-Shift"
  - "desc": "The vampire casts [Charm Person](/Rules/Source/spells/charm-person-xphb.md),\
      \ requiring no spell components and using Charisma as the spellcasting ability\
      \ (spell save DC 17), and the duration is 24 hours. The [Charmed](/Rules/Source/conditions.md#Charmed)\
      \ target is a willing recipient of the vampire's Bite, the damage of which doesn't\
      \ end the spell. When the spell ends, the target is unaware it was [Charmed](/Rules/Source/conditions.md#Charmed)\
      \ by the vampire.\n"
...
"regional_effects":
  - "desc": "The region containing a vampire's lair is warped by its presence, creating\
      ...
      \ smaller Beasts have the [Charmed](/Rules/Source/conditions.md#Charmed) condition\
      \ while within 1 mile of the lair.  \n- **Looming Shadows.** Shadows within\
      \ 1 mile of the lair seem to move as if alive. Any creature (excluding the vampire\
      \ and its allies) that finishes a [Short Rest](/Rules/Source/variant-rules/short-rest-xphb.md)\
      ...
      \ of the lair is [Lightly Obscured](/Rules/Source/variant-rules/lightly-obscured-xphb.md)\
...
"legendary_actions":
  - "desc": "The vampire moves up to half its [Speed](/Rules/Source/variant-rules/speed-xphb.md),\
      \ and it makes one Grave Strike attack."
    "name": "Deathless Strike"
  - "desc": "The vampire casts [Command](/Rules/Source/spells/command-xphb.md), requiring\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/undead/token/vampire-xmm.webp"
```{ #statblock}
