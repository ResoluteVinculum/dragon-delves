---
{"dg-publish":true,"permalink":"/rules/source/bestiary/undead/deathlock-wight-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/3","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/undead/warlock"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/3","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/undead/warlock"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Deathlock Wight"]}}
---

# [Deathlock Wight](Rules\Source\bestiary\undead/deathlock-wight-mpmm.md)
...
"traits":
  - "desc": "While in sunlight, the deathlock has disadvantage on attack rolls, as\
      \ well as on Wisdom ([Perception](/Rules/Source/skills.md#Perception)) checks\
      \ that rely on sight."
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one creature. *Hit:* 6\
      ...
      \ by this attack rises 24 hours later as a [zombie](/Rules/Source/bestiary/undead/zombie-xmm.md)\
  ...
  - "desc": "The deathlock casts one of the following spells, using Charisma as the\
      ...
      \n**1/day each:** [fear](/Rules/Source/spells/fear-xphb.md), [hold person](/Rules/Source/spells/hold-person-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/undead/token/deathlock-wight-mpmm.webp"
```
^statblock