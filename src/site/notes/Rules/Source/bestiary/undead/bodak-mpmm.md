...
"traits":
  - "desc": "When a creature that can see the bodak's eyes starts its turn within\
      ...
      \ saving throw if the bodak isn't [incapacitated](/Rules/Source/conditions.md#Incapacitated)\
      \ and can see the creature. If the saving throw fails by 5 or more, the creature\
      \ is reduced to 0 hit points unless it is immune to the [frightened](/Rules/Source/conditions.md#Frightened)\
      \ condition. Otherwise, a creature takes 16 (3d10) psychic damage on a failed\
      \ save.\n\nUnless [surprised](/Rules/Source/conditions.md#Surprised), a creature\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/undead/token/bodak-mpmm.webp"
```{ #statblock}
