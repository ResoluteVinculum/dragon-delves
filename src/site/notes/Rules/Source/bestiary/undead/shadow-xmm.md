...
"traits":
  - "desc": "The shadow can move through a space as narrow as 1 inch without expending\
    ...
    "name": "Amorphous"
  - "desc": "While in sunlight, the shadow has [Disadvantage](/Rules/Source/variant-rules/disadvantage-xphb.md)\
      \ on [D20 Tests](/Rules/Source/variant-rules/d20-test-xphb.md)."
...
"bonus_actions":
  - "desc": "While in [Dim Light](/Rules/Source/variant-rules/dim-light-xphb.md) or\
      \ [Darkness](/Rules/Source/variant-rules/darkness-xphb.md), the shadow takes\
      \ the [Hide](/Rules/Source/actions.md#Hide) action."
    "name": "Shadow Stealth"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/undead/token/shadow-xmm.webp"
```{ #statblock}
