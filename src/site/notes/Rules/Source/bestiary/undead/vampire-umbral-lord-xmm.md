---
{"dg-publish":true,"permalink":"/rules/source/bestiary/undead/vampire-umbral-lord-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/15","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/small-or-medium","ttrpg-cli/monster/type/undead"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/15","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/small-or-medium","ttrpg-cli/monster/type/undead"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Vampire Umbral Lord"]}}
---

# [Vampire Umbral Lord](Rules\Source\bestiary\undead/vampire-umbral-lord-xmm.md)
...
"senses": "[Blindsight](/Rules/Source/senses.md#Blindsight) 120 ft., passive Perception\
  \ 23"
...
"traits":
  ...
  - "desc": "If the vampire drops to 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      ...
      \ inside its resting place, it has the [Paralyzed](/Rules/Source/conditions.md#Paralyzed)\
      \ condition for 1 hour, after which it regains 1 [Hit Point](/Rules/Source/variant-rules/hit-points-xphb.md)."
    "name": "Shadow Escape"
...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* +10, range 120 ft. *Hit:* 16 (2d10 + 5) Necrotic\
      \ damage, and the target has the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
      \ condition until the start of the vampire's next turn."
    "name": "Sickening Ray"
  - "desc": "The vampire casts [Hunger of Hadar](/Rules/Source/spells/hunger-of-hadar-xphb.md)\
...
"bonus_actions":
  - "desc": "*Constitution Saving Throw:* DC 18, one creature the vampire can see\
      ...
      \ damage. The target's [Hit Point](/Rules/Source/variant-rules/hit-points-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/undead/token/vampire-umbral-lord-xmm.webp"
```{ #statblock}
