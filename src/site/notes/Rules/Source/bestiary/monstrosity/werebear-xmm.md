...
"skillsaves":
  - "name": "[Perception](/Rules/Source/skills.md#Perception)"
    "desc": "+7"
"gear":
  - "four [handaxes](/Rules/Source/items/handaxe-xphb.md)"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 17 (2d12 + 4) Piercing damage.\
      ...
      \ instead becomes a Werebear under the DM's control and has 10 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md).\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/monstrosity/token/werebear-xmm.webp"
```{ #statblock}
