---
{"dg-publish":true,"permalink":"/rules/source/bestiary/monstrosity/chimera-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/monstrosity"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/monstrosity"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Chimera"]}}
---

# [Chimera](Rules\Source\bestiary\monstrosity/chimera-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 11 (2d6 + 4) Piercing damage,\
      \ or 18 (4d6 + 4) Piercing damage if the chimera had [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
      \ on the attack roll."
    "name": "Bite"
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 10 (1d12 + 4) Bludgeoning\
      ...
      \ condition."
    "name": "Ram"
  - "desc": "*Dexterity Saving Throw:* DC 15, each creature in a 15-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 31 (7d8) Fire damage. *Success:* Half damage."
    "name": "Fire Breath (Recharge 5-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/monstrosity/token/chimera-xmm.webp"
```{ #statblock}
