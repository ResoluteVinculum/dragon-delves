...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 8 (2d4 + 3) Piercing damage.\
      ...
      \ instead becomes a Wererat under the DM's control and has 10 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md).\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/monstrosity/token/wererat-xmm.webp"
```{ #statblock}
