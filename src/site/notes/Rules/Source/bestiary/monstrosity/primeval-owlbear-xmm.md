---
{"dg-publish":true,"permalink":"/rules/source/bestiary/monstrosity/primeval-owlbear-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/monstrosity"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/monstrosity"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Primeval Owlbear"]}}
---

# [Primeval Owlbear](Rules\Source\bestiary\monstrosity/primeval-owlbear-xmm.md)
...
"cr": "7"
"traits":
  - "desc": "The owlbear has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 5 ft. *Hit:* 15 (2d8 + 6) Slashing damage.\
      ...
      \ (2d8) Slashing damage and has the [Prone](/Rules/Source/conditions.md#Prone)\
      \ condition."
    "name": "Ravage"
  - "desc": "*Constitution Saving Throw:* DC 15, each creature in a 30-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the owlbear. *Failure:* 27 (6d8) Thunder damage, and the\
      \ target has the [Incapacitated](/Rules/Source/conditions.md#Incapacitated)\
      \ condition until the end of its next turn. *Success:* Half damage only."
    "name": "Screech (Recharge 5-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/monstrosity/token/primeval-owlbear-xmm.webp"
```{ #statblock}
