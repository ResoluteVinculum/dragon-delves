...
"saves":
  - "wisdom": !!int "6"
"condition_immunities": "[petrified](/Rules/Source/conditions.md#Petrified)"
"senses": "[Darkvision](/Rules/Source/senses.md#Darkvision) 120 ft., passive Perception\
  \ 13"
"languages": ""
"cr": "8"
"traits":
  - "desc": "The cockatrice doesn't provoke an [Opportunity Attack](/Rules/Source/actions.md#Opportunity%20Attack)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 13 (2d8 + 4) Piercing damage.\
      ...
      \ Saving Throw:* DC 14. *1St Failure:* The target has the [Restrained](/Rules/Source/conditions.md#Restrained)\
      \ condition and repeats the save at the end of its next turn if it is still\
      \ [Restrained](/Rules/Source/conditions.md#Restrained), ending the effect on\
      \ itself on a success. *2Nd Failure:* The target has the [Petrified](/Rules/Source/conditions.md#Petrified)\
      \ condition instead of the [Restrained](/Rules/Source/conditions.md#Restrained)\
      \ condition."
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/monstrosity/token/cockatrice-regent-xmm.webp"
```{ #statblock}
