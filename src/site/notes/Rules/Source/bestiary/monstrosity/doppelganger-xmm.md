---
{"dg-publish":true,"permalink":"/rules/source/bestiary/monstrosity/doppelganger-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/3","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/monstrosity"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/3","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/monstrosity"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Doppelganger"]}}
---

# [Doppelganger](Rules\Source\bestiary\monstrosity/doppelganger-xmm.md)
...
"actions":
  - "desc": "The doppelganger makes two Slam attacks and uses Unsettling Visage if\
      \ available."
    "name": "Multiattack"
  - "desc": "*Melee Attack Roll:* +6 (with [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
      \ during the first round of each combat), reach 5 ft. *Hit:* 11 (2d6 + 4) Bludgeoning\
      \ damage."
    "name": "Slam"
  - "desc": "*Wisdom Saving Throw:* DC 12, each creature in a 15-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
  ...
  - "desc": "The doppelganger casts [Detect Thoughts](/Rules/Source/spells/detect-thoughts-xphb.md),\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/monstrosity/token/doppelganger-xmm.webp"
```{ #statblock}
