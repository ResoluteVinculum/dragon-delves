---
{"dg-publish":true,"permalink":"/rules/source/bestiary/monstrosity/draconian-mage-ftd/","tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/monstrosity"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/monstrosity"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Draconian Mage"]}}
---

# [Draconian Mage](Rules\Source\bestiary\monstrosity/draconian-mage-ftd.md)
...
"traits":
  - "desc": "When the draconian is reduced to 0 hit points, its scales and flesh immediately\
    ...
    "name": "Death Throes"
  - "desc": "When the draconian falls and isn't [incapacitated](/Rules/Source/conditions.md#Incapacitated),\
...
"actions":
  ...
  - "desc": "The draconian casts one of the following spells, requiring no material\
      ...
      \n**1/day each:** [enlarge/reduce](/Rules/Source/spells/enlarge-reduce-xphb.md),\
      \ [invisibility](/Rules/Source/spells/invisibility-xphb.md), [stinking cloud](/Rules/Source/spells/stinking-cloud-xphb.md)"
    "name": "Spellcasting"
"source":
  - "FTD"
"image": "/Rules/Source/bestiary/monstrosity/token/draconian-mage-ftd.webp"
```
^statblock