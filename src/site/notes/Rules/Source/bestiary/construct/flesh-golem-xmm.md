---
{"dg-publish":true,"permalink":"/rules/source/bestiary/construct/flesh-golem-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/construct"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/construct"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Flesh Golem"]}}
---

# [Flesh Golem](Rules\Source\bestiary\construct/flesh-golem-xmm.md)
...
"cr": "5"
"traits":
  - "desc": "If the golem takes Fire damage, it has [Disadvantage](/Rules/Source/variant-rules/disadvantage-xphb.md)\
      \ on attack rolls and ability checks until the end of its next turn."
    "name": "Aversion to Fire"
  - "desc": "Whenever the golem starts its turn [Bloodied](/Rules/Source/conditions.md#Bloodied),\
      ...
      \ goes berserk, it remains so until it is destroyed or it is no longer [Bloodied](/Rules/Source/conditions.md#Bloodied).\n\
      \nThe golem's creator, if within 60 feet of the berserk golem, can try to calm\
      \ it by taking an action to make a DC 15 Charisma ([Persuasion](/Rules/Source/skills.md#Persuasion))\
      ...
      \ point it resumes rolling for the Berserk trait again if it is still [Bloodied](/Rules/Source/conditions.md#Bloodied)."
    "name": "Berserk"
  - "desc": "The golem can't shape-shift."
    "name": "Immutable Form"
  - "desc": "Whenever the golem is subjected to Lightning damage, it regains a number\
      \ of [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md) equal to the\
      \ Lightning damage dealt."
    "name": "Lightning Absorption"
  - "desc": "The golem has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/construct/token/flesh-golem-xmm.webp"
```{ #statblock}
