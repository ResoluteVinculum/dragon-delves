---
{"dg-publish":true,"permalink":"/rules/source/bestiary/construct/clockwork-bronze-scout-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/construct"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/construct"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Clockwork Bronze Scout"]}}
---

# [Clockwork Bronze Scout](Rules\Source\bestiary\construct/clockwork-bronze-scout-mpmm.md)
...
|-----------|-------------|
| 1 | **Camouflaged.** The clockwork gains proficiency in [[Rules/Source/skills#Stealth\|Stealth]] if it lacks that proficiency. While motionless, it is indistinguishable from a stopped machine. |
| 2 | **Sensors.** The range of the clockwork's [[Rules/Source/senses#Darkvision\|darkvision]] increases by 60 feet, and it gains proficiency in [[Rules/Source/skills#Perception\|Perception]] if it lacks that proficiency. |
...
| 10 | **Water Propulsion.** The clockwork gains a swimming speed of 30 feet. |{ #clockwork-enhancements}
...
| dice: d8 | Malfunction |
|----------|-------------|
| 1 | **Faulty Sensors.** Roll a `d6` at the start of the clock work's turn. If you roll a 1, the clockwork is [[Rules/Source/conditions#Blinded\|blinded]] until the end of its turn. |
...
| 7 | **Overheats.** Roll a `d6` at the start of the clockwork's turn. If you roll a 1, the clockwork is [[Rules/Source/conditions#Incapacitated\|incapacitated]] until the end of its turn. |
| 8 | **Rusty Gears.** The clockwork has disadvantage on initiative rolls, and its speed decreases by 10 feet. |{ #clockwork-malfunctions}
...
"cr": "1"
"traits":
  - "desc": "The clockwork doesn't provoke [opportunity attacks](/Rules/Source/actions.md#Opportunity%20Attack)\
      \ when it burrows."
    "name": "Earth Armor"
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/construct/token/clockwork-bronze-scout-mpmm.webp"
```{ #statblock}
