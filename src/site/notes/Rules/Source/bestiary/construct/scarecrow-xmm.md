---
{"dg-publish":true,"permalink":"/rules/source/bestiary/construct/scarecrow-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/construct"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/construct"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Scarecrow"]}}
---

# [Scarecrow](Rules\Source\bestiary\construct/scarecrow-xmm.md)
...
"actions":
  - "desc": "*Melee Attack Roll:* +3, reach 5 ft. *Hit:* 6 (2d4 + 1) Slashing damage,\
      \ and the target has the [Frightened](/Rules/Source/conditions.md#Frightened)\
  ...
  - "desc": "*Wisdom Saving Throw:* DC 11, one creature the scarecrow can see within\
      \ 30 feet. *Failure:* The target has the [Frightened](/Rules/Source/conditions.md#Frightened)\
      \ condition until the end of the scarecrow's next turn. While [Frightened](/Rules/Source/conditions.md#Frightened),\
      \ the target has the [Paralyzed](/Rules/Source/conditions.md#Paralyzed) condition."
    "name": "Terrifying Glare"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/construct/token/scarecrow-xmm.webp"
```{ #statblock}
