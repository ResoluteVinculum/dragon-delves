---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fey/dolphin-delighter-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/3","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/3","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Dolphin Delighter"]}}
---

# [Dolphin Delighter](Rules\Source\bestiary\fey/dolphin-delighter-mpmm.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 5 (1d6\
      \ + 2) bludgeoning damage plus 7 (2d6) psychic damage, and the target is [blinded](/Rules/Source/conditions.md#Blinded)\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fey/token/dolphin-delighter-mpmm.webp"
```{ #statblock}
