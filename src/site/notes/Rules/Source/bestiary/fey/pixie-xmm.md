...
"actions":
  - "desc": "*Melee  or Ranged Attack Roll:* +4, reach 5 ft. or range 60 ft. *Hit:*\
      \ 1 Radiant damage, and the target has the [Charmed](/Rules/Source/conditions.md#Charmed)\
  ...
  - "desc": "The pixie casts one of the following spells, requiring no Material components\
      ...
      **1/day each:** [Detect Thoughts](/Rules/Source/spells/detect-thoughts-xphb.md),\
      \ [Fly](/Rules/Source/spells/fly-xphb.md), [Sleep](/Rules/Source/spells/sleep-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fey/token/pixie-xmm.webp"
```{ #statblock}
