---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fey/bheur-hag-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/environment/arctic","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/environment/arctic","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Bheur Hag"]}}
---

# [Bheur Hag](Rules\Source\bestiary\fey/bheur-hag-mpmm.md)
...
"cr": "7"
"traits":
  - "desc": "The hag can cast the [control weather](/Rules/Source/spells/control-weather-xphb.md)\
...
"actions":
  ...
  - "desc": "The hag feeds on the corpse of one enemy within reach that died within\
      ...
      \ be [frightened](/Rules/Source/conditions.md#Frightened) of the hag for 1 minute.\
      \ While [frightened](/Rules/Source/conditions.md#Frightened) in this way, a\
      \ creature is [incapacitated](/Rules/Source/conditions.md#Incapacitated), can't\
      \ understand what others say, can't read, and speaks only in gibberish. A creature\
      \ can repeat the saving throw at the end of each of its turns, ending the effect\
      \ on itself on a success. If a creature's saving throw is successful or the\
      \ effect ends for it, the creature is immune to the hag's Horrific Feast for\
      \ the next 24 hours."
    "name": "Horrific Feast"
  - "desc": "While holding or riding the graystaff, the hag casts one of the following\
      ...
      \ ability (spell save DC 14):\n\n**At will:** [hold person](/Rules/Source/spells/hold-person-xphb.md)\n\
      \n**1/day each:** [cone of cold](/Rules/Source/spells/cone-of-cold-xphb.md),\
      \ [ice storm](/Rules/Source/spells/ice-storm-xphb.md), [wall of ice](/Rules/Source/spells/wall-of-ice-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fey/token/bheur-hag-mpmm.webp"
```{ #statblock}
