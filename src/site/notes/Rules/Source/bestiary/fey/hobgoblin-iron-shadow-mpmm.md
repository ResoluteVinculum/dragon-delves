---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fey/hobgoblin-iron-shadow-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey/goblinoid"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey/goblinoid"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Hobgoblin Iron Shadow"]}}
---

# [Hobgoblin Iron Shadow](Rules\Source\bestiary\fey/hobgoblin-iron-shadow-mpmm.md)
...
"skillsaves":
  ...
  - "name": "[Stealth](/Rules/Source/skills.md#Stealth)"
    "desc": "+5"
"gear":
  - "[dart](/Rules/Source/items/dart-xphb.md)"
...
"actions":
  ...
  - "desc": "The hobgoblin casts one of the following spells, using Intelligence as\
      \ the spellcasting ability (spell save DC 12):\n\n**At will:** [minor illusion](/Rules/Source/spells/minor-illusion-xphb.md),\
      \ [prestidigitation](/Rules/Source/spells/prestidigitation-xphb.md)\n\n**1/day\
      \ each:** [charm person](/Rules/Source/spells/charm-person-xphb.md), [disguise\
      \ self](/Rules/Source/spells/disguise-self-xphb.md), [silent image](/Rules/Source/spells/silent-image-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fey/token/hobgoblin-iron-shadow-mpmm.webp"
```{ #statblock}
