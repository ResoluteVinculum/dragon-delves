---
{"dg-publish":true,"permalink":"/rules/source/bestiary/beast/giant-insect-xphb/","tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/monster/cr/","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/beast"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/monster/cr/","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/beast"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Giant Insect"]}}
---

# [Giant Insect](Rules\Source\bestiary\beast/giant-insect-xphb.md)
...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* Bonus equals your spell attack modifier, range\
      ...
      \ [Speed](/Rules/Source/variant-rules/speed-xphb.md) is reduced to 0 until the\
      \ start of the insect's next turn."
...
"source":
  - "XPHB"
"image": "/Rules/Source/bestiary/beast/token/giant-insect-xphb.webp"
```
^statblock