---
{"dg-publish":true,"permalink":"/rules/source/bestiary/beast/hunter-shark-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/beast"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/beast"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Hunter Shark"]}}
---

# [Hunter Shark](Rules\Source\bestiary\beast/hunter-shark-xmm.md)
...
"actions":
  - "desc": "*Melee Attack Roll:* +6 (with [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
      \ if the target doesn't have all its [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)),\
      \ reach 5 ft. *Hit:* 14 (3d6 + 4) Piercing damage."
    "name": "Bite"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/beast/token/hunter-shark-xmm.webp"
```{ #statblock}
