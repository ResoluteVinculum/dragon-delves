---
{"dg-publish":true,"permalink":"/rules/source/bestiary/beast/giant-crocodile-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/swamp","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/beast"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/swamp","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/beast"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Giant Crocodile"]}}
---

# [Giant Crocodile](Rules\Source\bestiary\beast/giant-crocodile-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +8, reach 5 ft. *Hit:* 21 (3d10 + 5) Piercing damage.\
      ...
      \ condition (escape DC 15). While [Grappled](/Rules/Source/conditions.md#Grappled),\
  ...
  - "desc": "*Melee Attack Roll:* +8, reach 10 ft. *Hit:* 18 (3d8 + 5) Bludgeoning\
      \ damage. If the target is a Large or smaller creature, it has the [Prone](/Rules/Source/conditions.md#Prone)\
      \ condition."
    "name": "Tail"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/beast/token/giant-crocodile-xmm.webp"
```{ #statblock}
