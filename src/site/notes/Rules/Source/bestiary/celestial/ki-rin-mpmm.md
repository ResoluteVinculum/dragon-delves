---
{"dg-publish":true,"permalink":"/rules/source/bestiary/celestial/ki-rin-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/12","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/celestial"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/12","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/celestial"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Ki-rin"]}}
---

# [Ki-rin](Rules\Source\bestiary\celestial/ki-rin-mpmm.md)
...
"senses": "[darkvision](/Rules/Source/senses.md#Darkvision) 120 ft., [truesight](/Rules/Source/senses.md#Truesight)\
...
"actions":
  ...
  - "desc": "The ki-rin casts one of the following spells, requiring no material components\
      ...
      \ [light](/Rules/Source/spells/light-xphb.md), [major image](/Rules/Source/spells/major-image-xphb.md)\
      \ (6th-level version), [thaumaturgy](/Rules/Source/spells/thaumaturgy-xphb.md)\n\
      \n**3/day each:** [cure wounds](/Rules/Source/spells/cure-wounds-xphb.md), [dispel\
      \ magic](/Rules/Source/spells/dispel-magic-xphb.md), [lesser restoration](/Rules/Source/spells/lesser-restoration-xphb.md),\
      \ [sending](/Rules/Source/spells/sending-xphb.md)\n\n**1/day each:** [banishment](/Rules/Source/spells/banishment-xphb.md),\
      \ [calm emotions](/Rules/Source/spells/calm-emotions-xphb.md), [create food\
      \ and water](/Rules/Source/spells/create-food-and-water-xphb.md), [greater restoration](/Rules/Source/spells/greater-restoration-xphb.md),\
      \ [plane shift](/Rules/Source/spells/plane-shift-xphb.md), [protection from\
      \ evil and good](/Rules/Source/spells/protection-from-evil-and-good-xphb.md),\
      \ [revivify](/Rules/Source/spells/revivify-xphb.md), [wind walk](/Rules/Source/spells/wind-walk-xphb.md)"
    "name": "Spellcasting"
"lair_actions":
...
"regional_effects":
  - "desc": "A ki-rin's Celestial nature transforms the region around its lair. Any\
      ...
      \ prey.  \n- **Controlled Weather.** A ki-rin can cast [control weather](/Rules/Source/spells/control-weather-xphb.md)\
...
"legendary_actions":
  - "desc": "The ki-rin moves up to half its speed without provoking [opportunity\
      \ attacks](/Rules/Source/actions.md#Opportunity%20Attack)."
    "name": "Move"
  - "desc": "The ki-rin makes one Hoof, Horn, or Sacred Fire attack."
    "name": "Smite"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/celestial/token/ki-rin-mpmm.webp"
```{ #statblock}
