...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 15, one Medium or smaller creature the couatl\
      ...
      \ DC 13), and it has the [Restrained](/Rules/Source/conditions.md#Restrained)\
      \ condition until the grapple ends."
    "name": "Constrict"
  - "desc": "The couatl casts one of the following spells, requiring no spell components\
      \ and using Wisdom as the spellcasting ability (spell save DC 15):\n\n**At will:**\
      \ [Detect Evil and Good](/Rules/Source/spells/detect-evil-and-good-xphb.md),\
      \ [Detect Magic](/Rules/Source/spells/detect-magic-xphb.md), [Detect Thoughts](/Rules/Source/spells/detect-thoughts-xphb.md),\
      ...
      \ required to maintain the spell)\n\n**1/day each:** [Create Food and Water](/Rules/Source/spells/create-food-and-water-xphb.md),\
      \ [Dream](/Rules/Source/spells/dream-xphb.md), [Greater Restoration](/Rules/Source/spells/greater-restoration-xphb.md),\
      \ [Scrying](/Rules/Source/spells/scrying-xphb.md), [Sleep](/Rules/Source/spells/sleep-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The couatl casts [Bless](/Rules/Source/spells/bless-xphb.md), [Lesser\
      \ Restoration](/Rules/Source/spells/lesser-restoration-xphb.md), or [Sanctuary](/Rules/Source/spells/sanctuary-xphb.md),\
      \ requiring no spell components and using the same spellcasting ability as Spellcasting.\n"
    "name": "Divine Aid (2/Day)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/celestial/token/couatl-xmm.webp"
```{ #statblock}
