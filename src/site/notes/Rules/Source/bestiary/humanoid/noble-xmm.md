...
"skillsaves":
  ...
  - "name": "[Persuasion](/Rules/Source/skills.md#Persuasion)"
    "desc": "+5"
"gear":
  - "[breastplate](/Rules/Source/items/breastplate-xphb.md)"
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/humanoid/token/noble-xmm.webp"
```{ #statblock}
