...
"gear":
  ...
  - "[musket](/Rules/Source/items/musket-xphb.md)"
...
"traits":
  ...
  - "desc": "The giff can try to knock a creature over; if the giff moves at least\
      ...
      \ bludgeoning damage and be knocked [prone](/Rules/Source/conditions.md#Prone)."
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/humanoid/token/giff-mpmm.webp"
```{ #statblock}
