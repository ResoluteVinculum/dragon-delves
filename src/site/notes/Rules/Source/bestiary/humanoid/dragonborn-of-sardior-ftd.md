---
{"dg-publish":true,"permalink":"/rules/source/bestiary/humanoid/dragonborn-of-sardior-ftd/","tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/humanoid"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/humanoid"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Dragonborn of Sardior"]}}
---

# [Dragonborn of Sardior](Rules\Source\bestiary\humanoid/dragonborn-of-sardior-ftd.md)
...
"actions":
  ...
  - "desc": "The dragonborn casts one of the following spells, requiring no spell\
      ...
      \ DC 15, +7 to hit with spell attacks):\n\n**1/day each:** [Bigby's hand](/Rules/Source/spells/bigbys-hand-xphb.md),\
      \ [hypnotic pattern](/Rules/Source/spells/hypnotic-pattern-xphb.md), [telekinesis](/Rules/Source/spells/telekinesis-xphb.md)"
    "name": "Spellcasting (Psionics)"
"source":
  - "FTD"
"image": "/Rules/Source/bestiary/humanoid/token/dragonborn-of-sardior-ftd.webp"
```
^statblock