---
{"dg-publish":true,"permalink":"/rules/source/bestiary/humanoid/archpriest-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/12","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/small-or-medium","ttrpg-cli/monster/type/humanoid/cleric"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/12","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/small-or-medium","ttrpg-cli/monster/type/humanoid/cleric"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Archpriest"]}}
---

# [Archpriest](Rules\Source\bestiary\humanoid/archpriest-xmm.md)
...
- **Habitat.** Any  
- **Treasure.** Individual, [[Rules/Source/tables/random-magic-items-relics\|Relics]]  
...
"skillsaves":
  ...
  - "name": "[Religion](/Rules/Source/skills.md#Religion)"
    "desc": "+10"
"gear":
  - "[chain mail](/Rules/Source/items/chain-mail-xphb.md)"
  - "[holy symbol](/Rules/Source/items/holy-symbol-xphb.md)"
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +9, reach 5 ft. or range 60 ft. *Hit:*\
    ...
    "name": "Radiant Burst"
  - "desc": "*Wisdom Saving Throw:* DC 17, each enemy in a 20-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the archpriest. *Failure:* 21 (6d6) Radiant damage, and the\
      \ target has the [Stunned](/Rules/Source/conditions.md#Stunned) condition until\
  ...
  - "desc": "The archpriest casts one of the following spells, requiring no Material\
      ...
      \n**At will:** [Light](/Rules/Source/spells/light-xphb.md), [Thaumaturgy](/Rules/Source/spells/thaumaturgy-xphb.md)\n\
      \n**1/day each:** [Flame Strike](/Rules/Source/spells/flame-strike-xphb.md)\
      \ (level 6 version), [Greater Restoration](/Rules/Source/spells/greater-restoration-xphb.md),\
      \ [Raise Dead](/Rules/Source/spells/raise-dead-xphb.md), [Zone of Truth](/Rules/Source/spells/zone-of-truth-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The priest casts [Bless](/Rules/Source/spells/bless-xphb.md), [Dispel\
      \ Magic](/Rules/Source/spells/dispel-magic-xphb.md), [Healing Word](/Rules/Source/spells/healing-word-xphb.md),\
      \ or [Lesser Restoration](/Rules/Source/spells/lesser-restoration-xphb.md),\
      \ using the same spellcasting ability as Spellcasting.\n"
    "name": "Divine Aid (3/Day)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/humanoid/token/archpriest-xmm.webp"
```{ #statblock}
