---
{"dg-publish":true,"permalink":"/rules/source/bestiary/humanoid/mage-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/small-or-medium","ttrpg-cli/monster/type/humanoid/wizard"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/small-or-medium","ttrpg-cli/monster/type/humanoid/wizard"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Mage"]}}
---

# [Mage](Rules\Source\bestiary\humanoid/mage-xmm.md)
...
"actions":
  ...
  - "desc": "The mage casts one of the following spells, using Intelligence as the\
      ...
      \n**2/day each:** [Fireball](/Rules/Source/spells/fireball-xphb.md) (level 4\
      \ version), [Invisibility](/Rules/Source/spells/invisibility-xphb.md)\n\n**1/day\
      \ each:** [Cone of Cold](/Rules/Source/spells/cone-of-cold-xphb.md), [Fly](/Rules/Source/spells/fly-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"reactions":
  - "desc": "The mage casts [Counterspell](/Rules/Source/spells/counterspell-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/humanoid/token/mage-xmm.webp"
```{ #statblock}
