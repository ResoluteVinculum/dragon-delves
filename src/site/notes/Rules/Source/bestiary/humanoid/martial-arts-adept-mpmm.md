...
| 8 | Detailed landscape depicting natural beauty |{ #martial-arts-adept-tattoos}
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 7 (1d8\
      ...
      \ target must succeed on a DC 13 Dexterity saving throw or be knocked [prone](/Rules/Source/conditions.md#Prone).\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/humanoid/token/martial-arts-adept-mpmm.webp"
```{ #statblock}
