...
"traits":
  - "desc": "At the start of each of the warlock's turns, each creature of its choice\
      ...
      \ (3d6) psychic damage, provided that the warlock isn't [incapacitated](/Rules/Source/conditions.md#Incapacitated)."
...
"actions":
  ...
  - "desc": "The warlock opens a momentary extraplanar rift within 60 feet of it.\
      ...
      \ save, a creature takes half as much damage and isn't [frightened](/Rules/Source/conditions.md#Frightened)."
    "name": "Howling Void"
  - "desc": "The warlock casts one of the following spells, using Charisma as the\
      ...
      \ [guidance](/Rules/Source/spells/guidance-xphb.md), [levitate](/Rules/Source/spells/levitate-xphb.md),\
      \ [mage armor](/Rules/Source/spells/mage-armor-xphb.md) (self only), [mage hand](/Rules/Source/spells/mage-hand-xphb.md),\
      \ [minor illusion](/Rules/Source/spells/minor-illusion-xphb.md), [prestidigitation](/Rules/Source/spells/prestidigitation-xphb.md)\n\
      \n**1/day each:** [arcane gate](/Rules/Source/spells/arcane-gate-xphb.md), [detect\
      \ thoughts](/Rules/Source/spells/detect-thoughts-xphb.md), [true seeing](/Rules/Source/spells/true-seeing-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/humanoid/token/warlock-of-the-great-old-one-mpmm.webp"
```{ #statblock}
