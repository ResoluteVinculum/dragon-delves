---
{"dg-publish":true,"permalink":"/rules/source/bestiary/plant/myconid-adult-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-2","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/plant"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-2","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/plant"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Myconid Adult"]}}
---

# [Myconid Adult](Rules\Source\bestiary\plant/myconid-adult-xmm.md)
...
"cr": "1/2"
"traits":
  - "desc": "While in sunlight, the myconid has [Disadvantage](/Rules/Source/variant-rules/disadvantage-xphb.md)\
      \ on [D20 Tests](/Rules/Source/variant-rules/d20-test-xphb.md). The myconid\
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 11, one creature the myconid can see\
      \ within 10 feet. *Failure:* The target has the [Stunned](/Rules/Source/conditions.md#Stunned)\
      \ condition and repeats the save at the end of each of its turns, ending the\
      \ effect on itself on a success. After 1 minute, it succeeds automatically."
    "name": "Pacifying Spores (1/Day)"
  - "desc": "The myconid expels spores in a 30-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/plant/token/myconid-adult-xmm.webp"
```{ #statblock}
