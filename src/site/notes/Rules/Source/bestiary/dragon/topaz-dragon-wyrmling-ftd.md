---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/topaz-dragon-wyrmling-ftd/","tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/dragon/gem"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/dragon/gem"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Topaz Dragon Wyrmling"]}}
---

# [Topaz Dragon Wyrmling](Rules\Source\bestiary\dragon/topaz-dragon-wyrmling-ftd.md)
...
| 3 | A topaz dragon wyrmling has developed a taste for crab meat and persistently hunts a giant crab that always manages to evade the wyrmling. (The crab might have been the recipient of a druid's [[Rules/Source/spells/awaken-xphb\|awaken]] spell.) |
...
| 6 | A pirate crew keeps a curmudgeonly topaz dragon wyrmling as a beloved mascot. |{ #connected-creatures}
...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no spell components\
      ...
      **1/day each:** [bane](/Rules/Source/spells/bane-xphb.md)"
    "name": "Spellcasting (Psionics)"
"source":
  - "FTD"
"image": "/Rules/Source/bestiary/dragon/token/topaz-dragon-wyrmling-ftd.webp"
```
^statblock