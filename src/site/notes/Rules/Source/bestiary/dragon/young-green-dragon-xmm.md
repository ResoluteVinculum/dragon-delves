---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/young-green-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/8","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/dragon/chromatic"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/8","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/dragon/chromatic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Young Green Dragon"]}}
---

# [Young Green Dragon](Rules\Source\bestiary\dragon/young-green-dragon-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 10 ft. *Hit:* 11 (2d6 + 4) Slashing damage\
    ...
    "name": "Rend"
  - "desc": "*Constitution Saving Throw:* DC 14, each creature in a 30-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 42 (12d6) Poison damage. *Success:* Half damage."
    "name": "Poison Breath (Recharge 5-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/young-green-dragon-xmm.webp"
```{ #statblock}
