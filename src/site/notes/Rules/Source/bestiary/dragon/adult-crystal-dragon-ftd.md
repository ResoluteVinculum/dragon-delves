---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/adult-crystal-dragon-ftd/","tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/12","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/gem"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/12","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/gem"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Adult Crystal Dragon"]}}
---

# [Adult Crystal Dragon](Rules\Source\bestiary\dragon/adult-crystal-dragon-ftd.md)
...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no spell components\
      ...
      **At will:** [dancing lights](/Rules/Source/spells/dancing-lights-xphb.md),\
      \ [guidance](/Rules/Source/spells/guidance-xphb.md)\n\n**1/day each:** [command](/Rules/Source/spells/command-xphb.md),\
      \ [divination](/Rules/Source/spells/divination-xphb.md), [hypnotic pattern](/Rules/Source/spells/hypnotic-pattern-xphb.md),\
      \ [lesser restoration](/Rules/Source/spells/lesser-restoration-xphb.md)"
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), the dragon can take\
      ...
      \ in the glow. [Attack](/Rules/Source/actions.md#Attack) rolls made against\
      \ an outlined creature have advantage, and the creature can't hide or benefit\
      \ from being [invisible](/Rules/Source/conditions.md#Invisible). The starlight\
...
"regional_effects":
  - "desc": "The region surrounding a legendary crystal dragon's lair is altered by\
      ...
      \ As an action, the dragon can cast the [clairvoyance](/Rules/Source/spells/clairvoyance-xphb.md)\
...
"source":
  - "FTD"
"image": "/Rules/Source/bestiary/dragon/token/adult-crystal-dragon-ftd.webp"
```
^statblock