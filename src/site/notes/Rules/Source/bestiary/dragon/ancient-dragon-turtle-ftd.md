---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/ancient-dragon-turtle-ftd/","tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/24","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/24","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Ancient Dragon Turtle"]}}
---

# [Ancient Dragon Turtle](Rules\Source\bestiary\dragon/ancient-dragon-turtle-ftd.md)
...
| 3 | A [[Rules/Source/spells/geas-xphb\|geas]] spell forces an ancient dragon turtle to carry a lich's tower. |
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +16 to hit, reach 15 ft., one target. *Hit:* 20\
      ...
      \ on a DC 24 Strength saving throw or be knocked [prone](/Rules/Source/conditions.md#Prone)."
    "name": "Tail"
...
"lair_actions":
  - "desc": "As they are presented in the *Monster Manual*, dragon turtles don't have\
      ...
      \ area must succeed on a DC 15 Strength saving throw or be [restrained](/Rules/Source/conditions.md#Restrained)\
...
"source":
  - "FTD"
"image": "/Rules/Source/bestiary/dragon/token/ancient-dragon-turtle-ftd.webp"
```
^statblock