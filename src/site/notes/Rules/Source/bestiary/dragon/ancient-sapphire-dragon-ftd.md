---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/ancient-sapphire-dragon-ftd/","tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/22","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/gem"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/22","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/gem"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Ancient Sapphire Dragon"]}}
---

# [Ancient Sapphire Dragon](Rules\Source\bestiary\dragon/ancient-sapphire-dragon-ftd.md)
...
"actions":
  ...
  - "desc": "The dragon exhales a pulse of high-pitched, nearly inaudible sound in\
      ...
      \ and is [incapacitated](/Rules/Source/conditions.md#Incapacitated) until the\
      \ end of its next turn. On a successful save, the creature takes half as much\
      \ damage and isn't [incapacitated](/Rules/Source/conditions.md#Incapacitated)."
    "name": "Debilitating Breath (Recharge 5-6)"
  - "desc": "The dragon casts one of the following spells, requiring no spell components\
      \ and using Intelligence as the spellcasting ability (spell save DC 20):\n\n\
      **1/day each:** [dissonant whispers](/Rules/Source/spells/dissonant-whispers-xphb.md),\
      \ [hold monster](/Rules/Source/spells/hold-monster-xphb.md), [meld into stone](/Rules/Source/spells/meld-into-stone-xphb.md),\
      \ [telekinesis](/Rules/Source/spells/telekinesis-xphb.md), [teleport](/Rules/Source/spells/teleport-xphb.md)"
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), the dragon can take\
      ...
      \ saving throw or take 13 (3d8) thunder damage and be [stunned](/Rules/Source/conditions.md#Stunned)\
...
"regional_effects":
  - "desc": "The region surrounding a legendary sapphire dragon's lair is altered\
      ...
      \ for the dragon's psionic presence. As an action, the dragon can cast the [clairvoyance](/Rules/Source/spells/clairvoyance-xphb.md)\
      ...
      \ the [Rary's telepathic bond](/Rules/Source/spells/rarys-telepathic-bond-xphb.md)\
      \ spell.  \n- **Thriving Wildlife.** [Giant spiders](/Rules/Source/bestiary/beast/giant-spider-xmm.md)\
...
"source":
  - "FTD"
"image": "/Rules/Source/bestiary/dragon/token/ancient-sapphire-dragon-ftd.webp"
```
^statblock