---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/ancient-white-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/20","ttrpg-cli/monster/environment/arctic","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/chromatic"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/20","ttrpg-cli/monster/environment/arctic","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/chromatic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Ancient White Dragon"]}}
---

# [Ancient White Dragon](Rules\Source\bestiary\dragon/ancient-white-dragon-xmm.md)
...
"traits":
  - "desc": "The dragon can move across and climb icy surfaces without needing to\
      \ make an ability check. Additionally, [Difficult Terrain](/Rules/Source/variant-rules/difficult-terrain-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing an adult or ancient white dragon's lair is affected\
      ...
      \ area within 1 mile of the lair is an area of [extreme cold](/Rules/Source/traps-hazards/extreme-cold-xdmg.md).\
      \ Any water in that area is [frigid water](/Rules/Source/traps-hazards/frigid-water-xdmg.md).\
      \ See the \"Dungeon Master's Guide\" for rules on extreme cold and frigid water.\
      \  \n- **Glacial Gloom.** The area within 1 mile of the lair is [Lightly Obscured](/Rules/Source/variant-rules/lightly-obscured-xphb.md)\
      ...
      \ its [Speed](/Rules/Source/variant-rules/speed-xphb.md) reduced by 10 feet\
...
"legendary_actions":
  - "desc": "*Constitution Saving Throw:* DC 20, each creature in a 30-foot-radius\
      \ [Sphere](/Rules/Source/variant-rules/sphere-area-of-effect-xphb.md) centered\
      \ on a point the dragon can see within 120 feet. *Failure:* 14 (4d6) Cold damage,\
      \ and the target's [Speed](/Rules/Source/variant-rules/speed-xphb.md) is 0 until\
      \ the end of the target's next turn. *Failure or Success:* The dragon can't\
      \ take this action again until the start of its next turn."
    "name": "Freezing Burst"
  - "desc": "The dragon moves up to half its [Speed](/Rules/Source/variant-rules/speed-xphb.md),\
      \ and it makes one Rend attack."
    "name": "Pounce"
  - "desc": "The dragon casts [Fear](/Rules/Source/spells/fear-xphb.md), requiring\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/ancient-white-dragon-xmm.webp"
```{ #statblock}
