---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/amethyst-greatwyrm-ftd/","tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/26","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/gem"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/26","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/gem"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Amethyst Greatwyrm"]}}
---

# [Amethyst Greatwyrm](Rules\Source\bestiary\dragon/amethyst-greatwyrm-ftd.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +17 to hit, reach 10 ft., one target. *Hit:* 18\
      ...
      \ is [grappled](/Rules/Source/conditions.md#Grappled) (escape DC 19) and is\
      \ [restrained](/Rules/Source/conditions.md#Restrained) until this grapple ends.\
      \ The greatwyrm can have only one creature [grappled](/Rules/Source/conditions.md#Grappled)\
  ...
  - "desc": "The greatwyrm exhales crushing force in a 300-foot cone. Each creature\
      ...
      \ creature takes 71 (11d12) force damage and is knocked [prone](/Rules/Source/conditions.md#Prone).\
      \ On a successful save, it takes half as much damage and isn't knocked [prone](/Rules/Source/conditions.md#Prone).\
  ...
  - "desc": "The greatwyrm targets any number of creatures and objects it can see\
      ...
      \ creature must succeed on a DC 26 Strength saving throw or be [restrained](/Rules/Source/conditions.md#Restrained)\
      ...
      \ of itself. In addition, it can choose any number of creatures [restrained](/Rules/Source/conditions.md#Restrained)\
  ...
  - "desc": "The greatwyrm casts one of the following spells, requiring no spell components\
      ...
      \ to hit with spell attack):\n\n**1/day each:** [dispel magic](/Rules/Source/spells/dispel-magic-xphb.md),\
      \ [forcecage](/Rules/Source/spells/forcecage-xphb.md), [plane shift](/Rules/Source/spells/plane-shift-xphb.md),\
      \ [reverse gravity](/Rules/Source/spells/reverse-gravity-xphb.md), [time stop](/Rules/Source/spells/time-stop-xphb.md)"
...
"legendary_description": "Legendary Action Uses: 3. Immediately after another creature's\
  \ turn, the amethyst greatwyrm can expend a use to take one of the following actions.\
  \ The amethyst greatwyrm regains all expended uses at the start of each of its turns."
"legendary_actions":
...
"source":
  - "FTD"
"image": "/Rules/Source/bestiary/dragon/token/amethyst-greatwyrm-ftd.webp"
```
^statblock