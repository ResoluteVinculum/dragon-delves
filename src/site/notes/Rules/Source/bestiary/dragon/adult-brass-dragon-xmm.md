---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/adult-brass-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/13","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/metallic"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/13","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/metallic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Adult Brass Dragon"]}}
---

# [Adult Brass Dragon](Rules\Source\bestiary\dragon/adult-brass-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of (A) Sleep Breath or (B) Spellcasting to cast [Scorching Ray](/Rules/Source/spells/scorching-ray-xphb.md)."
    "name": "Multiattack"
  ...
  - "desc": "*Constitution Saving Throw:* DC 18, each creature in a 60-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      ...
      \ *2Nd Failure:* The target has the [Unconscious](/Rules/Source/conditions.md#Unconscious)\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Detect Magic](/Rules/Source/spells/detect-magic-xphb.md), [Minor\
      \ Illusion](/Rules/Source/spells/minor-illusion-xphb.md), [Scorching Ray](/Rules/Source/spells/scorching-ray-xphb.md),\
      ...
      \ required to maintain the spell), [Speak with Animals](/Rules/Source/spells/speak-with-animals-xphb.md)\n\
      \n**1/day each:** [Detect Thoughts](/Rules/Source/spells/detect-thoughts-xphb.md),\
      \ [Control Weather](/Rules/Source/spells/control-weather-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The area containing an adult or ancient brass dragon's lair is altered\
      \ by its presence, creating the following effects:\n\n- **Mirages.** While in\
      \ its lair, the dragon can cast [Major Image](/Rules/Source/spells/major-image-xphb.md),\
      ...
      \ refreshing. A creature that drinks such water gains 2d4 [Temporary Hit Points](/Rules/Source/variant-rules/temporary-hit-points-xphb.md),\
...
"legendary_actions":
  - "desc": "The dragon uses Spellcasting to cast [Scorching Ray](/Rules/Source/spells/scorching-ray-xphb.md)."
    "name": "Blazing Light"
  ...
  - "desc": "*Dexterity Saving Throw:* DC 16, one creature the dragon can see within\
      \ 120 feet. *Failure:* 27 (6d8) Fire damage, and the target's [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
      \ is halved until the end of its next turn. *Failure or Success:* The dragon\
      \ can't take this action again until the start of its next turn."
    "name": "Scorching Sands"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/adult-brass-dragon-xmm.webp"
```{ #statblock}
