---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/crystal-greatwyrm-ftd/","tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/26","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/gem"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/26","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/gem"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Crystal Greatwyrm"]}}
---

# [Crystal Greatwyrm](Rules\Source\bestiary\dragon/crystal-greatwyrm-ftd.md)
...
"legendary_description": "Legendary Action Uses: 3. Immediately after another creature's\
  \ turn, the crystal greatwyrm can expend a use to take one of the following actions.\
  \ The crystal greatwyrm regains all expended uses at the start of each of its turns."
"legendary_actions":
...
"source":
  - "FTD"
"image": "/Rules/Source/bestiary/dragon/token/crystal-greatwyrm-ftd.webp"
```
^statblock