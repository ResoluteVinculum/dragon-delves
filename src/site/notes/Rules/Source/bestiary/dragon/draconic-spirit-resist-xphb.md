---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/draconic-spirit-resist-xphb/","tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/monster/cr/","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/dragon"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/monster/cr/","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/dragon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Draconic Spirit ({{resist}})"]}}
---

# [Draconic Spirit ({{resist}})](Rules\Source\bestiary\dragon/draconic-spirit-resist-xphb.md)
...
"traits":
  - "desc": "You have [Resistance](/Rules/Source/variant-rules/resistance-xphb.md)\
      \ to {{resist}} damage until the spell ends."
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC equals your spell save DC, each creature\
      ...
      \ *Failure:* 2d6 {{resist}} damage. *Success:* Half damage."
    "name": "Breath Weapon"
"source":
  - "XPHB"
```
