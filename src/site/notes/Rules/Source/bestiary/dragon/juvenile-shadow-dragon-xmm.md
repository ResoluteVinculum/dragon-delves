---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/juvenile-shadow-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/4","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/shadowfell","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/dragon"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/4","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/shadowfell","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/dragon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Juvenile Shadow Dragon"]}}
---

# [Juvenile Shadow Dragon](Rules\Source\bestiary\dragon/juvenile-shadow-dragon-xmm.md)
...
"cr": "4"
"traits":
  - "desc": "While in [Dim Light](/Rules/Source/variant-rules/dim-light-xphb.md) or\
      \ [Darkness](/Rules/Source/variant-rules/darkness-xphb.md), the dragon has [Resistance](/Rules/Source/variant-rules/resistance-xphb.md)\
      \ to damage that isn't Force, Psychic, or Radiant."
    "name": "Living Shadow"
  - "desc": "While in sunlight, the dragon has [Disadvantage](/Rules/Source/variant-rules/disadvantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 10 ft. *Hit:* 7 (1d8 + 3) Slashing damage\
    ...
    "name": "Rend"
  - "desc": "*Dexterity Saving Throw:* DC 13, each creature in a 30-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 17 (5d6) Necrotic damage. *Success:* Half damage. *Failure or Success:*\
      \ A Humanoid reduced to 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      \ by this damage dies, and a [Shadow](/Rules/Source/bestiary/undead/shadow-xmm.md)\
      \ rises from its corpse. The shadow is under the dragon's control and shares\
      \ the dragon's [Initiative](/Rules/Source/variant-rules/initiative-xphb.md)\
      \ count but acts immediately after the dragon."
    "name": "Shadow Breath (Recharge 5-6)"
"bonus_actions":
  - "desc": "While in [Dim Light](/Rules/Source/variant-rules/dim-light-xphb.md) or\
      \ [Darkness](/Rules/Source/variant-rules/darkness-xphb.md), the dragon takes\
      \ the [Hide](/Rules/Source/actions.md#Hide) action."
    "name": "Shadow Stealth"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/juvenile-shadow-dragon-xmm.webp"
```{ #statblock}
