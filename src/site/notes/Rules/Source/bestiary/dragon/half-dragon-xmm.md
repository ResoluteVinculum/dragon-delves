---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/half-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/dragon"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/dragon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Half-Dragon"]}}
---

# [Half-Dragon](Rules\Source\bestiary\dragon/half-dragon-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 10 ft. *Hit:* 6 (1d4 + 4) Slashing damage\
    ...
    "name": "Claw"
  - "desc": "*Dexterity Saving Throw:* DC 14, each creature in a 30-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/half-dragon-xmm.webp"
```{ #statblock}
