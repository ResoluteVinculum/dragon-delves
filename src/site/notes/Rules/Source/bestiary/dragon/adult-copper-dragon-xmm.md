---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/adult-copper-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/14","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/metallic"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/14","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/metallic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Adult Copper Dragon"]}}
---

# [Adult Copper Dragon](Rules\Source\bestiary\dragon/adult-copper-dragon-xmm.md)
...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ (level 4 version), [Minor Illusion](/Rules/Source/spells/minor-illusion-xphb.md),\
      ...
      \ [Major Image](/Rules/Source/spells/major-image-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/adult-copper-dragon-xmm.webp"
```{ #statblock}
