---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/dragon-turtle-wyrmling-ftd/","tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/4","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/dragon"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/4","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/dragon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Dragon Turtle Wyrmling"]}}
---

# [Dragon Turtle Wyrmling](Rules\Source\bestiary\dragon/dragon-turtle-wyrmling-ftd.md)
...
| 6 | A dragon turtle wyrmling plays with a pod of killer whales, leaping into the air and blowing clouds of steam each time the whales breach. |{ #connected-creatures}
...
"source":
  - "FTD"
"image": "/Rules/Source/bestiary/dragon/token/dragon-turtle-wyrmling-ftd.webp"
```
^statblock