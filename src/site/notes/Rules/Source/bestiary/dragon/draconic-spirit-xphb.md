---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/draconic-spirit-xphb/","tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/monster/cr/","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/dragon"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/monster/cr/","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/dragon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Draconic Spirit"]}}
---

# [Draconic Spirit](Rules\Source\bestiary\dragon/draconic-spirit-xphb.md)
...
"traits":
  - "desc": "When you summon the spirit, choose one of its Resistances. You have [Resistance](/Rules/Source/variant-rules/resistance-xphb.md)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC equals your spell save DC, each creature\
      \ in a 30-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 2d6 damage of a type this spirit has [Resistance](/Rules/Source/variant-rules/resistance-xphb.md)\
      \ to (your choice when you cast the spell). *Success:* Half damage."
    "name": "Breath Weapon"
"source":
  - "XPHB"
"image": "/Rules/Source/bestiary/dragon/token/draconic-spirit-xphb.webp"
```
^statblock