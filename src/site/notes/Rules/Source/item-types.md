---
{"dg-publish":true,"permalink":"/rules/source/item-types/","tags":["ttrpg-cli/compendium/src/5e/xdmg","ttrpg-cli/compendium/src/5e/xphb"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"tags":["ttrpg-cli/compendium/src/5e/xdmg","ttrpg-cli/compendium/src/5e/xphb"],"aliases":["Item Types"]}}
---
...
If you have proficiency with a tool, add your [[Rules/Source/variant-rules/proficiency-xphb\|Proficiency Bonus]] to any ability check you make that uses the tool. If you have proficiency in a skill that's used with that check, you have [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on the check too.
...
**Tool (Gaming Set).** If you have proficiency with a tool, add your [[Rules/Source/variant-rules/proficiency-xphb\|Proficiency Bonus]] to any ability check you make that uses the tool. If you have proficiency in a skill that's used with that check, you have [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on the check too.
...
**Tool (Musical Instrument).** If you have proficiency with a tool, add your [[Rules/Source/variant-rules/proficiency-xphb\|Proficiency Bonus]] to any ability check you make that uses the tool. If you have proficiency in a skill that's used with that check, you have [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on the check too.
...
**Damage Threshold.** See the [[Rules/Source/variant-rules/damage-threshold-xphb\|rules glossary]].

**Ship Repair.** Repairs to a damaged ship can be made while the vessel is berthed. Repairing 1 [[Rules/Source/variant-rules/hit-points-xphb\|Hit Point]] of damage requires 1 day and costs 20 GP for materials and labor. If the repairs are made in a location where supplies and skilled labor are abundant, such as a city shipyard, the repair time and cost are halved.
