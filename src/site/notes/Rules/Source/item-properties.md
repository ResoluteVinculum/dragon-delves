---
{"dg-publish":true,"permalink":"/rules/source/item-properties/","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"aliases":["Item Properties"]}}
---
...
You can fire only one piece of ammunition from a Loading weapon when you use an action, a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]], or a [[Rules/Source/variant-rules/reaction-xphb\|Reaction]] to fire it, regardless of the number of attacks you can normally make.
...
### Reload
_Source: Dungeon Master's Guide (2024) p. 72_
You can make a limited number of shots with a Reload weapon. You must then reload the weapon as an action or a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]].
...
Attunement to a cursed item can't be ended voluntarily unless the curse is broken first, such as with the [[Rules/Source/spells/remove-curse-xphb\|remove curse]] spell.
