---
{"dg-publish":true,"permalink":"/rules/source/classes/druid-xphb/","tags":["ttrpg-cli/class/druid","ttrpg-cli/compendium/src/5e/xphb"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/class/druid","ttrpg-cli/compendium/src/5e/xphb"],"aliases":["Druid"]}}
---
...
- **Skill Proficiencies**: *Choose 2:* [[Rules/Source/skills#Animal Handling\|Animal Handling]], [[Rules/Source/skills#Arcana\|Arcana]], [[Rules/Source/skills#Insight\|Insight]], [[Rules/Source/skills#Medicine\|Medicine]], [[Rules/Source/skills#Nature\|Nature]], [[Rules/Source/skills#Perception\|Perception]], [[Rules/Source/skills#Religion\|Religion]], or [[Rules/Source/skills#Survival\|Survival]]
- **Weapon Proficiencies**: Simple weapons
- **Tool Proficiencies**: [[Rules/Source/items/herbalism-kit-xphb\|Herbalism Kit]]
- **Armor Training**: [[Rules/Source/item-types#Light Armor\|Light armor]] and [[Rules/Source/items/shield-xphb\|Shields]]

**Starting Equipment:** *Choose A or B:* (A) [[Rules/Source/items/leather-armor-xphb\|Leather Armor]], [[Rules/Source/items/shield-xphb\|Shield]], [[Rules/Source/items/sickle-xphb\|Sickle]], [[Rules/Source/items/druidic-focus-xphb\|Druidic Focus (Quarterstaff)]], [[Rules/Source/items/explorers-pack-xphb\|Explorer's Pack]], [[Rules/Source/items/herbalism-kit-xphb\|Herbalism kit]], 9 GP; or (B) 50 GP

## Multiclassing Druid

- **Armor Training**: [[Rules/Source/item-types#Light Armor\|Light armor]], [[Rules/Source/items/shield-xphb\|Shields]]
...
You know Druidic, the secret language of Druids. While learning this ancient tongue, you also unlocked the magic of communicating with animals; you always have the [[Rules/Source/spells/speak-with-animals-xphb\|Speak with Animals]] spell prepared.

You can use Druidic to leave hidden messages. You and others who know Druidic automatically spot such a message. Others spot the message's presence with a successful DC 15 Intelligence ([[Rules/Source/skills#Investigation\|Investigation]]) check but can't decipher it without magic.
...
- **Magician**  
    You know one extra cantrip from the Druid spell list. In addition, your mystical connection to nature gives you a bonus to your Intelligence ([[Rules/Source/skills#Arcana\|Arcana]] or [[Rules/Source/skills#Nature\|Nature]]) checks. The bonus equals your Wisdom modifier (minimum bonus of +1).  
- **Warden**  
...
**Cantrips.** You know two cantrips of your choice from the Druid spell list. [[Rules/Source/spells/druidcraft-xphb\|Druidcraft]] and [[Rules/Source/spells/produce-flame-xphb\|Produce Flame]] are recommended.

Whenever you gain a Druid level, you can replace one of your cantrips with another cantrip of your choice from the Druid spell list.

When you reach Druid levels 4 and 10, you learn another cantrip of your choice from the Druid spell list, as shown in the Cantrips column of the Druid Features table.

**Spell Slots.** The Druid Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].

**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose four level 1 spells from the Druid spell list. [[Rules/Source/spells/animal-friendship-xphb\|Animal Friendship]], [[Rules/Source/spells/cure-wounds-xphb\|Cure Wounds]], [[Rules/Source/spells/faerie-fire-xphb\|Faerie Fire]], and [[Rules/Source/spells/thunderwave-xphb\|Thunderwave]] are recommended.
...
**Changing Your Prepared Spells.** Whenever you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]], you can change your list of prepared spells, replacing any of the spells with other Druid spells for which you have spell slots.

**Spellcasting Ability.** Wisdom is your spellcasting ability for your Druid spells.

**Spellcasting Focus.** You can use a [[Rules/Source/items/druidic-focus-xphb\|Druidic Focus]] as a [[Rules/Source/variant-rules/spellcasting-focus-xphb\|Spellcasting Focus]] for your Druid spells.

### Wild Companion (Level 2)

You can summon a nature spirit that assumes an animal form to aid you. As a [[Rules/Source/actions#Magic\|Magic]] action, you can expend a spell slot or a use of Wild Shape to cast the [[Rules/Source/spells/find-familiar-xphb\|Find Familiar]] spell without Material components.

When you cast the spell in this way, the familiar is Fey and disappears when you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].

### Wild Shape (Level 2)

The power of nature allows you to assume the form of an animal. As a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]], you shape-shift into a Beast form that you have learned for this feature (see "Known Forms" below). You stay in that form for a number of hours equal to half your Druid level or until you use Wild Shape again, have the [[Rules/Source/conditions#Incapacitated\|Incapacitated]] condition, or die. You can also leave the form early as a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]].

**Number of Uses.** You can use Wild Shape twice. You regain one expended use when you finish a [[Rules/Source/variant-rules/short-rest-xphb\|Short Rest]], and you regain all expended uses when you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].

You gain additional uses when you reach certain Druid levels, as shown in the Wild Shape column of the Druid Features table.

**Known Forms.** You know four Beast forms for this feature, chosen from among Beast stat blocks that have a maximum [[Rules/Source/variant-rules/challenge-rating-xphb\|Challenge Rating]] of 1/4 and that lack a [[Rules/Source/variant-rules/fly-speed-xphb\|Fly Speed]] (see appendix B for stat block options). The [[Rules/Source/bestiary/beast/rat-xmm\|Rat]], [[Rules/Source/bestiary/beast/riding-horse-xmm\|Riding Horse]], [[Rules/Source/bestiary/beast/spider-xmm\|Spider]], and [[Rules/Source/bestiary/beast/wolf-xmm\|Wolf]] are recommended. Whenever you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]], you can replace one of your known forms with another eligible form.

When you reach certain Druid levels, your number of known forms and the maximum [[Rules/Source/variant-rules/challenge-rating-xphb\|Challenge Rating]] for those forms increases, as shown in the Beast Shapes table. In addition, starting at level 8, you can adopt a form that has a [[Rules/Source/variant-rules/fly-speed-xphb\|Fly Speed]].
...
| 2 | 4 | 1/4 | No |
| 4 | 6 | 1/2 | No |
| 8 | 8 | 1 | Yes |{ #beast-shapes}


**Rules While Shape-Shifted.** While in a form, you retain your personality, memories, and ability to speak, and the following rules apply:

- **Temporary Hit Points.** When you assume a Wild Shape form, you gain a number of [[Rules/Source/variant-rules/temporary-hit-points-xphb\|Temporary Hit Points]] equal to your Druid level.  
- **Game Statistics.** Your game statistics are replaced by the Beast's stat block, but you retain your creature type; [[Rules/Source/variant-rules/hit-points-xphb\|Hit Points]]; [[Rules/Source/variant-rules/hit-point-dice-xphb\|Hit Point Dice]]; Intelligence, Wisdom, and Charisma scores; class features; languages; and feats. You also retain your skill and saving throw proficiencies and use your [[Rules/Source/variant-rules/proficiency-xphb\|Proficiency Bonus]] for them, in addition to gaining the proficiencies of the creature. If a skill or saving throw modifier in the Beast's stat block is higher than yours, use the one in the stat block.  
- **No Spellcasting.** You can't cast spells, but shape-shifting doesn't break your [[Rules/Source/conditions#Concentration\|Concentration]] or otherwise interfere with a spell you've already cast.  
...
You gain the [[Rules/Source/feats/ability-score-improvement-xphb\|Ability Score Improvement]] feat or another feat of your choice for which you qualify. You gain this feature again at Druid levels 8, 12, and 16.

### Wild Resurgence (Level 5)

Once on each of your turns, if you have no uses of Wild Shape left, you can give yourself one use by expending a spell slot (no action required).

In addition, you can expend one use of Wild Shape (no action required) to give yourself a level 1 spell slot, but you can't do so again until you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [[Rules/Source/feats/boon-of-dimensional-travel-xphb\|Boon of Dimensional Travel]] is recommended.

### Archdruid (Level 20)

The vitality of nature constantly blooms within you, granting you the following benefits.

**Evergreen Wild Shape.** Whenever you roll [[Rules/Source/variant-rules/initiative-xphb\|Initiative]] and have no uses of Wild Shape left, you regain one expended use of it.

**Nature Magician.** You can convert uses of Wild Shape into a spell slot (no action required). Choose a number of your unexpended uses of Wild Shape and convert them into a single spell slot, with each use contributing 2 spell levels. For example, if you convert two uses of Wild Shape, you produce a level 4 spell slot. Once you use this benefit, you can't do so again until you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].
