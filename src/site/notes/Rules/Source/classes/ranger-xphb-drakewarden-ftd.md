---
{"dg-publish":true,"permalink":"/rules/source/classes/ranger-xphb-drakewarden-ftd/","tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/subclass/ranger/drakewarden"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/subclass/ranger/drakewarden"],"aliases":["Drakewarden"]}}
---
...
| 6 | You had a vivid dream of a mysterious figure accompanied by seven yellow canaries, who warned you of impending doom. When you awoke, your drake was there, watching you. |{ #drakewarden-origin}
...
- **Thaumaturgy.** You learn the [[Rules/Source/spells/thaumaturgy-xphb\|thaumaturgy]] cantrip, which is a ranger spell for you.  
...
The drake is friendly to you and your companions, and it obeys your commands. See its game statistics in the accompanying [[Rules/Source/bestiary/dragon/drake-companion-ftd\|Drake Companion]] stat block, which uses your proficiency bonus (PB) in several places. Whenever you summon the drake, choose a damage type listed in its Draconic Essence trait. You can determine the cosmetic characteristics of the drake, such as its color, its scale texture, or any visible effect of its Draconic Essence; your choice has no effect on its game statistics.
