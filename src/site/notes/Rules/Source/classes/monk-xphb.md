---
{"dg-publish":true,"permalink":"/rules/source/classes/monk-xphb/","tags":["ttrpg-cli/class/monk","ttrpg-cli/compendium/src/5e/xphb"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/class/monk","ttrpg-cli/compendium/src/5e/xphb"],"aliases":["Monk"]}}
---
...
- **Skill Proficiencies**: *Choose 2:* [[Rules/Source/skills#Acrobatics\|Acrobatics]], [[Rules/Source/skills#Athletics\|Athletics]], [[Rules/Source/skills#History\|History]], [[Rules/Source/skills#Insight\|Insight]], [[Rules/Source/skills#Religion\|Religion]], or [[Rules/Source/skills#Stealth\|Stealth]]
- **Weapon Proficiencies**: Simple weapons and Martial weapons that have the Light property
- **Tool Proficiencies**: Choose one type of [[Rules/Source/items/artisans-tools-xphb\|Artisan's Tools]] or [[Rules/Source/items/musical-instrument-xphb\|Musical Instrument]]

**Starting Equipment:** *Choose A or B:* (A) [[Rules/Source/items/spear-xphb\|Spear]], 5 [[Rules/Source/items/dagger-xphb\|Daggers]], [[Rules/Source/items/artisans-tools-xphb\|Artisan's Tools]] or [[Rules/Source/items/musical-instrument-xphb\|Musical Instrument]] chosen for the tool proficiency above, [[Rules/Source/items/explorers-pack-xphb\|Explorer's Pack]], and 11 GP; or (B) 50 GP
...
Your practice of martial arts gives you mastery of combat styles that use your [[Rules/Source/variant-rules/unarmed-strike-xphb\|Unarmed Strike]] and Monk weapons, which are the following:

- Simple Melee Weapons  
- Martial Melee Weapons that have the Light property  

You gain the following benefits while you are unarmed or wielding only Monk weapons and you aren't wearing armor or wielding a [[Rules/Source/items/shield-xphb\|Shield]].

### Bonus Unarmed Strike (Level 1)

You can make an [[Rules/Source/variant-rules/unarmed-strike-xphb\|Unarmed Strike]] as a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]].

### Martial Arts Die (Level 1)

You can roll `1d6` in place of the normal damage of your [[Rules/Source/variant-rules/unarmed-strike-xphb\|Unarmed Strike]] or Monk weapons. This die changes as you gain Monk levels, as shown in the Martial Arts column of the Monk Features table.

### Dexterous Attacks (Level 1)

You can use your Dexterity modifier instead of your Strength modifier for the attack and damage rolls of your Unarmed Strikes and Monk weapons. In addition, when you use the Grapple or Shove option of your [[Rules/Source/variant-rules/unarmed-strike-xphb\|Unarmed Strike]], you can use your Dexterity modifier instead of your Strength modifier to determine the save DC.

### Unarmored Defense (Level 1)

While you aren't wearing armor or wielding a [[Rules/Source/items/shield-xphb\|Shield]], your base [[Rules/Source/variant-rules/armor-class-xphb\|Armor Class]] equals 10 plus your Dexterity and Wisdom modifiers.
...
When you expend a Focus Point, it is unavailable until you finish a [[Rules/Source/variant-rules/short-rest-xphb\|Short]] or [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]], at the end of which you regain all your expended points.

Some features that use Focus Points require your target to make a saving throw. The save DC equals 8 plus your Wisdom modifier and [[Rules/Source/variant-rules/proficiency-xphb\|Proficiency Bonus]].

### Flurry of Blows (Level 2)

You can expend 1 Focus Point to make two Unarmed Strikes as a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]].

### Patient Defense (Level 2)

You can take the [[Rules/Source/actions#Disengage\|Disengage]] action as a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]]. Alternatively, you can expend 1 Focus Point to take both the [[Rules/Source/actions#Disengage\|Disengage]] and the [[Rules/Source/actions#Dodge\|Dodge]] actions as a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]].

### Step of the Wind (Level 2)

You can take the [[Rules/Source/actions#Dash\|Dash]] action as a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]]. Alternatively, you can expend 1 Focus Point to take both the [[Rules/Source/actions#Disengage\|Disengage]] and [[Rules/Source/actions#Dash\|Dash]] actions as a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]], and your jump distance is doubled for the turn.

### Unarmored Movement (Level 2)

Your speed increases by 10 feet while you aren't wearing armor or wielding a [[Rules/Source/items/shield-xphb\|Shield]]. This bonus increases when you reach certain Monk levels, as shown on the Monk Features table.

### Uncanny Metabolism (Level 2)

When you roll [[Rules/Source/variant-rules/initiative-xphb\|Initiative]], you can regain all expended Focus Points. When you do so, roll your Martial Arts die, and regain a number of [[Rules/Source/variant-rules/hit-points-xphb\|Hit Points]] equal to your Monk level plus the number rolled.
...
When an attack roll hits you and its damage includes Bludgeoning, Piercing, or Slashing damage, you can take a [[Rules/Source/variant-rules/reaction-xphb\|Reaction]] to reduce the attack's total damage against you. The reduction equals `1d10` plus your Dexterity modifier and Monk level.

If you reduce the damage to 0, you can expend 1 Focus Point to redirect some of the attack's force. If you do so, choose a creature you can see within 5 feet of yourself if the attack was a melee attack or a creature you can see within 60 feet of yourself that isn't behind [[Rules/Source/variant-rules/cover-xphb\|Total Cover]] if the attack was a ranged attack. That creature must succeed on a Dexterity saving throw or take damage equal to two rolls of your Martial Arts die plus your Dexterity modifier. The damage is the same type dealt by the attack.
...
You gain the [[Rules/Source/feats/ability-score-improvement-xphb\|Ability Score Improvement]] feat or another feat of your choice for which you qualify. You gain this feature again at Monk levels 8, 12, and 16.

### Slow Fall (Level 4)

You can take a [[Rules/Source/variant-rules/reaction-xphb\|Reaction]] when you fall to reduce any damage you take from the fall by an amount equal to five times your Monk level.

### Extra Attack (Level 5)

You can attack twice instead of once whenever you take the [[Rules/Source/actions#Attack\|Attack]] action on your turn.

### Stunning Strike (Level 5)

Once per turn when you hit a creature with a Monk weapon or an [[Rules/Source/variant-rules/unarmed-strike-xphb\|Unarmed Strike]], you can expend 1 Focus Point to attempt a stunning strike. The target must make a Constitution saving throw. On a failed save, the target has the [[Rules/Source/conditions#Stunned\|Stunned]] condition until the start of your next turn. On a successful save, the target's [[Rules/Source/variant-rules/speed-xphb\|Speed]] is halved until the start of your next turn, and the next attack roll made against the target before then has [[Rules/Source/variant-rules/advantage-xphb\|Advantage]].

### Empowered Strikes (Level 6)

Whenever you deal damage with your [[Rules/Source/variant-rules/unarmed-strike-xphb\|Unarmed Strike]], it can deal your choice of Force damage or its normal damage type.
...
You don't benefit from this feature if you have the [[Rules/Source/conditions#Incapacitated\|Incapacitated]] condition.

### Ability Score Improvement (Level 8)

You gain the [[Rules/Source/feats/ability-score-improvement-xphb\|Ability Score Improvement]] feat or another feat of your choice for which you qualify.

### Acrobatic Movement (Level 9)

While you aren't wearing armor or wielding a [[Rules/Source/items/shield-xphb\|Shield]], you gain the ability to move along vertical surfaces and across liquids on your turn without falling during the movement.
...
**Patient Defense.** When you expend a Focus Point to use Patient Defense, you gain a number of [[Rules/Source/variant-rules/temporary-hit-points-xphb\|Temporary Hit Points]] equal to two rolls of your Martial Arts die.

**Step of the Wind.** When you expend a Focus Point to use Step of the Wind, you can choose a willing creature within 5 feet of yourself that is Large or smaller. You move the creature with you until the end of your turn. The creature's movement doesn't provoke [[Rules/Source/actions#Opportunity Attack\|Opportunity Attacks]].

### Self-Restoration (Level 10)

Through sheer force of will, you can remove one of the following conditions from yourself at the end of each of your turns: [[Rules/Source/conditions#Charmed\|Charmed]], [[Rules/Source/conditions#Frightened\|Frightened]], or [[Rules/Source/conditions#Poisoned\|Poisoned]].

In addition, forgoing food and drink doesn't give you levels of [[Rules/Source/conditions#Exhaustion\|Exhaustion]].
...
When you roll [[Rules/Source/variant-rules/initiative-xphb\|Initiative]] and don't use Uncanny Metabolism, you regain expended Focus Points until you have 4 if you have 3 or fewer.
...
At the start of your turn, you can expend 3 Focus Points to bolster yourself against harm for 1 minute or until you have the [[Rules/Source/conditions#Incapacitated\|Incapacitated]] condition. During that time, you have [[Rules/Source/variant-rules/resistance-xphb\|Resistance]] to all damage except Force damage.

### Epic Boon (Level 19)

You gain an Epic Boon feat or another feat of your choice for which you qualify. [[Rules/Source/feats/boon-of-irresistible-offense-xphb\|Boon of Irresistible Offense]] is recommended.
