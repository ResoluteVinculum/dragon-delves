---
{"dg-publish":true,"permalink":"/rules/source/classes/ranger-xphb/","tags":["ttrpg-cli/class/ranger","ttrpg-cli/compendium/src/5e/xphb"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/class/ranger","ttrpg-cli/compendium/src/5e/xphb"],"aliases":["Ranger"]}}
---
...
- **Skill Proficiencies**: *Choose 3:* [[Rules/Source/skills#Animal Handling\|Animal Handling]], [[Rules/Source/skills#Athletics\|Athletics]], [[Rules/Source/skills#Insight\|Insight]], [[Rules/Source/skills#Investigation\|Investigation]], [[Rules/Source/skills#Nature\|Nature]], [[Rules/Source/skills#Perception\|Perception]], [[Rules/Source/skills#Stealth\|Stealth]], or [[Rules/Source/skills#Survival\|Survival]]
...
**Starting Equipment:** *Choose A or B:* (A) [[Rules/Source/items/studded-leather-armor-xphb\|Studded Leather Armor]], [[Rules/Source/items/scimitar-xphb\|Scimitar]], [[Rules/Source/items/shortsword-xphb\|Shortsword]], [[Rules/Source/items/longbow-xphb\|Longbow]], [[Rules/Source/items/arrows-20-xphb\|20 Arrows]], [[Rules/Source/items/quiver-xphb\|Quiver]], [[Rules/Source/items/druidic-focus-xphb\|Druidic Focus]] ([[Rules/Source/items/sprig-of-mistletoe-xphb\|sprig of mistletoe]]), [[Rules/Source/items/explorers-pack-xphb\|Explorer's Pack]], and 7 GP; or (B) 150 GP

## Multiclassing Ranger

- **Skill Proficiencies**: *Choose 1:* [[Rules/Source/skills#Animal Handling\|Animal Handling]], [[Rules/Source/skills#Athletics\|Athletics]], [[Rules/Source/skills#Insight\|Insight]], [[Rules/Source/skills#Investigation\|Investigation]], [[Rules/Source/skills#Nature\|Nature]], [[Rules/Source/skills#Perception\|Perception]], [[Rules/Source/skills#Stealth\|Stealth]], or [[Rules/Source/skills#Survival\|Survival]]
...
**Spell Slots.** The Ranger Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].

**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Ranger spells. [[Rules/Source/spells/cure-wounds-xphb\|Cure Wounds]] and [[Rules/Source/spells/ensnaring-strike-xphb\|Ensnaring Strike]] are recommended.
...
**Changing Your Prepared Spells.** Whenever you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]], you can replace one spell on your list with another Ranger spell for which you have spell slots.

**Spellcasting Ability.** Wisdom is your spellcasting ability for your Ranger spells.

**Spellcasting Focus.** You can use a [[Rules/Source/items/druidic-focus-xphb\|Druidic Focus]] as a [[Rules/Source/variant-rules/spellcasting-focus-xphb\|Spellcasting Focus]] for your Ranger spells.

### Favored Enemy (Level 1)

You always have the [[Rules/Source/spells/hunters-mark-xphb\|Hunter's Mark]] spell prepared. You can cast it twice without expending a spell slot, and you regain all expended uses of this ability when you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].

The number of times you can cast the spell without a spell slot increases when you reach certain Ranger levels, as shown in the Favored Enemy column of the Ranger Features table.

### Weapon Mastery (Level 1)

Your training with weapons allows you to use the [[Rules/Source/variant-rules/weapon-mastery-properties-xphb\|mastery properties]] of two kinds of weapons of your choice with which you have proficiency, such as [[Rules/Source/items/longbow-xphb\|Longbows]] and [[Rules/Source/items/shortsword-xphb\|Shortswords]].

Whenever you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]], you can change the kinds of weapons you chose. For example, you could switch to using the [[Rules/Source/variant-rules/weapon-mastery-properties-xphb\|mastery properties]] of [[Rules/Source/items/scimitar-xphb\|Scimitars]] and [[Rules/Source/items/longsword-xphb\|Longswords]].

### Deft Explorer (Level 2)

Thanks to your travels, you gain the following benefits.

**Expertise.** Choose one of your skill proficiencies with which you lack [[Rules/Source/variant-rules/expertise-xphb\|Expertise]]. You gain [[Rules/Source/variant-rules/expertise-xphb\|Expertise]] in that skill.
...
You gain the [[Rules/Source/feats/ability-score-improvement-xphb\|Ability Score Improvement]] feat or another feat of your choice for which you qualify. You gain this feature again at Ranger levels 8, 12, and 16.
...
Your [[Rules/Source/variant-rules/speed-xphb\|Speed]] increases by 10 feet while you aren't wearing Heavy armor. You also have a [[Rules/Source/variant-rules/climb-speed-xphb\|Climb Speed]] and a [[Rules/Source/variant-rules/swim-speed-xphb\|Swim Speed]] equal to your [[Rules/Source/variant-rules/speed-xphb\|Speed]].
...
Choose two of your skill proficiencies with which you lack [[Rules/Source/variant-rules/expertise-xphb\|Expertise]]. You gain [[Rules/Source/variant-rules/expertise-xphb\|Expertise]] in those skills.

### Tireless (Level 10)

Primal forces now help fuel you on your journeys, granting you the following benefits.

**Temporary Hit Points.** As a [[Rules/Source/actions#Magic\|Magic]] action, you can give yourself a number of [[Rules/Source/variant-rules/temporary-hit-points-xphb\|Temporary Hit Points]] equal to `1d8` plus your Wisdom modifier (minimum of 1). You can use this action a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].

**Decrease Exhaustion.** Whenever you finish a [[Rules/Source/variant-rules/short-rest-xphb\|Short Rest]], your [[Rules/Source/conditions#Exhaustion\|Exhaustion]] level, if any, decreases by 1.
...
Taking damage can't break your [[Rules/Source/conditions#Concentration\|Concentration]] on Hunter's Mark.

### Nature's Veil (Level 14)

You invoke spirits of nature to magically hide yourself. As a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]], you can give yourself the [[Rules/Source/conditions#Invisible\|Invisible]] condition until the end of your next turn.

You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].
...
You have [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on attack rolls against the creature currently marked by your Hunter's Mark.

### Feral Senses (Level 18)

Your connection to the forces of nature grants you [[Rules/Source/senses#Blindsight\|Blindsight]] with a range of 30 feet.
