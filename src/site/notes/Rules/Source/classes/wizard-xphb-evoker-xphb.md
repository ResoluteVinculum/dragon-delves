---
{"dg-publish":true,"permalink":"/rules/source/classes/wizard-xphb-evoker-xphb/","tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/subclass/wizard/evoker"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/subclass/wizard/evoker"],"aliases":["Evoker"]}}
---
...
The first time you do so, you suffer no adverse effect. If you use this feature again before you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]], you take `2d12` Necrotic damage for each level of the spell slot immediately after you cast it. This damage ignores [[Rules/Source/variant-rules/resistance-xphb\|Resistance]] and [[Rules/Source/variant-rules/immunity-xphb\|Immunity]].

Each time you use this feature again before finishing a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]], the Necrotic damage per spell level increases by `1d12`.