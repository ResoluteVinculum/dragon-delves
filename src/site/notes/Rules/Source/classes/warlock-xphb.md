---
{"dg-publish":true,"permalink":"/rules/source/classes/warlock-xphb/","tags":["ttrpg-cli/class/warlock","ttrpg-cli/compendium/src/5e/xphb"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/class/warlock","ttrpg-cli/compendium/src/5e/xphb"],"aliases":["Warlock"]}}
---
...
> <tr class="class-progression"><th class"level">Level</th><th class"pb">PB</th><th class"feature">Features</th><th class="value"><a href="/Rules/Source/lists/list-optfeaturetype-ei.md">Invocations</a></th><th class="value">Cantrips</th><th class="value">Prepared Spells</th><th class="value">Spell Slots</th><th class="value">Slot Level</th></tr>
> </thead><tbody>
...
- **Skill Proficiencies**: *Choose 2:* [[Rules/Source/skills#Arcana\|Arcana]], [[Rules/Source/skills#Deception\|Deception]], [[Rules/Source/skills#History\|History]], [[Rules/Source/skills#Intimidation\|Intimidation]], [[Rules/Source/skills#Investigation\|Investigation]], [[Rules/Source/skills#Nature\|Nature]], or [[Rules/Source/skills#Religion\|Religion]]
- **Weapon Proficiencies**: Simple weapons
- **Armor Training**: [[Rules/Source/item-types#Light Armor\|Light armor]]

**Starting Equipment:** *Choose A or B:* (A) [[Rules/Source/items/leather-armor-xphb\|Leather Armor]], [[Rules/Source/items/sickle-xphb\|Sickle]], 2 [[Rules/Source/items/dagger-xphb\|Daggers]], [[Rules/Source/items/arcane-focus-xphb\|Arcane Focus]] ([[Rules/Source/items/orb-xphb\|orb]]), [[Rules/Source/items/book-xphb\|Book]] (occult lore), [[Rules/Source/items/scholars-pack-xphb\|Scholar's Pack]], and 15 GP; or (B) 100 GP
...
You have unearthed Eldritch Invocations, pieces of forbidden knowledge that imbue you with an abiding magical ability or other lessons. You gain one invocation of your choice, such as Pact of the Tome. Invocations are described in the "Eldritch Invocation Options^[[Rules/Source/lists/list-optfeaturetype-ei\|Optional features from [Eldritch Invocation]]; defined in Player's Handbook (2024)]" section later in this class's description.
...
**Cantrips.** You know two Warlock cantrips of your choice. [[Rules/Source/spells/eldritch-blast-xphb\|Eldritch Blast]] and [[Rules/Source/spells/prestidigitation-xphb\|Prestidigitation]] are recommended. Whenever you gain a Warlock level, you can replace one of your cantrips from this feature with another Warlock cantrip of your choice.

When you reach Warlock levels 4 and 10, you learn another Warlock cantrip of your choice, as shown in the Cantrips column of the Warlock Features table.

**Spell Slots.** The Warlock Features table shows how many spell slots you have to cast your Warlock spells of levels 1–5. The table also shows the level of those slots, all of which are the same level. You regain all expended Pact Magic spell slots when you finish a [[Rules/Source/variant-rules/short-rest-xphb\|Short]] or [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].

For example, when you're a level 5 Warlock, you have two level 3 spell slots. To cast the level 1 spell [[Rules/Source/spells/witch-bolt-xphb\|Witch Bolt]], you must spend one of those slots, and you cast it as a level 3 spell.

**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Warlock spells. [[Rules/Source/spells/charm-person-xphb\|Charm Person]] and [[Rules/Source/spells/hex-xphb\|Hex]] are recommended.
...
**Spellcasting Focus.** You can use an [[Rules/Source/items/arcane-focus-xphb\|Arcane Focus]] as a [[Rules/Source/variant-rules/spellcasting-focus-xphb\|Spellcasting Focus]] for your Warlock spells.
...
You can perform an esoteric rite for 1 minute. At the end of it, you regain expended Pact Magic spell slots but no more than a number equal to half your maximum (round up). Once you use this feature, you can't do so again until you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].
...
You gain the [[Rules/Source/feats/ability-score-improvement-xphb\|Ability Score Improvement]] feat or another feat of your choice for which you qualify. You gain this feature again at Warlock levels 8, 12, and 16.
...
In the past, you usually contacted your patron through intermediaries. Now you can communicate directly; you always have the [[Rules/Source/spells/contact-other-plane-xphb\|Contact Other Plane]] spell prepared. With this feature, you can cast the spell without expending a spell slot to contact your patron, and you automatically succeed on the spell's saving throw.

Once you cast the spell with this feature, you can't do so in this way again until you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].
...
You can cast your arcanum spell once without expending a spell slot, and you must finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]] before you can cast it in this way again.

As shown in the Warlock Features table, you gain another Warlock spell of your choice that can be cast in this way when you reach Warlock levels 13 (level 7 spell), 15 (level 8 spell), and 17 (level 9 spell). You regain all uses of your Mystic Arcanum when you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].
