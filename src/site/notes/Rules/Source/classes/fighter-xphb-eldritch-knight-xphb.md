---
{"dg-publish":true,"permalink":"/rules/source/classes/fighter-xphb-eldritch-knight-xphb/","tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/subclass/fighter/eldritch-knight"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/subclass/fighter/eldritch-knight"],"aliases":["Eldritch Knight"]}}
---
...
**Cantrips.** You know two cantrips of your choice from the Wizard spell list (see that class's section for its list). [[Rules/Source/spells/ray-of-frost-xphb\|Ray of Frost]] and [[Rules/Source/spells/shocking-grasp-xphb\|Shocking Grasp]] are recommended. Whenever you gain a Fighter level, you can replace one of these cantrips with another cantrip of your choice from the Wizard spell list.

When you reach Fighter level 10, you learn another Wizard cantrip of your choice.

**Spell Slots.** The Eldritch Knight Spellcasting table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].

**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose three level 1 spells from the Wizard spell list. [[Rules/Source/spells/burning-hands-xphb\|Burning Hands]], [[Rules/Source/spells/jump-xphb\|Jump]], and [[Rules/Source/spells/shield-xphb\|Shield]] are recommended.
...
You learn a ritual that creates a magical bond between yourself and one weapon. You perform the ritual over the course of 1 hour, which can be done during a [[Rules/Source/variant-rules/short-rest-xphb\|Short Rest]]. The weapon must be within your reach throughout the ritual, at the conclusion of which you touch the weapon and forge the bond. The bond fails if another Fighter is bonded to the weapon or if the weapon is a magic item to which someone else is attuned.

Once you have bonded a weapon to yourself, you can't be disarmed of that weapon unless you have the [[Rules/Source/conditions#Incapacitated\|Incapacitated]] condition. If it is on the same plane of existence, you can summon that weapon as a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]], causing it to teleport instantly to your hand.

You can have up to two bonded weapons, but you can summon only one at a time with a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]]. If you attempt to bond with a third weapon, you must break the bond with one of the other two.

### War Magic (Level 7)

When you take the [[Rules/Source/actions#Attack\|Attack]] action on your turn, you can replace one of the attacks with a casting of one of your Wizard cantrips that has a casting time of an action.

### Eldritch Strike (Level 10)

You learn how to make your weapon strikes undercut a creature's ability to withstand your spells. When you hit a creature with an attack using a weapon, that creature has [[Rules/Source/variant-rules/disadvantage-xphb\|Disadvantage]] on the next saving throw it makes against a spell you cast before the end of your next turn.
...
When you take the [[Rules/Source/actions#Attack\|Attack]] action on your turn, you can replace two of the attacks with a casting of one of your level 1 or level 2 Wizard spells that has a casting time of an action.