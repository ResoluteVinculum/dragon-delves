---
{"dg-publish":true,"permalink":"/rules/source/classes/wizard-xphb-bladesinging-tce/","tags":["ttrpg-cli/compendium/src/5e/tce","ttrpg-cli/subclass/wizard/bladesinging"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/compendium/src/5e/tce","ttrpg-cli/subclass/wizard/bladesinging"],"aliases":["Bladesinging"]}}
---
...
You also gain proficiency in the [[Rules/Source/skills#Performance\|Performance]] skill if you don't already have it.
...
You can use a bonus action to start the Bladesong, which lasts for 1 minute. It ends early if you are [[Rules/Source/conditions#Incapacitated\|incapacitated]], if you don medium or heavy armor or a shield, or if you use two hands to make an attack with a weapon. You can also dismiss Bladesong at any time you choose (no action required).

While your bladesong is active, you gain the following benefits:

- You gain a bonus to your AC equal to your Intelligence modifier (minimum of +1).  
- Your walking speed increases by 10 feet.  
- You have advantage on Dexterity ([[Rules/Source/skills#Acrobatics\|Acrobatics]]) checks.  
- You gain a bonus to any Constitution saving throws you make to maintain [[Rules/Source/conditions#Concentration\|concentration]] on a spell. The bonus equals your Intelligence modifier (minimum of +1).  
...
Starting at 6th level, you can attack twice, instead of once, whenever you take the [[Rules/Source/actions#Attack\|Attack]] action on your turn. Moreover, you can cast one of your cantrips in place of one of those attacks.
