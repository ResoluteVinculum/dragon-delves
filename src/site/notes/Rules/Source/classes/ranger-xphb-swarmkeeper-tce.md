---
{"dg-publish":true,"permalink":"/rules/source/classes/ranger-xphb-swarmkeeper-tce/","tags":["ttrpg-cli/compendium/src/5e/tce","ttrpg-cli/subclass/ranger/swarmkeeper"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/compendium/src/5e/tce","ttrpg-cli/subclass/ranger/swarmkeeper"],"aliases":["Swarmkeeper"]}}
---
...
| 3 | Fluttering birds |
| 4 | Playful pixies |{ #swarm-appearance}
...
You learn the [[Rules/Source/spells/mage-hand-xphb\|mage hand]] cantrip if you don't already know it. When you cast it, the hand takes the form of your swarming nature spirits.
...
| Ranger Level | Spells |
|--------------|--------|
| 3rd | [[Rules/Source/spells/faerie-fire-xphb\|faerie fire]] |
| 5th | [[Rules/Source/spells/web-xphb\|web]] |
| 9th | [[Rules/Source/spells/gaseous-form-xphb\|gaseous form]] |
| 13th | [[Rules/Source/spells/arcane-eye-xphb\|arcane eye]] |
| 17th | [[Rules/Source/spells/insect-plague-xphb\|insect plague]] |{ #swarmkeeper-spells}
...
You can condense part of your swarm into a focused mass that lifts you up. As a bonus action, you gain a flying speed of 10 feet and can hover. This effect lasts for 1 minute or until you are [[Rules/Source/conditions#Incapacitated\|incapacitated]].
...
- If a creature fails its saving throw against being moved by Gathered Swarm, you can also cause the swarm to knock the creature [[Rules/Source/conditions#Prone\|prone]].  
