---
{"dg-publish":true,"permalink":"/rules/source/classes/wizard-xphb-diviner-xphb/","tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/subclass/wizard/diviner"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/subclass/wizard/diviner"],"aliases":["Diviner"]}}
---
...
Glimpses of the future begin to press on your awareness. Whenever you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]], roll two d20s and record the numbers rolled. You can replace any [[Rules/Source/variant-rules/d20-test-xphb\|D20 Test]] made by you or a creature that you can see with one of these foretelling rolls. You must choose to do so before the roll, and you can replace a roll in this way only once per turn.

Each foretelling roll can be used only once. When you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]], you lose any unused foretelling rolls.
...
You can increase your powers of perception. As a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]], choose one of the following benefits, which lasts until you start a [[Rules/Source/variant-rules/short-rest-xphb\|Short]] or [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]]. You can't use this feature again until you finish a [[Rules/Source/variant-rules/short-rest-xphb\|Short]] or [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].

**Darkvision.** You gain [[Rules/Source/senses#Darkvision\|Darkvision]] with a range of 120 feet.

**Greater Comprehension.** You can read any language.

**See Invisibility.** You can cast [[Rules/Source/spells/see-invisibility-xphb\|See Invisibility]] without expending a spell slot.
