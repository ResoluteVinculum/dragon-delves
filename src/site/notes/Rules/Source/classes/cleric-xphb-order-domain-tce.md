---
{"dg-publish":true,"permalink":"/rules/source/classes/cleric-xphb-order-domain-tce/","tags":["ttrpg-cli/compendium/src/5e/tce","ttrpg-cli/domain/order","ttrpg-cli/subclass/cleric/order"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/compendium/src/5e/tce","ttrpg-cli/domain/order","ttrpg-cli/subclass/cleric/order"],"aliases":["Order Domain"]}}
---
...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [[Rules/Source/spells/command-xphb\|command]], [[Rules/Source/spells/heroism-xphb\|heroism]] |
| 3rd | [[Rules/Source/spells/hold-person-xphb\|hold person]], [[Rules/Source/spells/zone-of-truth-xphb\|zone of truth]] |
| 5th | [[Rules/Source/spells/mass-healing-word-xphb\|mass healing word]], [[Rules/Source/spells/slow-xphb\|slow]] |
| 7th | [[Rules/Source/spells/compulsion-xphb\|compulsion]], [[Rules/Source/spells/locate-creature-xphb\|locate creature]] |
| 9th | [[Rules/Source/spells/commune-xphb\|commune]], [[Rules/Source/spells/dominate-person-xphb\|dominate person]] |{ #order-domain-spells}


### Bonus Proficiencies (Level 1)

When you choose this domain at 1st level, you gain proficiency with heavy armor. You also gain proficiency in the [[Rules/Source/skills#Intimidation\|Intimidation]] or [[Rules/Source/skills#Persuasion\|Persuasion]] skill (your choice).
...
As an action, you present your holy symbol, and each creature of your choice that can see or hear you within 30 feet of you must succeed on a Wisdom saving throw or be [[Rules/Source/conditions#Charmed\|charmed]] by you until the end of your next turn or until the [[Rules/Source/conditions#Charmed\|charmed]] creature takes any damage. You can also cause any of the [[Rules/Source/conditions#Charmed\|charmed]] creatures to drop what they are holding when they fail the saving throw.
