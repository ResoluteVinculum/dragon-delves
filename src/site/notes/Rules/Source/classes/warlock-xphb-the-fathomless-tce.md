---
{"dg-publish":true,"permalink":"/rules/source/classes/warlock-xphb-the-fathomless-tce/","tags":["ttrpg-cli/compendium/src/5e/tce","ttrpg-cli/subclass/warlock/fathomless"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/compendium/src/5e/tce","ttrpg-cli/subclass/warlock/fathomless"],"aliases":["The Fathomless"]}}
---
...
| Spell Level | Spells |
|-------------|--------|
| 1st | [[Rules/Source/spells/create-or-destroy-water-xphb\|create or destroy water]], [[Rules/Source/spells/thunderwave-xphb\|thunderwave]] |
| 2nd | [[Rules/Source/spells/gust-of-wind-xphb\|gust of wind]], [[Rules/Source/spells/silence-xphb\|silence]] |
| 3rd | [[Rules/Source/spells/lightning-bolt-xphb\|lightning bolt]], [[Rules/Source/spells/sleet-storm-xphb\|sleet storm]] |
| 4th | [[Rules/Source/spells/control-water-xphb\|control water]], [[Rules/Source/spells/summon-elemental-xphb\|summon elemental]] (water only) |
| 5th | [[Rules/Source/spells/bigbys-hand-xphb\|Bigby's hand]] (appears as a tentacle), [[Rules/Source/spells/cone-of-cold-xphb\|cone of cold]] |{ #fathomless-expanded-spells}
...
You learn the spell [[Rules/Source/spells/evards-black-tentacles-xphb\|Evard's black tentacles]]. It counts as a warlock spell for you, but it doesn't count against the number of spells you know. You can also cast it once without a spell slot, and you regain the ability to do so when you finish a long rest.

Whenever you cast this spell, your patron's magic bolsters you, granting you a number of temporary hit points equal to your warlock level. Moreover, damage can't break your [[Rules/Source/conditions#Concentration\|concentration]] on this spell.
