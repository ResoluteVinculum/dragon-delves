---
{"dg-publish":true,"permalink":"/rules/source/classes/rogue-xphb-phantom-tce/","tags":["ttrpg-cli/compendium/src/5e/tce","ttrpg-cli/subclass/rogue/phantom"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/compendium/src/5e/tce","ttrpg-cli/subclass/rogue/phantom"],"aliases":["Phantom"]}}
---
...
When a life ends in your presence, you're able to snatch a token from the departing soul, a sliver of its life essence that takes physical form: as a reaction when a creature you can see dies within 30 feet of you, you can open your free hand and cause a Tiny trinket to appear there, a soul trinket. The DM determines the trinket's form or has you roll on the [[Rules/Source/items/trinket-xphb\|Trinkets]] table in the *Player's Handbook* to generate it. You can have a maximum number of soul trinkets equal to your proficiency bonus, and you can't create one while at your maximum.
