---
{"dg-publish":true,"permalink":"/rules/source/classes/fighter-xphb/","tags":["ttrpg-cli/class/fighter","ttrpg-cli/compendium/src/5e/xphb"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/class/fighter","ttrpg-cli/compendium/src/5e/xphb"],"aliases":["Fighter"]}}
---
...
- **Skill Proficiencies**: *Choose 2:* [[Rules/Source/skills#Acrobatics\|Acrobatics]], [[Rules/Source/skills#Animal Handling\|Animal Handling]], [[Rules/Source/skills#Athletics\|Athletics]], [[Rules/Source/skills#History\|History]], [[Rules/Source/skills#Insight\|Insight]], [[Rules/Source/skills#Intimidation\|Intimidation]], [[Rules/Source/skills#Perception\|Perception]], [[Rules/Source/skills#Persuasion\|Persuasion]], or [[Rules/Source/skills#Survival\|Survival]]
...
**Starting Equipment:** *Choose A, B, or C:* (A) [[Rules/Source/items/chain-mail-xphb\|Chain Mail]], [[Rules/Source/items/greatsword-xphb\|Greatsword]], [[Rules/Source/items/flail-xphb\|Flail]], 8 [[Rules/Source/items/javelin-xphb\|Javelins]], [[Rules/Source/items/dungeoneers-pack-xphb\|Dungeoneer's Pack]], and 4 GP; (B) [[Rules/Source/items/studded-leather-armor-xphb\|Studded Leather Armor]], [[Rules/Source/items/scimitar-xphb\|Scimitar]], [[Rules/Source/items/shortsword-xphb\|Shortsword]], [[Rules/Source/items/longbow-xphb\|Longbow]], [[Rules/Source/items/arrows-20-xphb\|20 Arrows]], [[Rules/Source/items/quiver-xphb\|Quiver]], [[Rules/Source/items/dungeoneers-pack-xphb\|Dungeoneer's Pack]], and 11 GP; or (C) 155 GP
...
You have honed your martial prowess and gain a Fighting Style feat of your choice. [[Rules/Source/feats/defense-xphb\|Defense]] is recommended.

Whenever you gain a Fighter level, you can replace the feat you chose with a different Fighting Style feat.

### Second Wind (Level 1)

You have a limited well of physical and mental stamina that you can draw on. As a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]], you can use it to regain [[Rules/Source/variant-rules/hit-points-xphb\|Hit Points]] equal to `1d10` plus your Fighter level.

You can use this feature twice. You regain one expended use when you finish a [[Rules/Source/variant-rules/short-rest-xphb\|Short Rest]], and you regain all expended uses when you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].

When you reach certain Fighter levels, you gain more uses of this feature, as shown in the Second Wind column of the Fighter Features table.

### Weapon Mastery (Level 1)

Your training with weapons allows you to use the [[Rules/Source/variant-rules/weapon-mastery-properties-xphb\|mastery properties]] of three kinds of Simple or Martial weapons of your choice. Whenever you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]], you can practice weapon drills and change one of those weapon choices.

When you reach certain Fighter levels, you gain the ability to use the [[Rules/Source/variant-rules/weapon-mastery-properties-xphb\|mastery properties]] of more kinds of weapons, as shown in the Weapon Mastery column of the Fighter Features table.

### Action Surge (Level 2)

You can push yourself beyond your normal limits for a moment. On your turn, you can take one additional action, except the [[Rules/Source/actions#Magic\|Magic]] action.

Once you use this feature, you can't do so again until you finish a [[Rules/Source/variant-rules/short-rest-xphb\|Short]] or [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]]. Starting at level 17, you can use it twice before a rest but only once on a turn.

### Tactical Mind (Level 2)

You have a mind for tactics on and off the battlefield. When you fail an ability check, you can expend a use of your Second Wind to push yourself toward success. Rather than regaining [[Rules/Source/variant-rules/hit-points-xphb\|Hit Points]], you roll `1d10` and add the number rolled to the ability check, potentially turning it into a success. If the check still fails, this use of Second Wind isn't expended.
...
You gain the [[Rules/Source/feats/ability-score-improvement-xphb\|Ability Score Improvement]] feat or another feat of your choice for which you qualify. You gain this feature again at Fighter levels 6, 8, 12, 14, and 16.
...
Whenever you activate your Second Wind with a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]], you can move up to half your [[Rules/Source/variant-rules/speed-xphb\|Speed]] without provoking [[Rules/Source/actions#Opportunity Attack\|Opportunity Attacks]].
...
If you fail a saving throw, you can reroll it with a bonus equal to your Fighter level. You must use the new roll, and you can't use this feature again until you finish a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]].

You can use this feature twice before a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]] starting at level 13 and three times before a [[Rules/Source/variant-rules/long-rest-xphb\|Long Rest]] starting at level 17.

### Tactical Master (Level 9)

When you attack with a weapon whose mastery property you can use, you can replace that property with the [[Rules/Source/item-mastery#Push\|Push]], [[Rules/Source/item-mastery#Sap\|Sap]], or [[Rules/Source/item-mastery#Slow\|Slow]] property for that attack.
...
You can attack three times instead of once whenever you take the [[Rules/Source/actions#Attack\|Attack]] action on your turn.
...
You study your opponents and learn from each attack you make. If you make an attack roll against a creature and miss, you have [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on your next attack roll against that creature before the end of your next turn.
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [[Rules/Source/feats/boon-of-combat-prowess-xphb\|Boon of Combat Prowess]] is recommended.

### Three Extra Attacks (Level 20)

You can attack four times instead of once whenever you take the [[Rules/Source/actions#Attack\|Attack]] action on your turn.