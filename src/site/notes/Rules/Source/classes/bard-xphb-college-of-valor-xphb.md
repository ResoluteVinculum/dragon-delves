---
{"dg-publish":true,"permalink":"/rules/source/classes/bard-xphb-college-of-valor-xphb/","tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/subclass/bard/valor"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-class"],"tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/subclass/bard/valor"],"aliases":["College of Valor"]}}
---
...
**Defense.** When the creature is hit by an attack roll, that creature can use its [[Rules/Source/variant-rules/reaction-xphb\|Reaction]] to roll the Bardic Inspiration die and add the number rolled to its AC against that attack, potentially causing the attack to miss.
...
You gain proficiency with Martial weapons and training with Medium armor and [[Rules/Source/items/shield-xphb\|Shields]].

In addition, you can use a Simple or Martial weapon as a [[Rules/Source/variant-rules/spellcasting-focus-xphb\|Spellcasting Focus]] to cast spells from your Bard spell list.
...
After you cast a spell that has a casting time of an action, you can make one attack with a weapon as a [[Rules/Source/variant-rules/bonus-action-xphb\|Bonus Action]].