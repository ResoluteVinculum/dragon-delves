---
{"dg-publish":true,"permalink":"/rules/source/variant-rules/customizing-your-origin-tce/","tags":["ttrpg-cli/compendium/src/5e/tce"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"tags":["ttrpg-cli/compendium/src/5e/tce"],"aliases":["Customizing Your Origin"]}}
---
...
| Tool | Tool or simple weapon |{ #proficiency-swaps}


For example, high elf adventurers have proficiency with longswords, which are martial weapons. Consulting the Proficiency Swaps table, we see that your high elf can swap that proficiency for proficiency with another weapon or a tool. Your elf might be a musician, who chooses proficiency with a [[Rules/Source/items/musical-instrument-xphb\|musical instrument]]—a type of tool—instead of with longswords. Similarly, elves start with proficiency in the [[Rules/Source/skills#Perception\|Perception]] skill. Your elf might not have the keen senses associated with your kin and could take proficiency in a different skill, such as [[Rules/Source/skills#Performance\|Performance]].
...
> - **Variable Trait.** You gain one of the following options of your choice: (a) [[Rules/Source/senses#Darkvision\|darkvision]] with a range of 60 feet or (b) proficiency in one skill of your choice.  
