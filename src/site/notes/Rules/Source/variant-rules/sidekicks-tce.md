---
{"dg-publish":true,"permalink":"/rules/source/variant-rules/sidekicks-tce/","tags":["ttrpg-cli/compendium/src/5e/tce"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"tags":["ttrpg-cli/compendium/src/5e/tce"],"aliases":["Sidekicks"]}}
---
...
When you create a sidekick, you choose the class it will have for the rest of its career: [[Rules/Source/classes/expert-sidekick-tce\|Expert]], [[Rules/Source/classes/spellcaster-sidekick-tce\|Spellcaster]], or [[Rules/Source/classes/warrior-sidekick-tce\|Warrior]]. If a sidekick class contains a choice, you may make the choice or let the players make it.
...
If the sidekick drops to 0 hit points and isn't killed outright, it falls [[Rules/Source/conditions#Unconscious\|unconscious]] and subsequently makes death saving throws, just like a player character.
