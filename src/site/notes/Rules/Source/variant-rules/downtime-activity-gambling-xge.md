---
{"dg-publish":true,"permalink":"/rules/source/variant-rules/downtime-activity-gambling-xge/","tags":["ttrpg-cli/compendium/src/5e/xge"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"tags":["ttrpg-cli/compendium/src/5e/xge"],"aliases":["Downtime Activity: Gambling"]}}
---
...
The character makes three checks: Wisdom ([[Rules/Source/skills#Insight\|Insight]]), Charisma ([[Rules/Source/skills#Deception\|Deception]]), and Charisma ([[Rules/Source/skills#Intimidation\|Intimidation]]). If the character has proficiency with an appropriate [[Rules/Source/items/gaming-set-xphb\|gaming set]], that tool proficiency can replace the relevant skill in any of the checks. The DC for each of the checks is `5 + 2d10`; generate a separate DC for each one. Consult the Gambling Results table to see how the character did.
