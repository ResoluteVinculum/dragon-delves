---
{"dg-publish":true,"permalink":"/rules/source/books/dungeon-masters-guide-2024/04-chapter-4-creating-adventures/","tags":["ttrpg-cli/compendium/src/5e/xdmg"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"tags":["ttrpg-cli/compendium/src/5e/xdmg"],"aliases":["Chapter 4: Creating Adventures"]}}
---
...
Many D&D adventures revolve around dungeons—interior spaces such as great halls and tombs, subterranean monster lairs, mazes riddled with traps, natural caverns extending for miles beneath the surface, and ruined castles. The "Dungeons" section in chapter 3 can help you craft a dungeon environment for an adventure.
...
- **The DM's Role.** If the characters can't figure out how to solve an encounter or aren't sure what to do next, you can remind the players of things their characters have already learned or call for Intelligence ([[Rules/Source/skills#Investigation\|Investigation]]) or similar checks to see if their characters can remember and connect things that the players might be missing.  
...
- 1 [[Rules/Source/bestiary/fey/bugbear-warrior-xmm\|Bugbear Warrior]] (200 XP)  
- 2 [[Rules/Source/bestiary/beast/giant-wasp-xmm\|Giant Wasps]] (100 XP each), for 200 XP total  
- 6 [[Rules/Source/bestiary/plant/twig-blight-xmm\|Twig Blights]] (25 XP each), for 150 XP total  
...
- 2 [[Rules/Source/bestiary/aberration/nothic-xmm\|Nothics]] (450 XP each) and 9 [[Rules/Source/bestiary/monstrosity/stirge-xmm\|Stirges]] (25 XP each), for 1,125 XP total  
- 1 [[Rules/Source/bestiary/undead/wight-xmm\|Wight]] (700 XP), 1 [[Rules/Source/bestiary/undead/warhorse-skeleton-xmm\|Warhorse Skeleton]] (100 XP), and 6 [[Rules/Source/bestiary/undead/skeleton-xmm\|Skeletons]] (50 XP each), for 1,100 XP total  
...
- 2 [[Rules/Source/bestiary/dragon/adult-red-dragon-xmm\|Adult Red Dragons]] (18,000 XP each) and 2 [[Rules/Source/bestiary/giant/fire-giant-xmm\|Fire Giants]] (5,000 XP each), for 46,000 XP total  
...
![/Rules/Source/books/dungeon-masters-guide-2024/img/055-03-007-skeleton.webp\|center wmed](/img/user/Rules/Source/books/dungeon-masters-guide-2024/img/055-03-007-skeleton.webp)
...
If your combat encounter includes a creature whose CR is higher than the party's level, be aware that such a creature might deal enough damage with a single action to take out one or more characters. For example, an [[Rules/Source/bestiary/giant/ogre-xmm\|Ogre]] (CR 2) can kill a level 1 Wizard with a single blow.
...
Borogrove, a kindly [[Rules/Source/bestiary/plant/treant-xmm\|Treant]], keeps watch over the wood and meets the characters as they follow the polluted stream. He knows the source of the corruption is inside a cave that the stream spills out of. He gives the characters a magic acorn. If swallowed, the acorn conveys the benefits of a [[Rules/Source/items/potion-of-healing-xdmg\|Potion of Healing]] and the [[Rules/Source/spells/lesser-restoration-xphb\|Lesser Restoration]] spell.

##### Twig Blights

Just outside the cave, the characters encounter six [[Rules/Source/bestiary/plant/twig-blight-xmm\|Twig Blights]].
...
- **Entrance.** A [[Rules/Source/bestiary/plant/shrieker-fungus-xmm\|Shrieker Fungus]] just inside the cave entrance alerts the inhabitants to the characters' arrival. On watch near the entrance and quick to respond to the shriekers' cry are four [[Rules/Source/bestiary/fey/bullywug-warrior-xmm\|Bullywug Warriors]] who have fungal growths on them.  
- **Berserk Bear.** In a side cave to the southeast is a [[Rules/Source/bestiary/beast/brown-bear-xmm\|Brown Bear]] that drank from the stream. It's upset because the water made it ill. If the characters can make it eat Borogrove's acorn or otherwise rid it the [[Rules/Source/conditions#Poisoned\|Poisoned]] condition, the bear recovers immediately and leaves them alone.  
- **Ooze's Lair.** At the north end of the stream are a [[Rules/Source/bestiary/ooze/gray-ooze-xmm\|Psychic Gray Ooze]] and six [[Rules/Source/bestiary/monstrosity/stirge-xmm\|Stirges]]. After defeating these creatures, the characters can destroy the brain-like fungus in the water, which is the source of the corruption. If they do, each character earns a bonus 100 XP.  

##### Journey Home

As they leave the wood, the characters encounter Borogrove again. If they used his acorn, he gives them another one. If they purified the source of the stream, he gives them a [[Rules/Source/items/staff-of-flowers-xdmg\|Staff of Flowers]] in gratitude.

### Miner Difficulties

*Adventure for Level 2 Characters*

- **Situation.** After miners dug into an Underdark tunnel, a [[Rules/Source/bestiary/monstrosity/hook-horror-xmm\|Hook Horror]] found its way into the mine and became trapped. It has eaten a few miners, and the others are too terrified of the echoing clicks in the mine to hunt down the predator.  
- **Hook.** The mayor of the village of Blackstone, Kristryd Splitanvil (a Lawful Good, dwarf [[Rules/Source/bestiary/humanoid/tough-xmm\|Tough]]), hires the adventurers—perhaps because of how adeptly they handled the situation in "The Fouled Stream"—to deal with the monster in the mines. She offers a precious [[Rules/Source/items/topaz-xdmg\|topaz]] worth 500 GP to adventurers who kill the creature or drive it away.  
...
- **Situation.** A few weeks ago, a [[Rules/Source/bestiary/dragon/red-dragon-wyrmling-xmm\|Red Dragon Wyrmling]] drove a band of kobolds out of their warren to claim the place as its lair. Now some of the kobolds are causing trouble in the Cairn Hills. They're raiding merchants, hoping the dragon will allow them to return home as its loyal servants.  
- **Hook.** A merchant named Nondy Barducks (a Lawful Neutral, gnome [[Rules/Source/bestiary/humanoid/commoner-xmm\|Commoner]]) hires the characters to escort his wagon to the remote mining village of Diamond Lake, which happens to be near the dragon's new lair. Nondy was robbed by kobolds on his last trip, and he wants protection this time. He offers to pay each character 150 GP.  
...
Along the road, the wagon is surrounded by eight [[Rules/Source/bestiary/dragon/kobold-warrior-xmm\|Kobold Warriors]] (Neutral) who demand that the merchant surrender his goods. In combat, the kobolds shout things like "For the Winged God!" and "Fight to reclaim our home!" If four of them fall in battle, the remaining kobolds try to flee. Any captured kobold explains the situation.

##### Kobold Supplicants

If the characters continue on their way without pursuing the kobolds, twelve [[Rules/Source/bestiary/dragon/kobold-warrior-xmm\|Kobold Warriors]] (including any survivors of the first encounter) and six [[Rules/Source/bestiary/dragon/winged-kobold-xmm\|Winged Kobolds]] (all Neutral) approach the wagon. These kobolds humbly ask the adventurers to help them. They promise to return the goods they stole from Nondy if the adventurers drive off the dragon.
...
Use the Volcanic Caves map in Appendix B for the dragon's lair, but close off passages to keep the lair small. Near the entrance, the characters encounter a gang of four [[Rules/Source/bestiary/elemental/magma-mephit-xmm\|Magma Mephits]] and three [[Rules/Source/bestiary/elemental/smoke-mephit-xmm\|Smoke Mephits]], drawn to the lair by the magic of the dragon.

In the inner cave, the troublesome [[Rules/Source/bestiary/dragon/red-dragon-wyrmling-xmm\|Red Dragon Wyrmling]] rests on its little hoard:
...
- Two [[Rules/Source/items/spell-scroll-xdmg\|Spell Scrolls]] ([[Rules/Source/spells/alarm-xphb\|Alarm]] and [[Rules/Source/spells/comprehend-languages-xphb\|Comprehend Languages]])  
...
Melchis hires a ship to carry the party to the Amedio Jungle. Use the map to determine how long the sea voyage takes, depending on where the adventurers begin the trip and figuring that the ship covers about 1½ hexes per day. Near the end of the trip, as the ship crosses Jeklea Bay, it's attacked by a group of [[Rules/Source/variant-rules/hostile-attitude-xphb\|Hostile]] sahuagin, including two [[Rules/Source/bestiary/fiend/sahuagin-priest-xmm\|Sahuagin Priests]], six [[Rules/Source/bestiary/fiend/sahuagin-warrior-xmm\|Sahuagin Warriors]], and a [[Rules/Source/bestiary/elemental/water-elemental-xmm\|Water Elemental]]. (Assume the ship's crew stays out of the way of these terrifying monsters and lets the characters and Melchis deal with this threat.) Stage 1 ends when Melchis and the characters row a launch ashore.
...
Once the characters reach the edge of the lake, Melchis leads them southwest along the shore until they find the ruin. This stage covers 90 miles through coastal terrain. The second day of the journey, [[Rules/Source/traps-hazards/heavy-precipitation-xdmg\|heavy rain]] obscures vision and creates [[Rules/Source/traps-hazards/quicksand-pit-xdmg\|quicksand pits]] (see "Environmental Effects" and "Hazards" in chapter 3). The front rank of the party might fall into a quicksand pit while two [[Rules/Source/bestiary/beast/giant-crocodile-xmm\|Giant Crocodiles]] attack at the same time. The rest of the journey passes without incident.

##### The Ruins

For the ruins, use the western half of the ground floor of the Dungeon Hideout map in Appendix B, and ignore the stairs leading to the lower levels. Dwelling in the ruins are six [[Rules/Source/bestiary/monstrosity/minotaur-of-baphomet-xmm\|Minotaurs of Baphomet]] who are Hostile to all intruders. They are spread out around the ruins but come quickly when they hear combat.

##### The Artifact

The Horns of the Beast—a jagged crown made from the horns of demons and wild animals—rests on a pedestal in the northwest corner of the ruins. Melchis immediately attempts to seize the Artifact and place it on his head. If he does, he is transformed into a [[Rules/Source/bestiary/fiend/hezrou-xmm\|Hezrou]] and tries to kill the characters. A character who dons the Artifact is cursed with Demonic Possession (see "Curses and Magical Contagions" in chapter 3). The Artifact can't be removed from the character's head until a [[Rules/Source/spells/remove-curse-xphb\|Remove Curse]] spell is cast on the character. If the characters defeat Melchis and search him, they find a [[Rules/Source/items/bag-of-holding-xdmg\|Bag of Holding]] containing twelve 5-pound gold trade bars (worth 250 GP each) and a [[Rules/Source/items/spell-scroll-xdmg\|Spell Scroll]] of [[Rules/Source/spells/teleportation-circle-xphb\|Teleportation Circle]]. The scroll also contains the sigil sequence for a permanent teleportation circle. At the end of the adventure, each character earns a bonus 1,000 XP.

##### Destroying the Artifact

The Horns of the Beast can be destroyed only by dropping it in the River Oceanus, which flows through the Upper Planes (see chapter 6). A character can learn this by casting [[Rules/Source/spells/identify-xphb\|Identify]] on the Artifact.
...
- Cannifer is a [[Rules/Source/bestiary/fey/satyr-revelmaster-xmm\|Satyr Revelmaster]] who is used to being the center of attention at every ball he attends and is thus [[Rules/Source/variant-rules/hostile-attitude-xphb\|Hostile]] to the adventurers.  
- Daris is a [[Rules/Source/variant-rules/friendly-attitude-xphb\|Friendly]], fun-loving [[Rules/Source/bestiary/fey/dryad-xmm\|Dryad]] who wants to be seen dancing with all the adventurers.  
- Fidget is a playful [[Rules/Source/bestiary/fey/pixie-xmm\|Pixie]] who is [[Rules/Source/variant-rules/indifferent-attitude-xphb\|Indifferent]] and pesters the adventurers with pranks throughout the evening, without causing any actual harm.  
- Granny Snailtongue is a [[Rules/Source/variant-rules/hostile-attitude-xphb\|Hostile]] [[Rules/Source/bestiary/fey/green-hag-xmm\|Green Hag]] who sees the adventurers as potentially useful tools. She offers to help them at every turn in hopes of putting them in her debt.  
- Raxas Albrethin is an arrogant, Chaotic Neutral drow [[Rules/Source/bestiary/humanoid/mage-xmm\|Mage]] who is initially [[Rules/Source/variant-rules/hostile-attitude-xphb\|Hostile]] and wants to see the adventurers humiliated. However, once the characters' Renown Score reaches 6, Raxas admits he misjudged them and becomes [[Rules/Source/variant-rules/friendly-attitude-xphb\|Friendly]].  

##### Rude Interruption

After the second dance, the ball is interrupted by a Neutral Evil [[Rules/Source/bestiary/fey/hobgoblin-warlord-xmm\|Hobgoblin Warlord]] named Varka, who is accompanied by a [[Rules/Source/bestiary/fey/hobgoblin-captain-xmm\|Hobgoblin Captain]] and five [[Rules/Source/bestiary/fey/hobgoblin-warrior-xmm\|Hobgoblin Warriors]]. The hobgoblins are offended by the adventurers' presence and attack them. If the characters defeat the hobgoblins, their Renown Score increases by 2.

##### Conclusion

After three dances, the Baron of the Boreal Ball appears. If the party's Renown Score is at least 6, he bestows on each character a Charm of the Boreal Ball. This charm (see "Supernatural Gifts" in chapter 3) allows a character who has it to cast the level 3 version of the [[Rules/Source/spells/ice-knife-xphb\|Ice Knife]] spell. Once used, the Charm vanishes. Each character also earns a bonus 1,700 XP.