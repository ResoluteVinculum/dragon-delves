---
{"dg-publish":true,"permalink":"/rules/source/books/players-handbook-2024/03-chapter-2-creating-a-character/","tags":["ttrpg-cli/compendium/src/5e/xphb"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"tags":["ttrpg-cli/compendium/src/5e/xphb"],"aliases":["Chapter 2: Creating a Character"]}}
---
...
> 
> The classic D&D party comprises a [[Rules/Source/classes/cleric-xphb\|Cleric]], [[Rules/Source/classes/fighter-xphb\|Fighter]], [[Rules/Source/classes/rogue-xphb\|Rogue]], and [[Rules/Source/classes/wizard-xphb\|Wizard]]. Those four classes have the longest history in the game, but more importantly, they bring a balanced mix of capabilities to adventures. You're welcome to use that party setup or modify it using these guidelines:
> 
> - **Cleric.** Replace with [[Rules/Source/classes/bard-xphb\|Bard]] or [[Rules/Source/classes/druid-xphb\|Druid]]  
> - **Fighter.** Replace with [[Rules/Source/classes/barbarian-xphb\|Barbarian]], [[Rules/Source/classes/monk-xphb\|Monk]], [[Rules/Source/classes/paladin-xphb\|Paladin]], or [[Rules/Source/classes/ranger-xphb\|Ranger]]  
> - **Rogue.** Replace with [[Rules/Source/classes/bard-xphb\|Bard]] or [[Rules/Source/classes/ranger-xphb\|Ranger]]  
> - **Wizard.** Replace with [[Rules/Source/classes/bard-xphb\|Bard]], [[Rules/Source/classes/sorcerer-xphb\|Sorcerer]], or [[Rules/Source/classes/warlock-xphb\|Warlock]]  { #a-balanced-party}



#### Write Your Level

Write your character's level on your character sheet. Typically, a character starts at level 1 and advances in level by adventuring and gaining [[Rules/Source/variant-rules/experience-points-xphb\|Experience Points]] (XP).
...
Your background and class both provide starting equipment. Any coins that you gain at this step can be immediately spent on equipment from chapter 6. In addition, you can have one [[Rules/Source/items/trinket-xphb\|trinket]] at no cost at the end of this chapter.
...
Choose a species for your character. The following species options are detailed in chapter 4: [[Rules/Source/races/aasimar-xphb\|Aasimar]], [[Rules/Source/races/dragonborn-xphb\|Dragonborn]], [[Rules/Source/races/dwarf-xphb\|Dwarf]], [[Rules/Source/races/elf-xphb\|Elf]], [[Rules/Source/races/gnome-xphb\|Gnome]], [[Rules/Source/races/goliath-xphb\|Goliath]], [[Rules/Source/races/halfling-xphb\|Halfling]], [[Rules/Source/races/human-xphb\|Human]], [[Rules/Source/races/orc-xphb\|Orc]], and [[Rules/Source/races/tiefling-xphb\|Tiefling]]. Once you've chosen a species, write it on your character sheet. Then record your species' traits.

Your character's [[Rules/Source/variant-rules/size-xphb\|size]] and [[Rules/Source/variant-rules/speed-xphb\|Speed]] are determined by the character's species; record these in the appropriate places on your character sheet as well (you may write just the first letter of your size).
...
> 
> Most creatures that lack the capacity for rational thought don't have alignments; they are unaligned. [[Rules/Source/bestiary/beast/reef-shark-xmm\|Sharks]] are savage predators, for example, but they aren't evil; they are unaligned.{ #unaligned-creatures}
...
Sometimes your DM will determine whether your character notices something without asking you to make a Wisdom ([[Rules/Source/skills#Perception\|Perception]]) check; the DM uses your Passive Perception instead. Passive Perception is a score that reflects a general awareness of your surroundings when you're not actively looking for something. Use this formula to determine your Passive Perception score:

<span class='abilityGeneric'>**Passive Perception.**</span>

Include all modifiers that apply to your Wisdom ([[Rules/Source/skills#Perception\|Perception]]) checks. For example, if your character has a Wisdom of 15 and proficiency in the [[Rules/Source/skills#Perception\|Perception]] skill, you have a Passive Perception of 14 (10 + 2 for your Wisdom modifier + 2 for proficiency).
...
Without armor or a shield, your base [[Rules/Source/variant-rules/armor-class-xphb\|Armor Class]] is 10 plus your Dexterity modifier. If your starting equipment includes armor or a Shield (or both), calculate your AC using the rules in chapter 6. A class feature might give you a different way to calculate your AC.
...
In tier 2, characters are full-fledged adventurers. Spellcasters gain iconic spells such as [[Rules/Source/spells/fireball-xphb\|Fireball]], [[Rules/Source/spells/lightning-bolt-xphb\|Lightning Bolt]], and [[Rules/Source/spells/raise-dead-xphb\|Raise Dead]]. Most weapon-focused classes gain the ability to make multiple attacks in a round. The characters now face dangers that threaten cities and kingdoms.
...
If you have multiple ways to calculate your [[Rules/Source/variant-rules/armor-class-xphb\|Armor Class]], you can benefit from only one at a time. For example, a Monk/Sorcerer with a Monk's Unarmored Defense feature and a Sorcerer's Draconic Resilience feature must choose only one of those features as a way to calculate Armor Class.
...
This table might give you spell slots of a higher level than the spells you prepare. You can use those slots but only to cast your lower-level spells. If a lower-level spell that you cast, like [[Rules/Source/spells/burning-hands-xphb\|Burning Hands]], has an enhanced effect when cast at a higher level, you can use the enhanced effect as normal.
...
When you make your character, you can roll once on the [[Rules/Source/items/trinket-xphb\|Trinkets]] table to gain a Tiny trinket, a simple item lightly touched by mystery. The DM might also use this table. It can help stock a room in a dungeon or fill a creature's pockets.