---
{"dg-publish":true,"permalink":"/rules/source/books/players-handbook-2024/01-introduction-welcome-to-adventure/","tags":["ttrpg-cli/compendium/src/5e/xphb"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"tags":["ttrpg-cli/compendium/src/5e/xphb"],"aliases":["Introduction: Welcome to Adventure"]}}
---
...
> 
> If you can't find a rule, check the index. If a rule's name has changed from what was printed in the 2014 *Player's Handbook*, the index points you to the new name. For example, if you look up Inspiration in the index, it points you to the rules for [[Rules/Source/variant-rules/heroic-inspiration-xphb\|Heroic Inspiration]] in the rules glossary.
