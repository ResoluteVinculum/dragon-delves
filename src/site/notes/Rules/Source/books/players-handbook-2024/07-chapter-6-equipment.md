---
{"dg-publish":true,"permalink":"/rules/source/books/players-handbook-2024/07-chapter-6-equipment/","tags":["ttrpg-cli/compendium/src/5e/xphb"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"tags":["ttrpg-cli/compendium/src/5e/xphb"],"aliases":["Chapter 6: Equipment"]}}
---
...
You have [[Rules/Source/variant-rules/disadvantage-xphb\|Disadvantage]] on attack rolls with a Heavy weapon if it's a Melee weapon and your Strength score isn't at least 13 or if it's a Ranged weapon and your Dexterity score isn't at least 13.

> [!note] Improvised Weapons
> 
> If you use an object—such as a table leg, frying pan, or bottle—as a makeshift weapon, see "[[Rules/Source/variant-rules/improvised-weapons-xphb\|Improvised Weapons]]" in the rules glossary. Also see those rules if you wield a weapon in an unusual way, such as using a Ranged weapon to make a melee attack.{ #improvised-weapons}



#### Light

When you take the [[Rules/Source/actions#Attack\|Attack]] action on your turn and attack with a Light weapon, you can make one extra attack as a Bonus Action later on the same turn. That extra attack must be made with a different Light weapon, and you don't add your ability modifier to the extra attack's damage unless that modifier is negative. For example, you can attack with a [[Rules/Source/items/shortsword-xphb\|Shortsword]] in one hand and a [[Rules/Source/items/dagger-xphb\|Dagger]] in the other using the [[Rules/Source/actions#Attack\|Attack]] action and a Bonus Action, but you don't add your Strength or Dexterity modifier to the damage roll of the Bonus Action unless that modifier is negative.
...
A Range weapon has a range in parentheses after the [[Rules/Source/item-properties#Ammunition\|Ammunition]] or [[Rules/Source/item-properties#Thrown\|Thrown]] property. The range lists two numbers. The first is the weapon's normal range in feet, and the second is the weapon's long range. When attacking a target beyond normal range, you have [[Rules/Source/variant-rules/disadvantage-xphb\|Disadvantage]] on the attack roll. You can't attack a target beyond the long range.

#### Reach

A Reach weapon adds 5 feet to your reach when you attack with it, as well as when determining your reach for [[Rules/Source/actions#Opportunity Attack\|Opportunity Attacks]] with it.
...
When you make the extra attack of the [[Rules/Source/item-properties#Light\|Light]] property, you can make it as part of the [[Rules/Source/actions#Attack\|Attack]] action instead of as a Bonus Action. You can make this extra attack only once per turn.
...
If you hit a creature with this weapon, that creature has [[Rules/Source/variant-rules/disadvantage-xphb\|Disadvantage]] on its next attack roll before the start of your next turn.
...
If you hit a creature with this weapon, you can force the creature to make a Constitution saving throw (DC 8 plus the ability modifier used to make the attack roll and your Proficiency Bonus). On a failed save, the creature has the [[Rules/Source/conditions#Prone\|Prone]] condition.

#### Vex

If you hit a creature with this weapon and deal damage to the creature, you have [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on your next attack roll against that creature before the end of your next turn.
...
If you wear Light, Medium, or Heavy armor and lack training with it, you have [[Rules/Source/variant-rules/disadvantage-xphb\|Disadvantage]] on any [[Rules/Source/variant-rules/d20-test-xphb\|D20 Test]] that involves Strength or Dexterity, and you can't cast spells.
...
- **Utilize.** This entry lists things you can do with the tool when you take the [[Rules/Source/actions#Utilize\|Utilize]] action. You can do one of those things each time you take the action. This entry also provides the DC for the action.  
...
![/Rules/Source/books/players-handbook-2024/img/176-07-002-tools.webp\|center wmed](/img/user/Rules/Source/books/players-handbook-2024/img/176-07-002-tools.webp)

### Tool Proficiency

If you have proficiency with a tool, add your Proficiency Bonus to any ability check you make that uses the tool. If you have proficiency in a skill that's used with that check, you have [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on the check too.
...
- **Craft.** [[Rules/Source/items/acid-xphb\|Acid]], [[Rules/Source/items/alchemists-fire-xphb\|Alchemist's Fire]], [[Rules/Source/items/component-pouch-xphb\|Component Pouch]], [[Rules/Source/items/oil-xphb\|Oil]], [[Rules/Source/items/paper-xphb\|Paper]], [[Rules/Source/items/perfume-xphb\|Perfume]]  
...
- **Craft.** [[Rules/Source/items/antitoxin-xphb\|Antitoxin]]  
...
- **Craft.** [[Rules/Source/items/ink-xphb\|Ink]], [[Rules/Source/items/spell-scroll-xdmg\|Spell Scroll]]  
...
- **Craft.** [[Rules/Source/items/club-xphb\|Club]], [[Rules/Source/items/greatclub-xphb\|Greatclub]], [[Rules/Source/items/quarterstaff-xphb\|Quarterstaff]], [[Rules/Source/items/barrel-xphb\|Barrel]], [[Rules/Source/items/chest-xphb\|Chest]], [[Rules/Source/items/ladder-xphb\|Ladder]], [[Rules/Source/items/pole-xphb\|Pole]], [[Rules/Source/items/portable-ram-xphb\|Portable Ram]], [[Rules/Source/items/torch-xphb\|Torch]]  
...
- **Craft.** [[Rules/Source/items/map-xphb\|Map]]  

#### Cobbler's Tools (5 GP)

- **Ability.** Dexterity  
- **Weight.** 5 lb.  
- **Utilize.** Modify footwear to give [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on the wearer's next Dexterity ([[Rules/Source/skills#Acrobatics\|Acrobatics]]) check (DC 10)  
- **Craft.** [[Rules/Source/items/climbers-kit-xphb\|Climber's Kit]]  
...
- **Craft.** [[Rules/Source/items/rations-xphb\|Rations]]  
...
- **Craft.** [[Rules/Source/items/glass-bottle-xphb\|Glass Bottle]], [[Rules/Source/items/magnifying-glass-xphb\|Magnifying Glass]], [[Rules/Source/items/spyglass-xphb\|Spyglass]], [[Rules/Source/items/vial-xphb\|Vial]]  
...
- **Craft.** [[Rules/Source/items/arcane-focus-xphb\|Arcane Focus]], [[Rules/Source/items/holy-symbol-xphb\|Holy Symbol]]  
...
- **Craft.** [[Rules/Source/items/sling-xphb\|Sling]], [[Rules/Source/items/whip-xphb\|Whip]], [[Rules/Source/items/hide-armor-xphb\|Hide Armor]], [[Rules/Source/items/leather-armor-xphb\|Leather Armor]], [[Rules/Source/items/studded-leather-armor-xphb\|Studded Leather Armor]], [[Rules/Source/items/backpack-xphb\|Backpack]], [[Rules/Source/items/crossbow-bolt-case-xphb\|Crossbow Bolt Case]], [[Rules/Source/items/map-or-scroll-case-xphb\|Map or Scroll Case]], [[Rules/Source/items/parchment-xphb\|Parchment]], [[Rules/Source/items/pouch-xphb\|Pouch]], [[Rules/Source/items/quiver-xphb\|Quiver]], [[Rules/Source/items/waterskin-xphb\|Waterskin]]  
...
- **Craft.** [[Rules/Source/items/block-and-tackle-xphb\|Block and Tackle]]  
...
- **Craft.** [[Rules/Source/items/druidic-focus-xphb\|Druidic Focus]], [[Rules/Source/items/holy-symbol-xphb\|Holy Symbol]]  
...
- **Craft.** [[Rules/Source/items/jug-xphb\|Jug]], [[Rules/Source/items/lamp-xphb\|Lamp]]  
...
- **Craft.** Any Melee weapon (except Club, Greatclub, Quarterstaff, and Whip), Medium armor (except Hide), Heavy armor, [[Rules/Source/items/ball-bearings-xphb\|Ball Bearings]], [[Rules/Source/items/bucket-xphb\|Bucket]], [[Rules/Source/items/caltrops-xphb\|Caltrops]], [[Rules/Source/items/chain-xphb\|Chain]], [[Rules/Source/items/crowbar-xphb\|Crowbar]], [[Rules/Source/items/firearm-bullets-10-xphb\|Firearm Bullets]], [[Rules/Source/items/grappling-hook-xphb\|Grappling Hook]], [[Rules/Source/items/iron-pot-xphb\|Iron Pot]], [[Rules/Source/items/iron-spikes-xphb\|Iron Spikes]], [[Rules/Source/items/sling-bullet-xphb\|Sling Bullets]]  
...
- **Craft.** [[Rules/Source/items/musket-xphb\|Musket]], [[Rules/Source/items/pistol-xphb\|Pistol]], [[Rules/Source/items/bell-xphb\|Bell]], [[Rules/Source/items/bullseye-lantern-xphb\|Bullseye Lantern]], [[Rules/Source/items/flask-xphb\|Flask]], [[Rules/Source/items/hooded-lantern-xphb\|Hooded Lantern]], [[Rules/Source/items/hunting-trap-xphb\|Hunter's Trap]], [[Rules/Source/items/lock-xphb\|Lock]], [[Rules/Source/items/manacles-xphb\|Manacles]], [[Rules/Source/items/mirror-xphb\|Mirror]], [[Rules/Source/items/shovel-xphb\|Shovel]], [[Rules/Source/items/signal-whistle-xphb\|Signal Whistle]], [[Rules/Source/items/tinderbox-xphb\|Tinderbox]]  
...
- **Craft.** [[Rules/Source/items/padded-armor-xphb\|Padded Armor]], [[Rules/Source/items/basket-xphb\|Basket]], [[Rules/Source/items/bedroll-xphb\|Bedroll]], [[Rules/Source/items/blanket-xphb\|Blanket]], [[Rules/Source/items/fine-clothes-xphb\|Fine Clothes]], [[Rules/Source/items/net-xphb\|Net]], [[Rules/Source/items/robe-xphb\|Robe]], [[Rules/Source/items/rope-xphb\|Rope]], [[Rules/Source/items/sack-xphb\|Sack]], [[Rules/Source/items/string-xphb\|String]], [[Rules/Source/items/tent-xphb\|Tent]], [[Rules/Source/items/travelers-clothes-xphb\|Traveler's Clothes]]  
...
- **Craft.** [[Rules/Source/items/club-xphb\|Club]], [[Rules/Source/items/greatclub-xphb\|Greatclub]], [[Rules/Source/items/quarterstaff-xphb\|Quarterstaff]], Ranged weapons (except Pistol, Musket, and Sling), [[Rules/Source/items/arcane-focus-xphb\|Arcane Focus]], [[Rules/Source/items/arrows-20-xphb\|Arrows]], [[Rules/Source/items/bolts-20-xphb\|Bolts]], [[Rules/Source/items/druidic-focus-xphb\|Druidic Focus]], [[Rules/Source/items/ink-pen-xphb\|Ink Pen]], [[Rules/Source/items/needles-50-xphb\|Needles]]  
...
- **Craft.** [[Rules/Source/items/costume-xphb\|Costume]]  
...
- **Variants.** [[Rules/Source/items/dice-set-xphb\|Dice]] (1 SP), [[Rules/Source/items/dragonchess-set-xphb\|dragonchess]] (1 GP), [[Rules/Source/items/playing-cards-xphb\|playing cards]] (5 SP), [[Rules/Source/items/three-dragon-ante-set-xphb\|three-dragon ante]] (1 GP)  
...
- **Craft.** [[Rules/Source/items/antitoxin-xphb\|Antitoxin]], [[Rules/Source/items/candle-xphb\|Candle]], [[Rules/Source/items/healers-kit-xphb\|Healer's Kit]], [[Rules/Source/items/potion-of-healing-xdmg\|Potion of Healing]]  
...
- **Variants.** [[Rules/Source/items/bagpipes-xphb\|Bagpipes]] (30 GP, 6 lb.), [[Rules/Source/items/drum-xphb\|drum]] (6 GP, 3 lb.), [[Rules/Source/items/dulcimer-xphb\|dulcimer]] (25 GP, 10 lb.), [[Rules/Source/items/flute-xphb\|flute]] (2 GP, 1 lb.), horn (3 GP, 2 lb.), [[Rules/Source/items/lute-xphb\|lute]] (35 GP, 2 lb.), [[Rules/Source/items/lyre-xphb\|lyre]] (30 GP, 2 lb.), [[Rules/Source/items/pan-flute-xphb\|pan flute]] (12 GP, 2 lb.), [[Rules/Source/items/shawm-xphb\|shawm]] (2 GP, 1 lb.), [[Rules/Source/items/viol-xphb\|viol]] (30 GP, 1 lb.)  
...
- **Craft.** [[Rules/Source/items/basic-poison-xphb\|Basic Poison]]  
...
When you take the [[Rules/Source/actions#Attack\|Attack]] action, you can replace one of your attacks with throwing a vial of Acid. Target one creature or object you can see within 20 feet of yourself. The target must succeed on a Dexterity saving throw (DC 8 plus your Dexterity modifier and Proficiency Bonus) or take `2d6` Acid damage.

### Alchemist's Fire (50 GP)

When you take the [[Rules/Source/actions#Attack\|Attack]] action, you can replace one of your attacks with throwing a flask of Alchemist's Fire. Target one creature or object you can see within 20 feet of yourself. The target must succeed on a Dexterity saving throw (DC 8 plus your Dexterity modifier and Proficiency Bonus) or take `1d4` Fire damage and start [[Rules/Source/traps-hazards/burning-xphb\|burning]].
...
As a Bonus Action, you can drink a vial of Antitoxin to gain [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on saving throws to avoid or end the [[Rules/Source/conditions#Poisoned\|Poisoned]] condition for 1 hour.
...
As a [[Rules/Source/actions#Utilize\|Utilize]] action, you can spill Ball Bearings from their pouch. They spread to cover a level, 10-foot-square area within 10 feet of yourself. A creature that enters this area for the first time on a turn must succeed on a DC 10 Dexterity saving throw or have the [[Rules/Source/conditions#Prone\|Prone]] condition. It takes 10 minutes to recover the Ball Bearings.
...
When rung as a [[Rules/Source/actions#Utilize\|Utilize]] action, a Bell produces a sound that can be heard up to 60 feet away.

### Blanket (5 SP)

While wrapped in a blanket, you have [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on saving throws against extreme cold (see the *Dungeon Master's Guide*).
...
A Book contains fiction or nonfiction. If you consult an accurate nonfiction Book about its topic, you gain a +5 bonus to Intelligence ([[Rules/Source/skills#Arcana\|Arcana]], [[Rules/Source/skills#History\|History]], [[Rules/Source/skills#Nature\|Nature]], or [[Rules/Source/skills#Religion\|Religion]]) checks you make about that topic.
...
A Burglar's Pack contains the following items: [[Rules/Source/items/backpack-xphb\|Backpack]], [[Rules/Source/items/ball-bearings-xphb\|Ball Bearings]], [[Rules/Source/items/bell-xphb\|Bell]], 10 [[Rules/Source/items/candle-xphb\|Candles]], [[Rules/Source/items/crowbar-xphb\|Crowbar]], [[Rules/Source/items/hooded-lantern-xphb\|Hooded Lantern]], 7 flasks of [[Rules/Source/items/oil-xphb\|Oil]], 5 days of [[Rules/Source/items/rations-xphb\|Rations]], [[Rules/Source/items/rope-xphb\|Rope]], [[Rules/Source/items/tinderbox-xphb\|Tinderbox]], and [[Rules/Source/items/waterskin-xphb\|Waterskin]].

### Caltrops (1 GP)

As a [[Rules/Source/actions#Utilize\|Utilize]] action, you can spread Caltrops from their bag to cover a 5-foot-square area within 5 feet of yourself. A creature that enters this area for the first time on a turn must succeed on a DC 15 Dexterity saving throw or take 1 Piercing damage and have its Speed reduced to 0 until the start of its next turn. It takes 10 minutes to recover the Caltrops.

### Candle (1 CP)

For 1 hour, a lit Candle sheds [[Rules/Source/variant-rules/bright-light-xphb\|Bright Light]] in a 5-foot radius and [[Rules/Source/variant-rules/dim-light-xphb\|Dim Light]] for an additional 5 feet.

### Case, Crossbow Bolt (1 GP)

A Crossbow Bolt Case holds up to 20 [[Rules/Source/items/bolts-20-xphb\|Bolts]].

### Case, Map or Scroll (1 GP)

A Map or Scroll Case holds up to 10 sheets of [[Rules/Source/items/paper-xphb\|paper]] or 5 sheets of [[Rules/Source/items/parchment-xphb\|parchment]].

### Chain (5 GP)

As a [[Rules/Source/actions#Utilize\|Utilize]] action, you can wrap a Chain around an unwilling creature within 5 feet of yourself that has the [[Rules/Source/conditions#Grappled\|Grappled]], [[Rules/Source/conditions#Incapacitated\|Incapacitated]], or [[Rules/Source/conditions#Restrained\|Restrained]] condition if you succeed on a DC 13 Strength ([[Rules/Source/skills#Athletics\|Athletics]]) check. If the creature's legs are bound, the creature has the Restrained condition until it escapes. Escaping the Chain requires the creature to make a successful DC 18 Dexterity ([[Rules/Source/skills#Acrobatics\|Acrobatics]]) check as an action. Bursting the Chain requires a successful DC 20 Strength ([[Rules/Source/skills#Athletics\|Athletics]]) check as an action.
...
While wearing a Costume, you have [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on any ability check you make to impersonate the person or type of person it represents.

### Crowbar (2 GP)

Using a Crowbar gives you [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on Strength checks where the Crowbar's leverage can be applied.

### Diplomat's Pack (39 GP)

A Diplomat's Pack contains the following items: [[Rules/Source/items/chest-xphb\|Chest]], [[Rules/Source/items/fine-clothes-xphb\|Fine Clothes]], [[Rules/Source/items/ink-xphb\|Ink]], 5 [[Rules/Source/items/ink-pen-xphb\|Ink Pens]], [[Rules/Source/items/lamp-xphb\|Lamp]], 2 [[Rules/Source/items/map-or-scroll-case-xphb\|Map or Scroll Cases]], 4 flasks of [[Rules/Source/items/oil-xphb\|Oil]], 5 sheets of [[Rules/Source/items/paper-xphb\|Paper]], 5 sheets of [[Rules/Source/items/parchment-xphb\|Parchment]], [[Rules/Source/items/perfume-xphb\|Perfume]], and [[Rules/Source/items/tinderbox-xphb\|Tinderbox]].
...
A Dungeoneer's Pack contains the following items: [[Rules/Source/items/backpack-xphb\|Backpack]], [[Rules/Source/items/caltrops-xphb\|Caltrops]], [[Rules/Source/items/crowbar-xphb\|Crowbar]], 2 flasks of [[Rules/Source/items/oil-xphb\|Oil]], 10 days of [[Rules/Source/items/rations-xphb\|Rations]], [[Rules/Source/items/rope-xphb\|Rope]], [[Rules/Source/items/tinderbox-xphb\|Tinderbox]], 10 [[Rules/Source/items/torch-xphb\|Torches]], and [[Rules/Source/items/waterskin-xphb\|Waterskin]].

### Entertainer's Pack (40 GP)

An Entertainer's Pack contains the following items: [[Rules/Source/items/backpack-xphb\|Backpack]], [[Rules/Source/items/bedroll-xphb\|Bedroll]], [[Rules/Source/items/bell-xphb\|Bell]], [[Rules/Source/items/bullseye-lantern-xphb\|Bullseye Lantern]], 3 [[Rules/Source/items/costume-xphb\|Costumes]], [[Rules/Source/items/mirror-xphb\|Mirror]], 8 flasks of [[Rules/Source/items/oil-xphb\|Oil]], 9 days of [[Rules/Source/items/rations-xphb\|Rations]], [[Rules/Source/items/tinderbox-xphb\|Tinderbox]], and [[Rules/Source/items/waterskin-xphb\|Waterskin]].

### Explorer's Pack (10 GP)

An Explorer's Pack contains the following items: [[Rules/Source/items/backpack-xphb\|Backpack]], [[Rules/Source/items/bedroll-xphb\|Bedroll]], 2 flasks of [[Rules/Source/items/oil-xphb\|Oil]], 10 days of [[Rules/Source/items/rations-xphb\|Rations]], [[Rules/Source/items/rope-xphb\|Rope]], [[Rules/Source/items/tinderbox-xphb\|Tinderbox]], 10 [[Rules/Source/items/torch-xphb\|Torches]], and [[Rules/Source/items/waterskin-xphb\|Waterskin]].
...
As a [[Rules/Source/actions#Utilize\|Utilize]] action, you can throw the Grappling Hook at a railing, a ledge, or another catch within 50 feet of yourself, and the hook catches on if you succeed on a DC 13 Dexterity ([[Rules/Source/skills#Acrobatics\|Acrobatics]]) check. If you tied a [[Rules/Source/items/rope-xphb\|Rope]] to the hook, you can then climb it.

### Healer's Kit (5 GP)

A Healer's Kit has ten uses. As a [[Rules/Source/actions#Utilize\|Utilize]] action, you can expend one of its uses to stabilize an [[Rules/Source/conditions#Unconscious\|Unconscious]] creature that has 0 Hit Points without needing to make a Wisdom ([[Rules/Source/skills#Medicine\|Medicine]]) check.

### Holy Symbol (Varies)

A Holy Symbol takes one of the forms in the Holy Symbol table and is bejeweled or painted to channel divine magic. A Cleric or Paladin can use a Holy Symbol as a [[Rules/Source/variant-rules/spellcasting-focus-xphb\|Spellcasting Focus]].
...
When you take the [[Rules/Source/actions#Attack\|Attack]] action, you can replace one of your attacks with throwing a flask of Holy Water. Target one creature you can see within 20 feet of yourself. The target must succeed on a Dexterity saving throw (DC 8 plus your Dexterity modifier and Proficiency Bonus) or take `2d8` Radiant damage if it is a Fiend or an Undead.

### Hunting Trap (5 GP)

As a [[Rules/Source/actions#Utilize\|Utilize]] action, you can set a Hunting Trap, which is a sawtooth steel ring that snaps shut when a creature steps on a pressure plate in the center. The trap is affixed by a heavy chain to an immobile object, such as a tree or a spike driven into the ground. A creature that steps on the plate must succeed on a DC 13 Dexterity saving throw or take `1d4` Piercing damage and have its Speed reduced to 0 until the start of its next turn. Thereafter, until the creature breaks free of the trap, its movement is limited by the length of the chain (typically 3 feet). A creature can use its action to make a DC 13 Strength ([[Rules/Source/skills#Athletics\|Athletics]]) check, freeing itself or another creature within its reach on a success. Each failed check deals 1 Piercing damage to the trapped creature.
...
Using [[Rules/Source/items/ink-xphb\|Ink]], an Ink Pen is used to write or draw.
...
A Lamp burns [[Rules/Source/items/oil-xphb\|Oil]] as fuel to cast [[Rules/Source/variant-rules/bright-light-xphb\|Bright Light]] in a 15-foot radius and [[Rules/Source/variant-rules/dim-light-xphb\|Dim Light]] for an additional 30 feet.
...
A Hooded Lantern burns [[Rules/Source/items/oil-xphb\|Oil]] as fuel to cast [[Rules/Source/variant-rules/bright-light-xphb\|Bright Light]] in a 30-foot radius and [[Rules/Source/variant-rules/dim-light-xphb\|Dim Light]] for an additional 30 feet. As a Bonus Action, you can lower the hood, reducing the light to Dim Light in a 5-foot radius, or raise it again.

### Lock (10 GP)

A Lock comes with a key. Without the key, a creature can use [[Rules/Source/items/thieves-tools-xphb\|Thieves' Tools]] to pick this Lock with a successful DC 15 Dexterity ([[Rules/Source/skills#Sleight of Hand\|Sleight of Hand]]) check.

### Magnifying Glass (100 GP)

A Magnifying Glass grants [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on any ability check made to appraise or inspect a highly detailed item. Lighting a fire with a Magnifying Glass requires light as bright as sunlight to focus, tinder to ignite, and about 5 minutes for the fire to ignite.

### Manacles (2 GP)

As a [[Rules/Source/actions#Utilize\|Utilize]] action, you can use Manacles to bind an unwilling Small or Medium creature within 5 feet of yourself that has the [[Rules/Source/conditions#Grappled\|Grappled]], [[Rules/Source/conditions#Incapacitated\|Incapacitated]], or [[Rules/Source/conditions#Restrained\|Restrained]] condition if you succeed on a DC 13 Dexterity ([[Rules/Source/skills#Sleight of Hand\|Sleight of Hand]]) check. While bound, a creature has [[Rules/Source/variant-rules/disadvantage-xphb\|Disadvantage]] on attack rolls, and the creature is [[Rules/Source/conditions#Restrained\|Restrained]] if the Manacles are attached to a chain or hook that is fixed in place. Escaping the Manacles requires a successful DC 20 Dexterity ([[Rules/Source/skills#Sleight of Hand\|Sleight of Hand]]) check as an action. Bursting them requires a successful DC 25 Strength ([[Rules/Source/skills#Athletics\|Athletics]]) check as an action.

Each set of Manacles comes with a key. Without the key, a creature can use [[Rules/Source/items/thieves-tools-xphb\|Thieves' Tools]] to pick the Manacles' lock with a successful DC 15 Dexterity ([[Rules/Source/skills#Sleight of Hand\|Sleight of Hand]]) check.

### Map (1 GP)

If you consult an accurate Map, you gain a +5 bonus to Wisdom ([[Rules/Source/skills#Survival\|Survival]]) checks you make to find your way in the place represented on it.
...
When you take the [[Rules/Source/actions#Attack\|Attack]] action, you can replace one of your attacks with throwing a Net. Target a creature you can see within 15 feet of yourself. The target must succeed on a Dexterity saving throw (DC 8 plus your Dexterity modifier and Proficiency Bonus) or have the [[Rules/Source/conditions#Restrained\|Restrained]] condition until it escapes. The target succeeds automatically if it is Huge or larger.

To escape, the target or a creature within 5 feet of it must take an action to make a DC 10 Strength ([[Rules/Source/skills#Athletics\|Athletics]]) check, freeing the Restrained creature on a success. Destroying the Net (AC 10; 5 HP; Immunity to Bludgeoning, Poison, and Psychic damage) also frees the target, ending the effect.
...
When you take the [[Rules/Source/actions#Attack\|Attack]] action, you can replace one of your attacks with throwing an Oil flask. Target one creature or object within 20 feet of yourself. The target must succeed on a Dexterity saving throw (DC 8 plus your Dexterity modifier and Proficiency Bonus) or be covered in oil. If the target takes Fire damage before the oil dries (after 1 minute), the target takes an extra 5 Fire damage from burning oil.

#### Dousing a Space

You can take the [[Rules/Source/actions#Utilize\|Utilize]] action to pour an Oil flask on level ground to cover a 5-foot-square area within 5 feet of yourself. If lit, the oil burns until the end of the turn 2 rounds from when the oil was lit (or 12 seconds) and deals 5 Fire damage to any creature that enters the area or ends its turn there. A creature can take this damage only once per turn.

#### Fuel

Oil serves as fuel for Lamps and Lanterns. Once lit, a flask of Oil burns for 6 hours in a Lamp or Lantern. That duration doesn't need to be consecutive; you can extinguish the burning Oil (as a [[Rules/Source/actions#Utilize\|Utilize]] action) and rekindle it again until it has burned for a total of 6 hours.
...
Perfume comes in a 4-ounce vial. For 1 hour after applying Perfume to yourself, you have [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on Charisma ([[Rules/Source/skills#Persuasion\|Persuasion]]) checks made to influence an [[Rules/Source/variant-rules/indifferent-attitude-xphb\|Indifferent]] Humanoid within 5 feet of yourself.
...
A Pole is 10 feet long. You can use it to touch something up to 10 feet away. If you must make a Strength ([[Rules/Source/skills#Athletics\|Athletics]]) check as part of a [[Rules/Source/variant-rules/high-jump-xphb\|High]] or [[Rules/Source/variant-rules/long-jump-xphb\|Long Jump]], you can use the Pole to vault, giving yourself [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on the check.
...
A Priest's Pack contains the following items: [[Rules/Source/items/backpack-xphb\|Backpack]], [[Rules/Source/items/blanket-xphb\|Blanket]], [[Rules/Source/items/holy-water-xphb\|Holy Water]], [[Rules/Source/items/lamp-xphb\|Lamp]], 7 days of [[Rules/Source/items/rations-xphb\|Rations]], [[Rules/Source/items/robe-xphb\|Robe]], and [[Rules/Source/items/tinderbox-xphb\|Tinderbox]].

### Quiver (1 GP)

A Quiver holds up to 20 [[Rules/Source/items/arrows-20-xphb\|Arrows]].

### Ram, Portable (4 GP)

You can use a Portable Ram to break down doors. When doing so, you gain a +4 bonus to the Strength check. One other character can help you use the ram, giving you [[Rules/Source/variant-rules/advantage-xphb\|Advantage]] on this check.

### Rations (5 SP)

Rations consist of travel-ready food, including jerky, dried fruit, hardtack, and nuts. See "[[Rules/Source/traps-hazards/malnutrition-xphb\|Malnutrition]]" in the rules glossary for the risks of not eating.
...
As a [[Rules/Source/actions#Utilize\|Utilize]] action, you can tie a knot with Rope if you succeed on a DC 10 Dexterity ([[Rules/Source/skills#Sleight of Hand\|Sleight of Hand]]) check. The Rope can be burst with a successful DC 20 Strength ([[Rules/Source/skills#Athletics\|Athletics]]) check.

You can bind an unwilling creature with the Rope only if the creature has the [[Rules/Source/conditions#Grappled\|Grappled]], [[Rules/Source/conditions#Incapacitated\|Incapacitated]], or [[Rules/Source/conditions#Restrained\|Restrained]] condition. If the creature's legs are bound, the creature has the Restrained condition until it escapes. Escaping the Rope requires the creature to make a successful DC 15 Dexterity ([[Rules/Source/skills#Acrobatics\|Acrobatics]]) check as an action.
...
A Scholar's Pack contains the following items: [[Rules/Source/items/backpack-xphb\|Backpack]], [[Rules/Source/items/book-xphb\|Book]], [[Rules/Source/items/ink-xphb\|Ink]], [[Rules/Source/items/ink-pen-xphb\|Ink Pen]], [[Rules/Source/items/lamp-xphb\|Lamp]], 10 flasks of [[Rules/Source/items/oil-xphb\|Oil]], 10 sheets of [[Rules/Source/items/parchment-xphb\|Parchment]], and [[Rules/Source/items/tinderbox-xphb\|Tinderbox]].
...
When blown as a [[Rules/Source/actions#Utilize\|Utilize]] action, a Signal Whistle produces a sound that can be heard up to 600 feet away.
...
Iron Spikes come in bundles of ten. As a [[Rules/Source/actions#Utilize\|Utilize]] action, you can use a blunt object, such as a [[Rules/Source/items/light-hammer-xphb\|Light Hammer]], to hammer a spike into wood, earth, or a similar material. You can do so to jam a door shut or to then tie a [[Rules/Source/items/rope-xphb\|Rope]] or [[Rules/Source/items/chain-xphb\|Chain]] to the Spike.
...
String is 10 feet long. You can tie a knot in it as a [[Rules/Source/actions#Utilize\|Utilize]] action.
...
A Tinderbox is a small container holding flint, fire steel, and tinder (usually dry cloth soaked in light oil) used to kindle a fire. Using it to light a [[Rules/Source/items/candle-xphb\|Candle]], [[Rules/Source/items/lamp-xphb\|Lamp]], Lantern, or [[Rules/Source/items/torch-xphb\|Torch]]—or anything else with exposed fuel—takes a Bonus Action. Lighting any other fire takes 1 minute.

### Torch (1 CP)

A Torch burns for 1 hour, casting [[Rules/Source/variant-rules/bright-light-xphb\|Bright Light]] in a 20-foot radius and [[Rules/Source/variant-rules/dim-light-xphb\|Dim Light]] for an additional 20 feet. When you take the [[Rules/Source/actions#Attack\|Attack]] action, you can attack with the Torch, using it as a Simple Melee weapon. On a hit, the target takes 1 Fire damage.

### Vial (1 GP)

A Vial holds up to 4 ounces.

![/Rules/Source/books/players-handbook-2024/img/179-07-005-adventurer-with-tools.webp\|center wmed](/img/user/Rules/Source/books/players-handbook-2024/img/179-07-005-adventurer-with-tools.webp)

### Waterskin (2 SP)

A Waterskin holds up to 4 pints. If you don't drink sufficient water, you risk [[Rules/Source/traps-hazards/dehydration-xphb\|dehydration]].
...
If a vehicle has a [[Rules/Source/variant-rules/damage-threshold-xphb\|damage threshold]], it's noted in the table.
...
The [[Rules/Source/spells/identify-xphb\|Identify]] spell is the fastest way to reveal an item's properties. Alternatively, you can focus on one magic item during a [[Rules/Source/variant-rules/short-rest-xphb\|Short Rest]] while being in physical contact with the item. At the end of the rest, you learn its properties and how to use them (but not any curse the item might bear).

Sometimes a magic item carries a clue to its properties. The command word to activate a ring might be etched inside the band, or a feathered design might hint that it's a [[Rules/Source/items/ring-of-feather-falling-xdmg\|Ring of Feather Falling]].

Wearing or experimenting with an item can also offer hints about its properties. In the specific case of Potions, a little taste is enough to tell the taster what a potion does. Other items might require more experimentation. For example, if your character puts on a [[Rules/Source/items/ring-of-swimming-xdmg\|Ring of Swimming]], the DM might say, "Your movement feels strangely fluid." Perhaps you then dive into a river to see what happens. The DM would then say you swim unexpectedly well.
...
Items that come in pairs—such as boots, bracers, gauntlets, and gloves—impart their benefits only if both items of the pair are worn. For example, a character wearing a [[Rules/Source/items/boots-of-striding-and-springing-xdmg\|Boot of Striding and Springing]] on one foot and a [[Rules/Source/items/boots-of-elvenkind-xdmg\|Boot of Elvenkind]] on the other foot gains no benefit from either.

## Crafting Equipment

Using the rules below, characters can make nonmagical items, [[Rules/Source/items/potion-of-healing-xdmg\|Potions of Healing]], and [[Rules/Source/items/spell-scroll-xdmg\|Spell Scrolls]].
...
A character who has proficiency with the Herbalism Kit can create a [[Rules/Source/items/potion-of-healing-xdmg\|Potion of Healing]]. Doing so requires using that kit and 25 GP of raw material over the course of 1 day (8 hours of work).

### Scribing Spell Scrolls

A spellcaster can transfer a spell to a scroll and create a [[Rules/Source/items/spell-scroll-xdmg\|Spell Scroll]], using the rules below.
