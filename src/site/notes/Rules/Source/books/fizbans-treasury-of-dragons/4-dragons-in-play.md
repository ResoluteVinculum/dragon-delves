---
{"dg-publish":true,"permalink":"/rules/source/books/fizbans-treasury-of-dragons/4-dragons-in-play/","tags":["ttrpg-cli/compendium/src/5e/ftd"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"tags":["ttrpg-cli/compendium/src/5e/ftd"],"aliases":["Dragons in Play"]}}
---
...
Most dragons are proficient in the [[Rules/Source/skills#Perception\|Perception]] and [[Rules/Source/skills#Stealth\|Stealth]] skills, and many dragons have additional skill proficiencies. As with languages, you can customize a dragon's skill list (even doubling their proficiency bonus with certain skills) to reflect particular interests and activities. You can also give a dragon tool proficiencies, particularly if the dragon spends time in Humanoid form.
...
- **Damage Absorption.** You might decide that a red or gold dragon is not only unharmed by fire damage, but actually healed by it. (See the [[Rules/Source/bestiary/construct/flesh-golem-xmm\|flesh golem]] in the "Monster Manual".)  
- **Flyby.** The dragon is an agile flier, quick to fly out of enemies' reach. (See the [[Rules/Source/bestiary/monstrosity/peryton-xmm\|peryton]] in the "Monster Manual".)  
- **Mimicry.** Impersonating characters or their allies could be a fun trick for a crafty dragon. (See the [[Rules/Source/bestiary/monstrosity/kenku-xmm\|kenku]] in the "Monster Manual".)  
- **Rejuvenation.** You might decide that dragons in your campaign, being an essential part of the Material Plane, are nearly impossible to destroy. A dragon's life essence might be preserved in the egg from which it first emerged, in its hoard, or in a cavernous hall at the center of the world, just as a lich's essence is hidden in a phylactery. (See the [[Rules/Source/bestiary/undead/lich-xmm\|lich]] in the "Monster Manual".)  
- **Special Senses.** Most dragons have [[Rules/Source/senses#Blindsight\|blindsight]] and [[Rules/Source/senses#Darkvision\|darkvision]]. You might upgrade [[Rules/Source/senses#Blindsight\|blindsight]] to [[Rules/Source/senses#Truesight\|truesight]], or you could give a dragon with a burrowing speed [[Rules/Source/senses#Tremorsense\|tremorsense]]. (See the "introduction" to the "Monster Manual".)  
- **Tunneler.** Any dragon with a burrowing speed could have this trait, moving through solid rock and leaving a tunnel in its wake. (See the [[Rules/Source/bestiary/monstrosity/umber-hulk-xmm\|umber hulk]] in the "Monster Manual".)  
...
Chapter 6 details three additional kinds of draconic Undead. A [[Rules/Source/bestiary/undead/hollow-dragon-ftd\|hollow dragon]] comes into being when a metallic dragon gives up mortal life so a fragment of life essence can linger as an eternal guardian of a precious treasure or knowledge. [[Rules/Source/bestiary/undead/draconic-shard-ftd\|Draconic shards]] are lingering psychic projections of psionic gem dragons. And dragons can also linger after death as [[Rules/Source/bestiary/undead/ghost-dragon-ftd\|ghost dragons]].
...
Most metallic and gem dragons can change shape to take on a Humanoid or Beast form by the time they reach adulthood or ancient age. A few other Dragon varieties possess similar abilities (including deep dragons, described in chapter 6), and you can give any dragon the Change Shape action of an adult or ancient dragon without affecting the dragon's challenge rating (as noted under "Customizing Dragons" earlier in this chapter). Likewise, if you use the "Monster Manual" variant rule to make dragons innate spellcasters, you could give any adult or older dragon the [[Rules/Source/spells/polymorph-xphb\|polymorph]] spell to take on an alternate form.
...
Monks who follow the Way of the Ascendant Dragon might follow a dragon teacher or could train in monasteries established by dragons in past generations.
