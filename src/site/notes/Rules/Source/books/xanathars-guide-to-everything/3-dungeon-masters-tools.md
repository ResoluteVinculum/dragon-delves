---
{"dg-publish":true,"permalink":"/rules/source/books/xanathars-guide-to-everything/3-dungeon-masters-tools/","tags":["ttrpg-cli/compendium/src/5e/xge"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"tags":["ttrpg-cli/compendium/src/5e/xge"],"aliases":["Dungeon Master's Tools"]}}
---
...
Falling from a great height is a significant risk for adventurers and their foes. The rule given in the player's handbook is simple: at the end of a fall, you take `1d6` bludgeoning damage for every 10 feet you fell, to a maximum of `20d6`. You also land [[Rules/Source/conditions#Prone\|prone]], unless you somehow avoid taking damage from the fall. Here are two optional rules that expand on that simple rule.

### Rate of Falling

The rule for falling assumes that a creature immediately drops the entire distance when it falls. But what if a creature is at a high altitude when it falls, perhaps on the back of a [[Rules/Source/bestiary/monstrosity/griffon-xmm\|griffon]] or on board an [[Rules/Source/items/airship-xphb\|airship]]? Realistically, a fall from such a height can take more than a few seconds, extending past the end of the turn when the fall occurred. If you'd like high-altitude falls to be properly time-consuming, use the following optional rule.

When you fall from a great height, you instantly descend up to 500 feet. If you're still falling on your next turn, you descend up to 500 feet at the end of that turn. This process continues until the fall ends, either because you hit the ground or the fall is otherwise halted.

### Flying Creatures and Falling

A flying creature in flight falls if it is knocked [[Rules/Source/conditions#Prone\|prone]], if its speed is reduced to 0 feet, or if it otherwise loses the ability to move, unless it can hover or it is being held aloft by magic, such as the [[Rules/Source/spells/fly-xphb\|fly]] spell.

If you'd like a flying creature to have a better chance of surviving a fall than a non-flying creature does, use this rule: subtract the creature's current flying speed from the distance it fell before calculating falling damage. This rule is helpful to a flier that is knocked [[Rules/Source/conditions#Prone\|prone]] but is still conscious and has a current flying speed that is greater than 0 feet. The rule is designed to simulate the creature flapping its wings furiously or taking similar measures to slow the velocity of its fall.

If you use the rule for rate of falling in the previous section, a flying creature descends 500 feet on the turn when it falls, just as other creatures do. But if that creature starts any of its later turns still falling and is [[Rules/Source/conditions#Prone\|prone]], it can halt the fall on its turn by spending half its flying speed to counter the [[Rules/Source/conditions#Prone\|prone]] condition (as if it were standing up in midair).

## Sleep

Just as in the real world, D&D characters spend many hours sleeping, most often as part of a long rest. Most monsters also need to sleep. While a creature sleeps, it is subjected to the [[Rules/Source/conditions#Unconscious\|unconscious]] condition. Here are a few rules that expand on that basic fact.
...
When you finish a long rest during which you slept in medium or heavy armor, you regain only one quarter of your spent Hit Dice (minimum of one die). If you have any levels of [[Rules/Source/conditions#Exhaustion\|exhaustion]], the rest doesn't reduce your [[Rules/Source/conditions#Exhaustion\|exhaustion]] level.
...
Whenever you end a 24-hour period without finishing a long rest, you must succeed on a DC 10 Constitution saving throw or suffer one level of [[Rules/Source/conditions#Exhaustion\|exhaustion]].

It becomes harder to fight off [[Rules/Source/conditions#Exhaustion\|exhaustion]] if you stay awake for multiple days. After the first 24 hours, the DC increases by 5 for each consecutive 24-hour period without a long rest. The DC resets to 10 when you finish a long rest.
...
The creature who ties the knot makes an Intelligence ([[Rules/Source/skills#Sleight of Hand\|Sleight of Hand]]) check when doing so. The total of the check becomes the DC for an attempt to untie the knot with an Intelligence ([[Rules/Source/skills#Sleight of Hand\|Sleight of Hand]]) check or to slip out of it with a Dexterity ([[Rules/Source/skills#Acrobatics\|Acrobatics]]) check.

This rule intentionally links [[Rules/Source/skills#Sleight of Hand\|Sleight of Hand]] with Intelligence, rather than Dexterity. This is an example of how to apply the rule in the <span title="Player's Handbook">"Variant: Skills with Different Abilities"</span> section in chapter 7 of the player's handbook.
...
![/Rules/Source/books/xanathars-guide-to-everything/img/c2001.webp\|center wmed](/img/user/Rules/Source/books/xanathars-guide-to-everything/img/c2001.webp)
...
See the [[Rules/Source/actions#Identify a Spell\|Identify a Spell]] entry.
...
![/Rules/Source/variant-rules/img/xge-001.webp\|center wmed](/img/user/Rules/Source/variant-rules/img/xge-001.webp)
...
![/Rules/Source/variant-rules/img/xge-002.webp\|center wmed](/img/user/Rules/Source/variant-rules/img/xge-002.webp)

![/Rules/Source/variant-rules/img/xge-003.webp\|center wmed](/img/user/Rules/Source/variant-rules/img/xge-003.webp)
...
![/Rules/Source/books/xanathars-guide-to-everything/img/c2005.webp\|center wmed](/img/user/Rules/Source/books/xanathars-guide-to-everything/img/c2005.webp)
...
![/Rules/Source/books/xanathars-guide-to-everything/img/c2021.webp\|center wmed](/img/user/Rules/Source/books/xanathars-guide-to-everything/img/c2021.webp)

#### Running a Simple Trap

To prepare for using a simple trap in play, start by making note of the characters' passive Wisdom ([[Rules/Source/skills#Perception\|Perception]]) scores. Most traps allow Wisdom ([[Rules/Source/skills#Perception\|Perception]]) checks to detect their triggers or other elements that can tip off their presence. If you stop to ask players for this information, they might suspect a hidden danger.
...
- [[Rules/Source/traps-hazards/bear-trap-xge\|Bear Trap]]  
- [[Rules/Source/traps-hazards/crossbow-trap-xge\|Crossbow Trap]]  
- [[Rules/Source/traps-hazards/falling-portcullis-xge\|Falling Portcullis]]  
- [[Rules/Source/traps-hazards/fiery-blast-trap-xge\|Fiery Blast Trap]]  
- [[Rules/Source/traps-hazards/net-trap-xge\|Net Trap]]  
- [[Rules/Source/traps-hazards/pit-trap-xge\|Pit Trap]]  
- [[Rules/Source/traps-hazards/poison-needle-trap-xge\|Poison Needle Trap]]  
- [[Rules/Source/traps-hazards/scything-blade-trap-xge\|Scything Blade Trap]]  
- [[Rules/Source/traps-hazards/sleep-of-ages-trap-xge\|Sleep of Ages Trap]]  
...
A trigger requires a Wisdom ([[Rules/Source/skills#Perception\|Perception]]) check if simply spotting it reveals its nature. The characters can foil a pit trap hidden by a leaf-covered net if they spot the pit through a gap in the leaves. A trip wire is foiled if it is spotted, as is a pressure plate.

Other traps require careful inspection and deduction to notice. A doorknob opens a door when turned to the left, but activates a trap when turned to the right. Such a subtle trap requires a successful Intelligence ([[Rules/Source/skills#Investigation\|Investigation]]) check to notice. The trigger is obvious. Understanding its nature is not.
...
Once you determine how a trap can be disarmed or avoided, decide the appropriate ability and skill combinations that characters can use. A Dexterity check using [[Rules/Source/items/thieves-tools-xphb\|thieves' tools]], a Strength ([[Rules/Source/skills#Athletics\|Athletics]]) check, and an Intelligence ([[Rules/Source/skills#Arcana\|Arcana]]) check are all commonly used for this purpose.

A Dexterity check using [[Rules/Source/items/thieves-tools-xphb\|thieves' tools]] can apply to any trap that has a mechanical element. [[Rules/Source/items/thieves-tools-xphb\|Thieves' tools]] can be used to disable a trip wire or a pressure plate, disassemble a poison needle mechanism, or clog a valve that leaks poisonous gas into a room.
...
![/Rules/Source/books/xanathars-guide-to-everything/img/c2024.webp\|center wmed](/img/user/Rules/Source/books/xanathars-guide-to-everything/img/c2024.webp)
...
- [[Rules/Source/traps-hazards/path-of-blades-xge\|Path of Blades]]  
- [[Rules/Source/traps-hazards/poisoned-tempest-xge\|Poisoned Tempest]]  
...
The trigger for a complex trap should be as foolproof as you can make it. A complex trap represents a serious expenditure of effort and magical power. No one builds such a trap and makes it easy to avoid. Wisdom ([[Rules/Source/skills#Perception\|Perception]]) and Intelligence ([[Rules/Source/skills#Investigation\|Investigation]]) checks might be unable to spot a trigger, especially a magical one, but they can still give hints about the trap before it triggers. Bloodstains, ashes, gouges in the floor, and other clues of that sort can serve as evidence of the trap's presence.
...
![/Rules/Source/books/xanathars-guide-to-everything/img/c2026.webp\|center wmed](/img/user/Rules/Source/books/xanathars-guide-to-everything/img/c2026.webp)
...
To attempt a crime, the character makes three checks: Dexterity ([[Rules/Source/skills#Stealth\|Stealth]]), Dexterity using [[Rules/Source/items/thieves-tools-xphb\|thieves' tools]], and the player's choice of Intelligence ([[Rules/Source/skills#Investigation\|Investigation]]), Wisdom ([[Rules/Source/skills#Perception\|Perception]]), or Charisma ([[Rules/Source/skills#Deception\|Deception]]).
...
Scribing a spell scroll takes an amount of time and money related to the level of the spell the character wants to scribe, as shown in the Spell Scroll Costs table. In addition, the character must have proficiency in the [[Rules/Source/skills#Arcana\|Arcana]] skill and must provide any material components required for the casting of the spell. Moreover, the character must have the spell prepared, or it must be among the character's known spells, in order to scribe a scroll of that spell.
