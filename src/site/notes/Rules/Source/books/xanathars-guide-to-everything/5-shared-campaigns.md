---
{"dg-publish":true,"permalink":"/rules/source/books/xanathars-guide-to-everything/5-shared-campaigns/","tags":["ttrpg-cli/compendium/src/5e/xge"],"dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"tags":["ttrpg-cli/compendium/src/5e/xge"],"aliases":["Shared Campaigns"]}}
---
...
> - Make the DM or the campaign's administrators aware of disruptive or aggressive behavior so that appropriate action can be taken.  { #code-of-conduct}
...
See the [[Rules/Source/variant-rules/shared-campaign-variant-rules-xge\|variant rules]] entry for more information.